...
- generated_at: `2026-05-25T16:20:13.595695Z`
...
- support: `0/50` (gap `50`, delta `-30`, stagnant `0`)
- semantic-signature progress: delta `-24`, stagnant `0` (does not relax strict support_identity)
- release_ready: `True` / recent wins `50/50`, required `15`, needed `0`
