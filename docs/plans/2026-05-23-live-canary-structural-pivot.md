...
- generated_at: `2026-05-24T22:09:27.209941Z`
...
- support: `24/50` (gap `26`, delta `-8`, stagnant `0`)
- semantic-signature progress: delta `-6`, stagnant `0` (does not relax strict support_identity)
