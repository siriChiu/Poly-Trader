...
- `data/live_predict_probe.json` generated at `2026-05-23T08:21:43.171880Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T08:21:45.299045Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T08:21:47.628570+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=24993`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T08:22:01.552124Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T08:21:39.399024+00:00`。
- Full sample rows `24855`。
- Recent canonical window `100`: win_rate `15.0%`, dominant regime `chop(89.0%)`, alerts `label_imbalance, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T08:21:59.235894+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T08:22:02.486847Z`。
