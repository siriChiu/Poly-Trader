...
- `data/live_predict_probe.json` generated at `2026-05-28T02:13:35.358930Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=C` / `decision_quality_score=-0.2291`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-28T02:13:22.562535Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-28T02:13:24.967498+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25424`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-28T02:13:41.857539Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-28T02:13:15.681847+00:00`。
- Full sample rows `25286`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(58.0%)`, alerts `constant_target`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-28T02:13:39.145307+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-28T02:13:42.806928Z`。
