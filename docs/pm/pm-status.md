...
- `data/live_predict_probe.json` generated at `2026-05-23T10:18:22.361087Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T10:18:23.977744Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T10:19:11.472877+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25001`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T10:19:40.430520Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T10:18:17.954047+00:00`。
- Full sample rows `24863`。
- Recent canonical window `100`: win_rate `7.0%`, dominant regime `chop(87.0%)`, alerts `label_imbalance, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T10:19:35.653702+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T10:19:41.361037Z`。
...
2. **Recent tail root-cause lane**：針對 recent canonical pocket（window `100` win_rate `7.0%`）交付一個 no-new-risk / shadow-only falsification artifact；不可把 shadow-only artifact 誤寫成 release patch。
