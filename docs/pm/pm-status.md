...
- `data/live_predict_probe.json` generated at `2026-05-28T00:06:47.905953Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=C` / `decision_quality_score=-0.2299`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-28T00:06:33.338298Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-28T00:06:35.749535+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25422`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-28T00:06:54.515728Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-28T00:06:27.599764+00:00`。
- Full sample rows `25284`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(60.0%)`, alerts `constant_target`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-28T00:06:51.808637+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-28T00:06:55.455949Z`。
