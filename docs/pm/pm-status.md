...
- `data/live_predict_probe.json` generated at `2026-05-23T12:22:04.657747Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T12:22:06.788528Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T12:22:11.433352+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25010`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T12:22:23.002565Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T12:22:00.852497+00:00`。
- Full sample rows `24872`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(93.0%)`, alerts `constant_target, regime_concentration, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T12:22:20.755838+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T12:22:23.957579Z`。
