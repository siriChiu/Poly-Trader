...
- `data/live_predict_probe.json` generated at `2026-05-24T18:02:55.562977Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-24T18:02:04.438410Z`；verdict `breaker_clear`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-24T18:02:44.089670+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25133`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-24T18:03:03.365260Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-24T18:01:47.639162+00:00`。
- Full sample rows `24995`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-24T18:03:00.423825+00:00`；scanned current support identity bucket is `CAUTION|base_caution_regime_or_bias|q35`。
- Verdict: `classification=semantic_window_gap_not_raw_backfill_gap`, current calibration window `200`, current exact bucket rows `0/50`, identity rows before bucket filter `32`, non-current-bucket identity rows `32`, `gap=50`, `time_to_evidence_bucket=semantic_rebaseline_review_required_before_reference_rows_count`, `missing_capability_class=Constraint/Review`, `alternative_solution_required=true`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-24T18:03:04.268313Z`。
