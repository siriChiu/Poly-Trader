...
- `data/live_predict_probe.json` generated at `2026-05-27T06:15:59.491169Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=C` / `decision_quality_score=-0.2002`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T06:15:46.993319Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T06:15:49.291911+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25367`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T06:16:07.922137Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T06:15:41.176603+00:00`。
- Full sample rows `25229`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T06:16:03.554845+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T06:16:08.800153Z`。
