...
- `data/live_predict_probe.json` generated at `2026-05-27T11:20:54.816044Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=D` / `decision_quality_score=-0.2127`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T11:20:06.073762Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T11:20:45.141960+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25377`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T11:21:03.918532Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T11:20:00.211189+00:00`。
- Full sample rows `25239`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T11:21:01.204659+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q15`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T11:21:04.837953Z`。
