...
- `data/live_predict_probe.json` generated at `2026-05-23T05:13:24.078973Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T05:13:25.648800Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T05:13:28.923017+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=24976`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T05:13:46.266106Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T05:13:19.699499+00:00`。
- Full sample rows `24838`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T05:13:43.606134+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T05:13:47.145007Z`。
