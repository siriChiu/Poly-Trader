...
- `data/live_predict_probe.json` generated at `2026-05-23T14:32:32.020294Z`；canonical target is `simulated_pyramid_win`。
...
- Support progress: `support_progress_status=no_recent_comparable_history` / `regression_basis=no_same_identity_same_semantic_signature_history` / `previous_rows=None` / `delta_vs_previous=None` / `stagnant_run_count=0` / legacy reference is reference-only because support identity does not close current deployment.
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T14:32:15.230830Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T14:32:22.421422+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25019`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T14:32:38.105672Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T14:32:06.290642+00:00`。
- Full sample rows `24881`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(85.0%)`, alerts `constant_target, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T14:32:35.454665+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q15`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T14:32:38.929836Z`。
