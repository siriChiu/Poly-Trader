...
- `data/live_predict_probe.json` generated at `2026-05-27T10:17:30.262447Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=D` / `decision_quality_score=-0.2095`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T10:17:15.434171Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T10:17:18.063547+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25375`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T10:17:37.011380Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T10:17:09.433785+00:00`。
- Full sample rows `25237`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T10:17:34.330882+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q15`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T10:17:37.932978Z`。
