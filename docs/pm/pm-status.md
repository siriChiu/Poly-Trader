...
- `data/live_predict_probe.json` generated at `2026-05-27T12:17:53.492444Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=D` / `decision_quality_score=-0.2145`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T12:17:39.123593Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T12:17:43.763922+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25378`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T12:18:00.342882Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T12:17:33.354074+00:00`。
- Full sample rows `25240`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T12:17:57.605570+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T12:18:01.329040Z`。
