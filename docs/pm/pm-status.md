...
- `data/live_predict_probe.json` generated at `2026-05-23T06:44:07.419171Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T06:44:09.991448Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T06:26:44.908800+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=24984`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T06:26:57.653703Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T06:44:02.800581+00:00`。
- Full sample rows `24846`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T06:26:55.104187+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T06:26:58.343212Z`。
