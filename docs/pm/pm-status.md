...
- `data/live_predict_probe.json` generated at `2026-05-27T13:13:19.891694Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=C` / `decision_quality_score=-0.2180`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T13:13:04.805586Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T13:13:07.072480+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25381`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T13:13:26.606797Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T13:12:58.888940+00:00`。
- Full sample rows `25243`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T13:13:23.777324+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T13:13:27.571515Z`。
