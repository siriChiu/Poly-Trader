...
- `data/live_predict_probe.json` generated at `2026-05-27T14:12:41.912586Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=B` / `decision_quality_score=-0.2191`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T14:12:26.548925Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T14:12:29.388694+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25382`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T14:12:48.799112Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T14:12:20.586730+00:00`。
- Full sample rows `25244`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T14:12:45.842514+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- Reference-only evidence: `best_reference_window=600`, `best_reference_exact_bucket_rows=6`, `best_reference_evidence_role=reference_only_calibration_window_mismatch`；reference rows cannot be counted as deployable support unless support identity is deliberately rebaselined and fully reverified.
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T14:12:49.729390Z`。
