...
- `data/live_predict_probe.json` generated at `2026-05-23T18:20:14.819141Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T18:20:00.265197Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T18:20:05.008287+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25036`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T18:20:21.621597Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T18:19:54.442129+00:00`。
- Full sample rows `24898`。
- Recent canonical window `100`: win_rate `6.0%`, dominant regime `chop(68.0%)`, alerts `label_imbalance, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T18:20:18.498690+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q15`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T18:20:22.468524Z`。
...
2. **Recent tail root-cause lane**：針對 recent canonical pocket（window `100` win_rate `6.0%`）交付一個 no-new-risk / shadow-only falsification artifact；不可把 shadow-only artifact 誤寫成 release patch。
