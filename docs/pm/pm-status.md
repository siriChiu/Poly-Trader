...
- `data/live_predict_probe.json` generated at `2026-05-27T08:20:24.190977Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=D` / `decision_quality_score=-0.2046`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T08:20:09.619304Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T08:20:14.434878+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25370`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T08:20:30.905762Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T08:20:03.776842+00:00`。
- Full sample rows `25232`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(99.0%)`, alerts `constant_target, regime_concentration, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T08:20:28.183626+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q15`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T08:20:31.893489Z`。
