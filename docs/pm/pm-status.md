...
- `data/live_predict_probe.json` generated at `2026-05-27T09:20:11.858825Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=C` / `decision_quality_score=-0.2069`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T09:20:01.829054Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T09:05:37.755476+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25371`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T09:20:18.309111Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T09:19:55.926584+00:00`。
- Full sample rows `25235`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T09:20:15.463174+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T09:20:19.288900Z`。
