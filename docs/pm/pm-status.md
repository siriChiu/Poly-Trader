...
- `data/live_predict_probe.json` generated at `2026-05-23T13:25:01.405730Z`；canonical target is `simulated_pyramid_win`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-23T13:25:03.586329Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-23T13:25:06.216108+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25015`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-23T13:25:21.514002Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-23T13:24:57.590967+00:00`。
- Full sample rows `24877`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(89.0%)`, alerts `constant_target, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-23T13:25:18.415503+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-23T13:25:22.438797Z`。
