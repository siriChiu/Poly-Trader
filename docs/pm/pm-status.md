...
- `data/live_predict_probe.json` generated at `2026-05-27T23:07:29.921187Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=C` / `decision_quality_score=-0.2301`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T23:07:16.402674Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T23:07:18.864410+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25421`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T23:07:36.693242Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T23:07:09.995812+00:00`。
- Full sample rows `25283`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(61.0%)`, alerts `constant_target`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T23:07:33.967614+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T23:07:37.599568Z`。
