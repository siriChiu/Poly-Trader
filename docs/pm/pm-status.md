...
- `data/live_predict_probe.json` generated at `2026-05-27T17:15:02.305046Z`；canonical target is `simulated_pyramid_win`。
- Runtime signal: `signal=CIRCUIT_BREAKER` / `should_trade=false` / confidence `0.500000`；`regime_label=bear` / `regime_gate=BLOCK` / `entry_quality_label=C` / `decision_quality_score=-0.2328`。
...
- Latest artifact `data/circuit_breaker_audit.json` generated at `2026-05-27T17:14:45.035659Z`；verdict `canonical_breaker_active`。
...
- `data/high_conviction_topk_oos_matrix.json` generated at `2026-05-27T17:14:49.769336+00:00`；`artifact_freshness_status=fresh`, `artifact_deployment_blocking=false`, `samples=25398`, `row_count=24`, `runtime_blocked_candidate_rows=6`。
...
- `data/execution_metadata_smoke.json` generated at `2026-05-27T17:15:09.150623Z`。
...
- `data/recent_drift_report.json` generated at `2026-05-27T17:14:39.125550+00:00`。
- Full sample rows `25260`。
- Recent canonical window `100`: win_rate `0.0%`, dominant regime `chop(84.0%)`, alerts `constant_target, regime_shift`。
...
- `data/q15_support_fill_feasibility.json` generated at `2026-05-27T17:15:06.258347+00:00`；scanned current support identity bucket is `BLOCK|bear_bias200_hard_block|q00`。
...
- `data/customer_safe_alternative_proof.json` generated at `2026-05-27T17:15:10.039162Z`。
