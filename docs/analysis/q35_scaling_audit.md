...
- generated_at: **2026-04-21 08:09:08.315057**
...
- legacy_entry_quality: **0.3621** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.3621** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5645** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.5499**
- structure_quality: **0.409**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-1.8347)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-1.8041)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-1.8349)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-1.8246)
...
- runtime preview: applied=**False** | score=**0.17001999999999998** | legacy=**0.17001999999999998** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.3621 → 0.3621** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.3621 → 0.5645** (Δ=**0.2024**)
...
- runtime gap to floor: **-0.0145**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.3621**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6111**, layers **1**
- required bias50 cap to cross trade floor: **-1.5815** (current=1.5499)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.3802** / layers **0** / gap **0.1698** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4758** / layers **0** / gap **0.0742**
- required_bias50_cap_after_best_scenario: **0.3135**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.5, 'feat_pulse': 0.0, 'feat_ear': 0.5}** → entry_quality **0.5645** / gap **0.0** / mean_gap **0.0027**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8272** / gap **0.0** / mean_gap **-0.004**
