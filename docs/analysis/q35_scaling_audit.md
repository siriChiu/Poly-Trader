...
- generated_at: **2026-04-21 05:35:21.001275**
...
- legacy_entry_quality: **0.4291** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4291** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5517** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.2968**
- structure_quality: **0.371**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-2.0878)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-2.0572)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-2.088)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-2.0777)
...
- runtime preview: applied=**False** | score=**0.22064** | legacy=**0.22064** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4291 → 0.4291** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4291 → 0.5517** (Δ=**0.1226**)
...
- runtime gap to floor: **-0.0017**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4291**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6629**, layers **1**
- required bias50 cap to cross trade floor: **-0.718** (current=1.2968)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.4321** / layers **0** / gap **0.1179** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4839** / layers **0** / gap **0.0661**
- required_bias50_cap_after_best_scenario: **0.1955**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.6, 'feat_pulse': 0.0, 'feat_ear': 0.4}** → entry_quality **0.5517** / gap **0.0** / mean_gap **0.0041**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8338** / gap **0.0** / mean_gap **-0.004**
