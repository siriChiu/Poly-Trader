...
- generated_at: **2026-04-21 00:34:08.041964**
...
- legacy_entry_quality: **0.4328** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4328** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5531** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.5034**
- structure_quality: **0.3976**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-1.8812)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-1.8506)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-1.8814)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-1.8711)
...
- runtime preview: applied=**False** | score=**0.17931999999999998** | legacy=**0.17931999999999998** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4328 → 0.4328** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4328 → 0.5531** (Δ=**0.1203**)
...
- gate -> ALLOW only: entry_quality **0.4328**, layers **0**
- fully relax bias50 penalty: entry_quality **0.679**, layers **1**
- required bias50 cap to cross trade floor: **-0.45** (current=1.5034)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.4481** / layers **0** / gap **0.1019** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4778** / layers **0** / gap **0.0722**
- required_bias50_cap_after_best_scenario: **0.3**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.85, 'feat_pulse': 0.0, 'feat_ear': 0.15}** → entry_quality **0.5531** / gap **0.0** / mean_gap **0.0075**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8379** / gap **0.0** / mean_gap **-0.004**
