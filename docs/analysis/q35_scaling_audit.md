...
- generated_at: **2026-05-02 02:35:54.465981**
...
- legacy_entry_quality: **0.4539** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4539** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.4539** (raw_reason=`entry_quality_below_trade_floor`, effective_reason=`under_minimum_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **1.3216**
- structure_quality: **0.4604**

## Exact lane summary

- rows: **875** | win_rate: **0.7771**
- bias50 distribution: {'min': -0.4035, 'p25': 0.7875, 'p50': 1.1459, 'p75': 1.3669, 'p90': 1.6949, 'p95': 1.8374, 'max': 4.4265, 'mean': 1.1028}
- current bias50 percentile in exact lane: **0.7029**
- winner-only bias50 distribution: {'min': -0.4035, 'p25': 0.6319, 'p50': 1.0717, 'p75': 1.3466, 'p90': 1.6072, 'p95': 1.7763, 'max': 3.9157, 'mean': 1.0263}

## Broader bull cohorts

- same_gate_same_quality: rows=**2888** | win_rate=**0.8047** | bias50_pct=**0.4681** | dist={'min': -1.7439, 'p25': 0.6931, 'p50': 1.4299, 'p75': 3.2782, 'p90': 4.0983, 'p95': 4.6111, 'max': 8.0151, 'mean': 1.9567}
- same_bucket: rows=**1409** | win_rate=**0.8396** | bias50_pct=**0.7892** | dist={'min': -5.5588, 'p25': 0.5057, 'p50': 0.9944, 'p75': 1.2897, 'p90': 1.5575, 'p95': 1.7562, 'max': 4.4265, 'mean': 0.8255}
- bull_all: rows=**4038** | win_rate=**0.8289** | bias50_pct=**0.5339** | dist={'min': -6.9187, 'p25': 0.3567, 'p50': 1.2544, 'p75': 3.2265, 'p90': 4.2186, 'p95': 4.7277, 'max': 8.0151, 'mean': 1.6678}
...
- exact lane band: **warm** (pct=0.7029, Δp90=-0.3733)
- same_gate_same_quality band: **core_normal** (pct=0.4681, Δp90=-2.7767)
- same_bucket band: **elevated_but_within_p90** (pct=0.7892, Δp90=-0.2359)
- bull_all band: **warm** (pct=0.5339, Δp90=-2.897)
- reference cohort: **same_gate_same_quality** / label=同 bull gate + 同 quality lane / pct=0.4681
- note: current bias50 已回到 exact lane p90 內；下一步應做 exact-lane 內的保守 bias50 校準 / 公式檢查，而不是再走 broader bull segmentation。
- runtime preview: applied=**False** | score=**0.21567999999999996** | legacy=**0.21567999999999996** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_no_material_improvement**
- baseline -> calibration runtime entry_quality: **0.4539 → 0.4539** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4539 → 0.4539** (Δ=**0.0**)
...
- runtime gap to floor: **0.0961**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4539**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6892**, layers **2**
- required bias50 cap to cross trade floor: **-0.28** (current=1.3216)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.4591** / layers **0** / gap **0.0909**
- required_bias50_cap_after_best_scenario: **-0.1935**
...
- best scenario: **exact_runtime_p90** → entry_quality **0.5165** / layers **0** / gap **0.0335** / target_score **0.4245**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.5413** / layers **0** / gap **0.0087**
- required_bias50_cap_after_best_scenario: **0.487**
...
- rows / wins / losses: **875 / 680 / 195**
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.4, 'feat_nose': 0.0, 'feat_pulse': 0.15, 'feat_ear': 0.45}** → entry_quality **0.5505** / gap **0.0** / mean_gap **0.0341**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8174** / gap **0.0** / mean_gap **0.0096**
