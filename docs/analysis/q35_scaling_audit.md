...
- legacy_entry_quality: **0.4023** (raw_reason=`regime_gate_block`)
- calibration_runtime_entry_quality: **0.4023** (raw_reason=`regime_gate_block`)
- deployed_runtime_entry_quality: **0.4023** (raw_reason=`regime_gate_block`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **4.1433**
- structure_quality: **0.5837**
...
- bull_all: rows=**10201** | win_rate=**0.5969** | bias50_pct=**0.9562** | dist={'min': -1.1554, 'p25': 2.593, 'p50': 2.8002, 'p75': 3.3094, 'p90': 3.3733, 'p95': 3.5101, 'max': 9.36, 'mean': 2.9429}
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-1.2203)
- same_gate_same_quality band: **core_normal** (pct=0.2872, Δp90=-1.8736)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-1.2203)
- bull_all band: **overheat** (pct=0.9562, Δp90=0.77)
...
- baseline -> calibration runtime entry_quality: **0.4023 → 0.4023** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4023 → 0.4023** (Δ=**0.0**)
...
- runtime gap to floor: **0.1477**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4023**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7023**, layers **0**
- required bias50 cap to cross trade floor: **-0.0615** (current=4.1433)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.4036** / layers **0** / gap **0.1464**
- required_bias50_cap_after_best_scenario: **-0.04**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.4977** / layers **0** / gap **0.0523**
- required_bias50_cap_after_best_scenario: **1.5285**
