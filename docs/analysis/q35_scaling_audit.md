...
- generated_at: **2026-05-20 13:09:49.229818**
...
- legacy_entry_quality: **0.5985** (raw_reason=`entry_quality_C_single_layer`)
- calibration_runtime_entry_quality: **0.5985** (raw_reason=`entry_quality_C_single_layer`)
- deployed_runtime_entry_quality: **0.5985** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **-1.4783**
...
- exact lane band: **core_normal** (pct=0.0157, Δp90=-2.7351)
- same_gate_same_quality band: **core_normal** (pct=0.0465, Δp90=-6.0909)
- same_bucket band: **core_normal** (pct=0.0237, Δp90=-3.0293)
- bull_all band: **core_normal** (pct=0.024, Δp90=-5.6249)
...
- runtime preview: applied=**False** | score=**0.77566** | legacy=**0.77566** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_floor_but_execution_blocked**
- baseline -> calibration runtime entry_quality: **0.5985 → 0.5985** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.5985 → 0.5985** (Δ=**0.0**)
...
- runtime gap to floor: **-0.0485**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.5985**, layers **1**
- fully relax bias50 penalty: entry_quality **0.6658**, layers **1**
- required bias50 cap to cross trade floor: **-1.4785** (current=-1.4783)
...
- best scenario: **exact_lane_p75** → entry_quality **0.6192** / layers **1** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-1.4785**
...
- machine_read: entry_quality>=0.55=**True** | allowed_layers>0=**True**
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.6906** / layers **2** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-1.4785**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.85, 'feat_ear': 0.15}** → entry_quality **0.559** / gap **0.0** / mean_gap **0.0065**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8271** / gap **0.0** / mean_gap **0.0028**
