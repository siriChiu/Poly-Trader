...
- generated_at: **2026-04-20 20:06:27.172117**
...
- legacy_entry_quality: **0.3939** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.3939** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5507** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.9249**
- structure_quality: **0.4685**
...
- exact lane band: **core_normal** (pct=0.0026, Δp90=-1.4597)
- same_gate_same_quality band: **core_normal** (pct=0.0021, Δp90=-1.4291)
- same_bucket band: **core_normal** (pct=0.0026, Δp90=-1.4599)
- bull_all band: **core_normal** (pct=0.0067, Δp90=-1.4496)
...
- runtime preview: applied=**False** | score=**0.09501999999999997** | legacy=**0.09501999999999997** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.3939 → 0.3939** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.3939 → 0.5507** (Δ=**0.1568**)
...
- runtime gap to floor: **-0.0007**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.3939**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6654**, layers **1**
- required bias50 cap to cross trade floor: **-0.6765** (current=1.9249)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.4346** / layers **0** / gap **0.1154** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4664** / layers **0** / gap **0.0836**
- required_bias50_cap_after_best_scenario: **0.5315**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.85, 'feat_pulse': 0.0, 'feat_ear': 0.15}** → entry_quality **0.5507** / gap **0.0** / mean_gap **0.0075**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8305** / gap **0.0** / mean_gap **-0.004**
