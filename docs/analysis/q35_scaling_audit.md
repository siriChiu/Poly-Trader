...
- legacy_entry_quality: **0.4248** (raw_reason=`regime_gate_block`)
- calibration_runtime_entry_quality: **0.4248** (raw_reason=`regime_gate_block`)
- deployed_runtime_entry_quality: **0.4248** (raw_reason=`regime_gate_block`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **3.751**
- structure_quality: **0.5955**
...
- bull_all: rows=**10183** | win_rate=**0.5962** | bias50_pct=**0.9541** | dist={'min': -1.1554, 'p25': 2.5932, 'p50': 2.8011, 'p75': 3.3094, 'p90': 3.3738, 'p95': 3.5101, 'max': 9.36, 'mean': 2.9465}
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-1.6126)
- same_gate_same_quality band: **core_normal** (pct=0.2872, Δp90=-2.2659)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-1.6126)
- bull_all band: **overheat** (pct=0.9541, Δp90=0.3772)
...
- baseline -> calibration runtime entry_quality: **0.4248 → 0.4248** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4248 → 0.4248** (Δ=**0.0**)
...
- runtime gap to floor: **0.1252**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4248**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7248**, layers **0**
- required bias50 cap to cross trade floor: **0.3135** (current=3.751)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.4302** / layers **0** / gap **0.1198**
- required_bias50_cap_after_best_scenario: **0.4035**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.5036** / layers **0** / gap **0.0464**
- required_bias50_cap_after_best_scenario: **1.6265**
