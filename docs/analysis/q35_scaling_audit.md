...
- legacy_entry_quality: **0.5656** (raw_reason=`entry_quality_C_single_layer`)
- calibration_runtime_entry_quality: **0.5656** (raw_reason=`entry_quality_C_single_layer`)
- deployed_runtime_entry_quality: **0.5656** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **-0.4675**
- structure_quality: **0.3553**
...
- same_bucket: rows=**1562** | win_rate=**0.7875** | bias50_pct=**0.0717** | dist={'min': -5.5588, 'p25': 0.4479, 'p50': 0.9529, 'p75': 1.2659, 'p90': 1.533, 'p95': 1.7352, 'max': 4.4265, 'mean': 0.7255}
- bull_all: rows=**4579** | win_rate=**0.7759** | bias50_pct=**0.173** | dist={'min': -6.9187, 'p25': 0.073, 'p50': 1.0869, 'p75': 3.0699, 'p90': 4.0978, 'p95': 4.6734, 'max': 8.0151, 'mean': 1.3662}
...
- exact lane band: **core_normal** (pct=0.12, Δp90=-1.6891)
- same_gate_same_quality band: **core_normal** (pct=0.3331, Δp90=-4.9476)
- same_bucket band: **core_normal** (pct=0.0717, Δp90=-2.0005)
- bull_all band: **core_normal** (pct=0.173, Δp90=-4.5653)
...
- runtime preview: applied=**False** | score=**0.5734999999999999** | legacy=**0.5734999999999999** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_floor_but_execution_blocked**
- baseline -> calibration runtime entry_quality: **0.5656 → 0.5656** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.5656 → 0.5656** (Δ=**0.0**)
...
- runtime gap to floor: **-0.0156**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.5656**, layers **1**
- fully relax bias50 penalty: entry_quality **0.6936**, layers **2**
- required bias50 cap to cross trade floor: **-0.4675** (current=-0.4675)
...
- best scenario: **winner_p75** → entry_quality **0.5757** / layers **1** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-0.4675**
...
- best scenario: **exact_runtime_p90** → entry_quality **0.5792** / layers **1** / gap **0.0** / target_score **0.6186**
...
- machine_read: entry_quality>=0.55=**True** | allowed_layers>0=**True**
- best scenario: **winner_triplet_p75** → entry_quality **0.623** / layers **1** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-0.4675**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 1.0, 'feat_pulse': 0.0, 'feat_ear': 0.0}** → entry_quality **0.5982** / gap **0.0** / mean_gap **0.1075**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8326** / gap **0.0** / mean_gap **0.0063**
