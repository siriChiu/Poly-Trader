...
- legacy_entry_quality: **0.4703** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4704** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.4704** (raw_reason=`entry_quality_below_trade_floor`, effective_reason=`under_minimum_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **1.3659**
- structure_quality: **0.3734**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-2.0187)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-1.9881)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-2.0189)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-2.0086)
...
- runtime preview: applied=**False** | score=**0.20682** | legacy=**0.20682** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_improves_but_still_below_floor**
- baseline -> calibration runtime entry_quality: **0.4703 → 0.4704** (Δ=**0.0001**)
- baseline -> deployed runtime entry_quality: **0.4703 → 0.4704** (Δ=**0.0001**)
...
- runtime gap to floor: **0.0796**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4703**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7083**, layers **2**
- required bias50 cap to cross trade floor: **0.0375** (current=1.3659)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4987** / layers **0** / gap **0.0513**
- required_bias50_cap_after_best_scenario: **0.511**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.65, 'feat_pulse': 0.0, 'feat_ear': 0.35}** → entry_quality **0.5539** / gap **0.0** / mean_gap **0.0055**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8286** / gap **0.0** / mean_gap **-0.0036**
