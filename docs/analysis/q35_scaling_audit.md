...
- legacy_entry_quality: **0.4569** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4569** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5541** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.9623**
...
- exact lane band: **core_normal** (pct=0.0033, Δp90=-1.4223)
- same_gate_same_quality band: **core_normal** (pct=0.0024, Δp90=-1.3917)
- same_bucket band: **core_normal** (pct=0.0033, Δp90=-1.4225)
- bull_all band: **core_normal** (pct=0.007, Δp90=-1.4122)
...
- runtime preview: applied=**False** | score=**0.08753999999999999** | legacy=**0.08753999999999999** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4569 → 0.4569** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4569 → 0.5541** (Δ=**0.0972**)
...
- runtime gap to floor: **-0.0041**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4569**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7306**, layers **2**
- required bias50 cap to cross trade floor: **0.411** (current=1.9623)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.4998** / layers **0** / gap **0.0502** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4828** / layers **0** / gap **0.0672**
- required_bias50_cap_after_best_scenario: **0.8425**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.7, 'feat_pulse': 0.05, 'feat_ear': 0.25}** → entry_quality **0.5541** / gap **0.0** / mean_gap **0.0056**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8408** / gap **0.0** / mean_gap **-0.004**
