...
- generated_at: **2026-04-21 05:07:30.758425**
...
- legacy_entry_quality: **0.4139** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4139** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5644** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.2895**
- structure_quality: **0.3698**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-2.0951)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-2.0645)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-2.0953)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-2.085)
...
- runtime preview: applied=**False** | score=**0.22209999999999996** | legacy=**0.22209999999999996** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4139 → 0.4139** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4139 → 0.5644** (Δ=**0.1505**)
...
- runtime gap to floor: **-0.0144**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4139**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6473**, layers **1**
- required bias50 cap to cross trade floor: **-0.979** (current=1.2895)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4837** / layers **0** / gap **0.0663**
- required_bias50_cap_after_best_scenario: **0.1845**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.65, 'feat_pulse': 0.0, 'feat_ear': 0.35}** → entry_quality **0.5644** / gap **0.0** / mean_gap **0.0055**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8313** / gap **0.0** / mean_gap **-0.0036**
