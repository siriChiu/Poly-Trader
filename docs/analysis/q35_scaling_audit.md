...
- generated_at: **2026-04-21 07:32:22.326895**
...
- legacy_entry_quality: **0.4547** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4547** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5559** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.5753**
- structure_quality: **0.4146**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-1.8093)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-1.7787)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-1.8095)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-1.7992)
...
- runtime preview: applied=**False** | score=**0.16494** | legacy=**0.16494** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4547 → 0.4547** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4547 → 0.5559** (Δ=**0.1012**)
...
- runtime gap to floor: **-0.0059**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4547**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7053**, layers **2**
- required bias50 cap to cross trade floor: **-0.013** (current=1.5753)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.4744** / layers **0** / gap **0.0756** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.5029** / layers **0** / gap **0.0471**
- required_bias50_cap_after_best_scenario: **0.7905**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.5, 'feat_pulse': 0.1, 'feat_ear': 0.4}** → entry_quality **0.5559** / gap **0.0** / mean_gap **0.0031**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8381** / gap **0.0** / mean_gap **-0.004**
