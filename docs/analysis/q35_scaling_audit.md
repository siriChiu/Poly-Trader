...
- generated_at: **2026-04-23 00:33:51.319077**
...
- legacy_entry_quality: **0.3885** (raw_reason=`regime_gate_block`)
- calibration_runtime_entry_quality: **0.3885** (raw_reason=`regime_gate_block`)
- deployed_runtime_entry_quality: **0.3885** (raw_reason=`regime_gate_block`, effective_reason=`under_minimum_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **3.2654**
- structure_quality: **0.4043**
...
- bull_all: rows=**10235** | win_rate=**0.5982** | bias50_pct=**0.6382** | dist={'min': -1.1554, 'p25': 2.5896, 'p50': 2.7989, 'p75': 3.3094, 'p90': 3.373, 'p95': 3.51, 'max': 9.36, 'mean': 2.9361}
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-2.0982)
- same_gate_same_quality band: **core_normal** (pct=0.2872, Δp90=-2.7515)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-2.0982)
- bull_all band: **warm** (pct=0.6382, Δp90=-0.1076)
...
- baseline -> calibration runtime entry_quality: **0.3885 → 0.3885** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.3885 → 0.3885** (Δ=**0.0**)
...
- runtime gap to floor: **0.1615**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.3885**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6885**, layers **0**
- required bias50 cap to cross trade floor: **-0.2915** (current=3.2654)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.395** / layers **0** / gap **0.155**
- required_bias50_cap_after_best_scenario: **-0.1835**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.4579** / layers **0** / gap **0.0921**
- required_bias50_cap_after_best_scenario: **0.865**
