...
- generated_at: **2026-04-21 13:19:18.585452**
...
- deployed_runtime_entry_quality: **0.5808** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.2635**
- structure_quality: **0.3575**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-2.1211)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-2.0905)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-2.1213)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-2.111)
...
- runtime preview: applied=**False** | score=**0.22729999999999997** | legacy=**0.22729999999999997** | Δ=**0.0** | segment=**None**
...
- baseline -> deployed runtime entry_quality: **0.4563 → 0.5808** (Δ=**0.1245**)
...
- runtime gap to floor: **-0.0308**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4563**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6882**, layers **2**
- required bias50 cap to cross trade floor: **-0.298** (current=1.2635)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.487** / layers **0** / gap **0.063**
- required_bias50_cap_after_best_scenario: **0.2135**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 1.0, 'feat_pulse': 0.0, 'feat_ear': 0.0}** → entry_quality **0.5808** / gap **0.0** / mean_gap **0.0104**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8343** / gap **0.0** / mean_gap **-0.0036**
