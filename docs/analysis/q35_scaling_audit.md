...
- generated_at: **2026-04-22 12:49:13.198706**
...
- legacy_entry_quality: **0.4262** (raw_reason=`regime_gate_block`)
- calibration_runtime_entry_quality: **0.4262** (raw_reason=`regime_gate_block`)
- deployed_runtime_entry_quality: **0.4262** (raw_reason=`regime_gate_block`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **3.4377**
- structure_quality: **0.5485**
...
- bull_all: rows=**10181** | win_rate=**0.5961** | bias50_pct=**0.938** | dist={'min': -1.1554, 'p25': 2.5932, 'p50': 2.8012, 'p75': 3.3094, 'p90': 3.3738, 'p95': 3.5101, 'max': 9.36, 'mean': 2.9469}
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-1.9259)
- same_gate_same_quality band: **core_normal** (pct=0.2872, Δp90=-2.5792)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-1.9259)
- bull_all band: **borderline_overheat** (pct=0.938, Δp90=0.0639)
...
- baseline -> calibration runtime entry_quality: **0.4262 → 0.4262** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4262 → 0.4262** (Δ=**0.0**)
...
- runtime gap to floor: **0.1238**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4262**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7262**, layers **0**
- required bias50 cap to cross trade floor: **0.3365** (current=3.4377)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.434** / layers **0** / gap **0.116**
- required_bias50_cap_after_best_scenario: **0.4665**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.4935** / layers **0** / gap **0.0565**
- required_bias50_cap_after_best_scenario: **1.4585**
