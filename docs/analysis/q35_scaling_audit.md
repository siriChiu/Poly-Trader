...
- legacy_entry_quality: **0.4294** (raw_reason=`regime_gate_block`)
- calibration_runtime_entry_quality: **0.4294** (raw_reason=`regime_gate_block`)
- deployed_runtime_entry_quality: **0.4294** (raw_reason=`regime_gate_block`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **2.9323**
- structure_quality: **0.6428**
...
- bull_all: rows=**10139** | win_rate=**0.5944** | bias50_pct=**0.5608** | dist={'min': -1.1554, 'p25': 2.5959, 'p50': 2.8036, 'p75': 3.3095, 'p90': 3.374, 'p95': 3.5102, 'max': 9.36, 'mean': 2.9528}
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-2.4313)
- same_gate_same_quality band: **core_normal** (pct=0.2872, Δp90=-3.0846)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-2.4313)
- bull_all band: **warm** (pct=0.5608, Δp90=-0.4417)
...
- baseline -> calibration runtime entry_quality: **0.4294 → 0.4294** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4294 → 0.4294** (Δ=**0.0**)
...
- runtime gap to floor: **0.1206**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4294**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7294**, layers **0**
- required bias50 cap to cross trade floor: **0.39** (current=2.9323)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.4318** / layers **0** / gap **0.1182**
- required_bias50_cap_after_best_scenario: **0.43**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.5082** / layers **0** / gap **0.0418**
- required_bias50_cap_after_best_scenario: **1.7035**
