...
- generated_at: **2026-04-21 06:51:38.316218**
...
- legacy_entry_quality: **0.4805** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4805** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5597** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.5019**
- structure_quality: **0.4031**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-1.8827)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-1.8521)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-1.8829)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-1.8726)
...
- runtime preview: applied=**False** | score=**0.17961999999999997** | legacy=**0.17961999999999997** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4805 → 0.4805** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4805 → 0.5597** (Δ=**0.0792**)
...
- runtime gap to floor: **-0.0097**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4805**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7266**, layers **2**
- required bias50 cap to cross trade floor: **0.3435** (current=1.5019)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.5197** / layers **0** / gap **0.0303**
- required_bias50_cap_after_best_scenario: **0.997**
...
- rows / wins / losses: **4194 / 2572 / 1622**
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.45, 'feat_pulse': 0.55, 'feat_ear': 0.0}** → entry_quality **0.5597** / gap **0.0** / mean_gap **0.0054**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8396** / gap **0.0** / mean_gap **-0.0036**
