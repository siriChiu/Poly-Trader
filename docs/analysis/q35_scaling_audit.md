...
- generated_at: **2026-05-25 01:10:28.179561**
...
- feat_4h_bias50: **0.1025**
- structure_quality: **0.408**

## Exact lane summary

- rows: **964** | win_rate: **0.7365**
- bias50 distribution: {'min': -1.2312, 'p25': 0.6815, 'p50': 1.1118, 'p75': 1.3382, 'p90': 1.6507, 'p95': 1.8129, 'max': 4.4265, 'mean': 1.0501}
- current bias50 percentile in exact lane: **0.083**
- winner-only bias50 distribution: {'min': -1.1316, 'p25': 0.6355, 'p50': 1.0636, 'p75': 1.3278, 'p90': 1.6068, 'p95': 1.7757, 'max': 3.9157, 'mean': 1.0126}

## Broader bull cohorts

- same_gate_same_quality: rows=**3221** | win_rate=**0.7597** | bias50_pct=**0.1916** | dist={'min': -1.9, 'p25': 0.3423, 'p50': 1.2863, 'p75': 3.1735, 'p90': 4.0361, 'p95': 4.5297, 'max': 8.0151, 'mean': 1.6845}
- same_bucket: rows=**1576** | win_rate=**0.7849** | bias50_pct=**0.1688** | dist={'min': -5.5588, 'p25': 0.4334, 'p50': 0.9502, 'p75': 1.2607, 'p90': 1.53, 'p95': 1.7263, 'max': 4.4265, 'mean': 0.7156}
- bull_all: rows=**4593** | win_rate=**0.7751** | bias50_pct=**0.2652** | dist={'min': -6.9187, 'p25': 0.0679, 'p50': 1.0839, 'p75': 3.0659, 'p90': 4.0963, 'p95': 4.6724, 'max': 8.0151, 'mean': 1.3608}
...
- exact lane band: **core_normal** (pct=0.083, Δp90=-1.5482)
- same_gate_same_quality band: **core_normal** (pct=0.1916, Δp90=-3.9336)
- same_bucket band: **core_normal** (pct=0.1688, Δp90=-1.4275)
- bull_all band: **core_normal** (pct=0.2652, Δp90=-3.9938)
- reference cohort: **same_gate_same_quality** / label=同 bull gate + 同 quality lane / pct=0.1916
- note: current bias50 已回到 exact lane p90 內；下一步應做 exact-lane 內的保守 bias50 校準 / 公式檢查，而不是再走 broader bull segmentation。
- runtime preview: applied=**False** | score=**0.45949999999999996** | legacy=**0.45949999999999996** | Δ=**0.0** | segment=**None**
...
- fully relax bias50 penalty: entry_quality **0.6574**, layers **1**
- required bias50 cap to cross trade floor: **-0.811** (current=0.1025)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.5052** / layers **0** / gap **0.0448**
- required_bias50_cap_after_best_scenario: **-0.644**
...
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.563** / layers **1** / gap **0.0**
- required_bias50_cap_after_best_scenario: **0.1025**
...
- rows / wins / losses: **964 / 710 / 254**
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.75, 'feat_ear': 0.25}** → entry_quality **0.559** / gap **0.0** / mean_gap **0.0516**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.832** / gap **0.0** / mean_gap **0.0185**
