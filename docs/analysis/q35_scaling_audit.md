...
- legacy_entry_quality: **0.4808** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4808** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5576** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.3121**
- structure_quality: **0.3677**
...
- exact lane band: **core_normal** (pct=0.0, Δp90=-2.0725)
- same_gate_same_quality band: **core_normal** (pct=0.0007, Δp90=-2.0419)
- same_bucket band: **core_normal** (pct=0.0, Δp90=-2.0727)
- bull_all band: **core_normal** (pct=0.0054, Δp90=-2.0624)
...
- runtime preview: applied=**False** | score=**0.21757999999999997** | legacy=**0.21757999999999997** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4808 → 0.4808** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4808 → 0.5576** (Δ=**0.0768**)
...
- runtime gap to floor: **-0.0076**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4808**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7155**, layers **2**
- required bias50 cap to cross trade floor: **0.1585** (current=1.3121)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.4846** / layers **0** / gap **0.0654** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4904** / layers **0** / gap **0.0596**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.85, 'feat_pulse': 0.0, 'feat_ear': 0.15}** → entry_quality **0.5576** / gap **0.0** / mean_gap **0.0075**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8376** / gap **0.0** / mean_gap **-0.004**
