...
- generated_at: **2026-04-22 02:34:04.180761**
...
- legacy_entry_quality: **0.4283** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4283** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5573** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **2.2913**
...
- current bias50 percentile in exact lane: **0.0225**
...
- same_gate_same_quality: rows=**9565** | win_rate=**0.612** | bias50_pct=**0.0583** | dist={'min': -1.1489, 'p25': 2.6003, 'p50': 2.7934, 'p75': 3.3013, 'p90': 3.3536, 'p95': 3.3792, 'max': 4.9835, 'mean': 2.8863}
- same_bucket: rows=**4263** | win_rate=**0.6097** | bias50_pct=**0.0225** | dist={'min': 1.2403, 'p25': 3.2671, 'p50': 3.3094, 'p75': 3.3474, 'p90': 3.384, 'p95': 3.447, 'max': 4.9835, 'mean': 3.2566}
- bull_all: rows=**10133** | win_rate=**0.5942** | bias50_pct=**0.0696** | dist={'min': -1.1554, 'p25': 2.5959, 'p50': 2.8045, 'p75': 3.3095, 'p90': 3.374, 'p95': 3.5102, 'max': 9.36, 'mean': 2.954}
...
- exact lane band: **core_normal** (pct=0.0225, Δp90=-1.0927)
- same_gate_same_quality band: **core_normal** (pct=0.0583, Δp90=-1.0623)
- same_bucket band: **core_normal** (pct=0.0225, Δp90=-1.0927)
- bull_all band: **core_normal** (pct=0.0696, Δp90=-1.0827)
- reference cohort: **same_gate_same_quality** / label=同 bull gate + 同 quality lane / pct=0.0583
- note: current bias50 已回到 exact lane p90 內；下一步應做 exact-lane 內的保守 bias50 校準 / 公式檢查，而不是再走 broader bull segmentation。
- runtime preview: applied=**False** | score=**0.02173999999999996** | legacy=**0.02173999999999996** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4283 → 0.4283** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4283 → 0.5573** (Δ=**0.129**)
...
- runtime gap to floor: **-0.0073**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4283**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7218**, layers **2**
- required bias50 cap to cross trade floor: **0.263** (current=2.2913)
...
- required_bias50_cap_after_best_scenario: **1.1615**
...
- rows / wins / losses: **4262 / 2598 / 1664**
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.55, 'feat_pulse': 0.0, 'feat_ear': 0.45}** → entry_quality **0.5573** / gap **0.0** / mean_gap **0.0041**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8567** / gap **0.0** / mean_gap **-0.0041**
