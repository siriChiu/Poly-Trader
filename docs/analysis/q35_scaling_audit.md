...
- generated_at: **2026-04-24 01:50:14.374702**
...
- legacy_entry_quality: **0.391** (raw_reason=`regime_gate_block`)
- calibration_runtime_entry_quality: **0.391** (raw_reason=`regime_gate_block`)
- deployed_runtime_entry_quality: **0.391** (raw_reason=`regime_gate_block`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **2.7049**
- structure_quality: **0.4283**
...
- bull_all: rows=**10723** | win_rate=**0.5911** | bias50_pct=**0.6653** | dist={'min': -20.6429, 'p25': -1.4045, 'p50': 1.2979, 'p75': 3.4923, 'p90': 5.1601, 'p95': 6.0628, 'max': 17.0434, 'mean': 0.9724}
...
- exact lane band: **warm** (pct=0.5707, Δp90=-2.2447)
- same_gate_same_quality band: **warm** (pct=0.548, Δp90=-4.4354)
- same_bucket band: **warm** (pct=0.5949, Δp90=-2.151)
- bull_all band: **warm** (pct=0.6653, Δp90=-2.4552)
...
- baseline -> calibration runtime entry_quality: **0.391 → 0.391** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.391 → 0.391** (Δ=**0.0**)
...
- runtime gap to floor: **0.159**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.391**, layers **0**
- fully relax bias50 penalty: entry_quality **0.691**, layers **0**
- required bias50 cap to cross trade floor: **-0.25** (current=2.7049)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.4363** / layers **0** / gap **0.1137**
- required_bias50_cap_after_best_scenario: **0.505**
...
- best scenario: **exact_runtime_p90** → entry_quality **0.49** / layers **0** / gap **0.06** / target_score **0.33**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4995** / layers **0** / gap **0.0505**
- required_bias50_cap_after_best_scenario: **0.1685**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.65, 'feat_pulse': 0.0, 'feat_ear': 0.35}** → entry_quality **0.5558** / gap **0.0** / mean_gap **0.004**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8432** / gap **0.0** / mean_gap **-0.0269**
