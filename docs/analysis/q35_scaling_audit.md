...
- generated_at: **2026-04-21 01:08:16.415721**
...
- legacy_entry_quality: **0.4794** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4794** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.5663** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **True**
- feat_4h_bias50: **1.8826**
- structure_quality: **0.4569**
...
- exact lane band: **core_normal** (pct=0.0021, Δp90=-1.502)
- same_gate_same_quality band: **core_normal** (pct=0.0019, Δp90=-1.4714)
- same_bucket band: **core_normal** (pct=0.0021, Δp90=-1.5022)
- bull_all band: **core_normal** (pct=0.0065, Δp90=-1.4919)
...
- runtime preview: applied=**False** | score=**0.10347999999999997** | legacy=**0.10347999999999997** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_trade_floor**
- baseline -> calibration runtime entry_quality: **0.4794 → 0.4794** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4794 → 0.5663** (Δ=**0.0869**)
...
- runtime gap to floor: **-0.0163**
- next patch target: **verify_runtime_guardrails**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4794**, layers **0**
- fully relax bias50 penalty: entry_quality **0.7484**, layers **2**
- required bias50 cap to cross trade floor: **0.706** (current=1.8826)
...
- best scenario: **exact_runtime_p90** → entry_quality **0.5175** / layers **0** / gap **0.0325** / target_score **0.2304**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.5242** / layers **0** / gap **0.0258**
- required_bias50_cap_after_best_scenario: **1.4525**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.5, 'feat_pulse': 0.5, 'feat_ear': 0.0}** → entry_quality **0.5663** / gap **0.0** / mean_gap **0.0045**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8465** / gap **0.0** / mean_gap **-0.004**
