...
- generated_at: **2026-05-02 01:02:20.716721**
...
- legacy_entry_quality: **0.4408** (raw_reason=`entry_quality_below_trade_floor`)
- calibration_runtime_entry_quality: **0.4408** (raw_reason=`entry_quality_below_trade_floor`)
- deployed_runtime_entry_quality: **0.4408** (raw_reason=`entry_quality_below_trade_floor`, effective_reason=`under_minimum_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **1.33**
- structure_quality: **0.4618**

## Exact lane summary

- rows: **874** | win_rate: **0.7769**
- bias50 distribution: {'min': -0.4035, 'p25': 0.7875, 'p50': 1.1449, 'p75': 1.3669, 'p90': 1.6949, 'p95': 1.8374, 'max': 4.4265, 'mean': 1.1028}
- current bias50 percentile in exact lane: **0.7162**
- winner-only bias50 distribution: {'min': -0.4035, 'p25': 0.6319, 'p50': 1.0706, 'p75': 1.3466, 'p90': 1.6072, 'p95': 1.7763, 'max': 3.9157, 'mean': 1.0261}

## Broader bull cohorts

- same_gate_same_quality: rows=**2887** | win_rate=**0.8046** | bias50_pct=**0.4732** | dist={'min': -1.7439, 'p25': 0.6931, 'p50': 1.4299, 'p75': 3.2782, 'p90': 4.0983, 'p95': 4.6111, 'max': 8.0151, 'mean': 1.957}
- same_bucket: rows=**1408** | win_rate=**0.8395** | bias50_pct=**0.7976** | dist={'min': -5.5588, 'p25': 0.5057, 'p50': 0.9944, 'p75': 1.2897, 'p90': 1.5575, 'p95': 1.7562, 'max': 4.4265, 'mean': 0.8252}
- bull_all: rows=**4037** | win_rate=**0.8288** | bias50_pct=**0.5375** | dist={'min': -6.9187, 'p25': 0.3567, 'p50': 1.2544, 'p75': 3.2265, 'p90': 4.2186, 'p95': 4.7277, 'max': 8.0151, 'mean': 1.6679}
...
- exact lane band: **warm** (pct=0.7162, Δp90=-0.3649)
- same_gate_same_quality band: **core_normal** (pct=0.4732, Δp90=-2.7683)
- same_bucket band: **elevated_but_within_p90** (pct=0.7976, Δp90=-0.2275)
- bull_all band: **warm** (pct=0.5375, Δp90=-2.8886)
- reference cohort: **same_gate_same_quality** / label=同 bull gate + 同 quality lane / pct=0.4732
- note: current bias50 已回到 exact lane p90 內；下一步應做 exact-lane 內的保守 bias50 校準 / 公式檢查，而不是再走 broader bull segmentation。
- runtime preview: applied=**False** | score=**0.21399999999999997** | legacy=**0.21399999999999997** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_no_material_improvement**
- baseline -> calibration runtime entry_quality: **0.4408 → 0.4408** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.4408 → 0.4408** (Δ=**0.0**)
...
- runtime gap to floor: **0.1092**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.4408**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6766**, layers **1**
- required bias50 cap to cross trade floor: **-0.49** (current=1.33)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.4459** / layers **0** / gap **0.1041**
- required_bias50_cap_after_best_scenario: **-0.405**
...
- best scenario: **exact_runtime_p90** → entry_quality **0.504** / layers **0** / gap **0.046** / target_score **0.4245**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.5463** / layers **0** / gap **0.0037**
- required_bias50_cap_after_best_scenario: **0.5705**
...
- rows / wins / losses: **874 / 679 / 195**
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.4, 'feat_nose': 0.0, 'feat_pulse': 0.1, 'feat_ear': 0.5}** → entry_quality **0.5567** / gap **0.0** / mean_gap **0.0326**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8096** / gap **0.0** / mean_gap **0.0097**
