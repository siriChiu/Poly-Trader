...
- legacy_entry_quality: **0.6626** (raw_reason=`entry_quality_C_single_layer`)
- calibration_runtime_entry_quality: **0.6626** (raw_reason=`entry_quality_C_single_layer`)
- deployed_runtime_entry_quality: **0.6626** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **-1.585**
...
- exact lane band: **core_normal** (pct=0.0157, Δp90=-2.8418)
- same_gate_same_quality band: **core_normal** (pct=0.0431, Δp90=-6.1976)
- same_bucket band: **core_normal** (pct=0.0237, Δp90=-3.136)
- bull_all band: **core_normal** (pct=0.0223, Δp90=-5.7316)
...
- runtime preview: applied=**False** | score=**0.7969999999999999** | legacy=**0.7969999999999999** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_floor_but_execution_blocked**
- baseline -> calibration runtime entry_quality: **0.6626 → 0.6626** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.6626 → 0.6626** (Δ=**0.0**)
...
- runtime gap to floor: **-0.1126**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.6626**, layers **1**
- fully relax bias50 penalty: entry_quality **0.7235**, layers **2**
- required bias50 cap to cross trade floor: **-1.585** (current=-1.585)
...
- best scenario: **exact_lane_p75** → entry_quality **0.6834** / layers **2** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-1.585**
...
- machine_read: entry_quality>=0.55=**True** | allowed_layers>0=**True**
- best scenario: **exact_lane_triplet_p75** → entry_quality **0.7055** / layers **2** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-1.585**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 1.0, 'feat_ear': 0.0}** → entry_quality **0.7019** / gap **0.0** / mean_gap **0.0071**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8146** / gap **0.0** / mean_gap **0.0028**
