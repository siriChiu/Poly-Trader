...
- generated_at: **2026-04-23 22:15:48.219880**
...
- legacy_entry_quality: **0.3712** (raw_reason=`regime_gate_block`)
- calibration_runtime_entry_quality: **0.3712** (raw_reason=`regime_gate_block`)
- deployed_runtime_entry_quality: **0.3712** (raw_reason=`regime_gate_block`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **2.3925**
- structure_quality: **0.3746**
...
- bull_all: rows=**10551** | win_rate=**0.5942** | bias50_pct=**0.6376** | dist={'min': -20.6429, 'p25': -1.4512, 'p50': 1.188, 'p75': 3.4362, 'p90': 5.197, 'p95': 6.0856, 'max': 17.0434, 'mean': 0.9299}
...
- exact lane band: **warm** (pct=0.5489, Δp90=-2.5571)
- same_gate_same_quality band: **warm** (pct=0.528, Δp90=-4.7478)
- same_bucket band: **warm** (pct=0.5744, Δp90=-2.4634)
- bull_all band: **warm** (pct=0.6376, Δp90=-2.8045)
...
- runtime preview: applied=**False** | score=**0.001499999999999968** | legacy=**0.001499999999999968** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_no_material_improvement**
- baseline -> calibration runtime entry_quality: **0.3712 → 0.3712** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.3712 → 0.3712** (Δ=**0.0**)
...
- runtime gap to floor: **0.1788**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.3712**, layers **0**
- fully relax bias50 penalty: entry_quality **0.6708**, layers **0**
- required bias50 cap to cross trade floor: **-0.5875** (current=2.3925)
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **exact_lane_p75** → entry_quality **0.4197** / layers **0** / gap **0.1303**
- required_bias50_cap_after_best_scenario: **0.221**
...
- best scenario: **exact_runtime_p90** → entry_quality **0.4698** / layers **0** / gap **0.0802** / target_score **0.33**
...
- machine_read: entry_quality>=0.55=**False** | allowed_layers>0=**False**
- best scenario: **winner_triplet_p75** → entry_quality **0.4953** / layers **0** / gap **0.0547**
- required_bias50_cap_after_best_scenario: **0.0985**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 1.0, 'feat_pulse': 0.0, 'feat_ear': 0.0}** → entry_quality **0.2982** / gap **0.2518** / mean_gap **0.0207**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8416** / gap **0.0** / mean_gap **-0.0269**
