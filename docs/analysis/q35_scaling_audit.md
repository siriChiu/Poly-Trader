...
- legacy_entry_quality: **0.5579** (raw_reason=`entry_quality_C_single_layer`)
- calibration_runtime_entry_quality: **0.5579** (raw_reason=`entry_quality_C_single_layer`)
- deployed_runtime_entry_quality: **0.5579** (raw_reason=`entry_quality_C_single_layer`, effective_reason=`unsupported_exact_live_structure_bucket`)
- q35_discriminative_redesign_applied: **False**
- feat_4h_bias50: **-0.4773**
- structure_quality: **0.3535**
...
- bull_all: rows=**4579** | win_rate=**0.7759** | bias50_pct=**0.1719** | dist={'min': -6.9187, 'p25': 0.073, 'p50': 1.0869, 'p75': 3.0699, 'p90': 4.0978, 'p95': 4.6734, 'max': 8.0151, 'mean': 1.3662}
...
- exact lane band: **core_normal** (pct=0.12, Δp90=-1.6989)
- same_gate_same_quality band: **core_normal** (pct=0.3331, Δp90=-4.9574)
- same_bucket band: **core_normal** (pct=0.0717, Δp90=-2.0103)
- bull_all band: **core_normal** (pct=0.1719, Δp90=-4.5751)
...
- runtime preview: applied=**False** | score=**0.57546** | legacy=**0.57546** | Δ=**0.0** | segment=**None**

## Deployment-grade component experiment

- verdict: **runtime_patch_crosses_floor_but_execution_blocked**
- baseline -> calibration runtime entry_quality: **0.5579 → 0.5579** (Δ=**0.0**)
- baseline -> deployed runtime entry_quality: **0.5579 → 0.5579** (Δ=**0.0**)
...
- runtime gap to floor: **-0.0079**
- next patch target: **feat_4h_bias50_formula**

## Counterfactuals

- gate -> ALLOW only: entry_quality **0.5579**, layers **1**
- fully relax bias50 penalty: entry_quality **0.6853**, layers **2**
- required bias50 cap to cross trade floor: **-0.4775** (current=-0.4773)
...
- best scenario: **winner_p75** → entry_quality **0.568** / layers **1** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-0.4775**
...
- best scenario: **exact_runtime_p90** → entry_quality **0.5709** / layers **1** / gap **0.0** / target_score **0.6186**
...
- machine_read: entry_quality>=0.55=**True** | allowed_layers>0=**True**
- best scenario: **winner_triplet_p75** → entry_quality **0.6224** / layers **1** / gap **0.0**
- required_bias50_cap_after_best_scenario: **-0.4775**
...
- best discriminative candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.9, 'feat_pulse': 0.0, 'feat_ear': 0.1}** → entry_quality **0.5544** / gap **0.0** / mean_gap **0.0974**
- best floor candidate: weights=**{'feat_4h_bias50': 0.0, 'feat_nose': 0.0, 'feat_pulse': 0.0, 'feat_ear': 1.0}** → entry_quality **0.8273** / gap **0.0** / mean_gap **0.0063**
