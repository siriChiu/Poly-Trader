...
- current_live_structure_bucket_rows: **93**
...
- support_progress.current_rows / minimum: **93 / 50**
- support_progress.previous_rows: **94**
...
- best_single_component_required_score_delta: **0.5053**
