...
- support_progress.delta_vs_previous: **28**
...
- support_progress.reason: current live exact support 目前是 28/50，仍低於 minimum；歷史上同 bucket 曾有 190/50（heartbeat 1202），語義證據已回填但不吻合 current support_identity（mismatched=['calibration_window', 'entry_quality_label', 'regime_label'], missing=[]），只能當 legacy reference，不能宣稱為 same-identity regression。
...
- current_entry_quality: **0.6598**
- trade_floor: **0.55**
- current_trade_floor_gap: **0.1098**
