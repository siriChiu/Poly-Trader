...
- current_live_structure_bucket_rows: **121**
...
- exact-bucket proxy rows: **64**
- exact-lane proxy rows: **149**
...
- support_progress.current_rows / minimum: **121 / 50**
...
- best_single_component_required_score_delta: **0.219**
...
- preserves_positive_discrimination: **None** (not_measured_single_bucket_exact_lane)
