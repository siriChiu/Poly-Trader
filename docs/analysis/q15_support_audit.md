...
- support_progress.previous_rows: **39**
...
- legacy reference heartbeat/rows/minimum: **1434 / 66 / 50**
...
- support_progress.reason: current q15 exact support 目前是 41/50，仍低於 minimum；歷史上同 bucket 曾有 66/50（heartbeat 1434），語義證據已回填但不吻合 current support_identity（mismatched=['regime_label'], missing=[]），只能當 legacy reference，不能宣稱為 same-identity regression。
...
- current_entry_quality: **0.5895**
- trade_floor: **0.55**
- current_trade_floor_gap: **0.0395**
