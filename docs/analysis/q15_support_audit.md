...
- current_entry_quality: **0.5652**
- trade_floor: **0.55**
- current_trade_floor_gap: **0.0152**
...
- actions: `['collect_exact_current_bucket_rows', 'force_q15_support_audit_refresh', 'semantic_signature_map_signal_redesign_or_row_harvest']`
