...
- current_live_structure_bucket_rows: **44**
...
- current bucket gap to minimum: **6**
...
- support_progress.current_rows / minimum: **44 / 50**
- support_progress.previous_rows: **33**
- support_progress.delta_vs_previous: **11**
...
- support_progress.reason: current q15 exact support 目前是 44/50，仍低於 minimum；歷史上同 bucket 曾有 53/50（heartbeat 20260419b），語義證據已回填但不吻合 current support_identity（mismatched=['entry_quality_label', 'regime_label'], missing=[]），只能當 legacy reference，不能宣稱為 same-identity regression。
...
- current_entry_quality: **0.6124**
- trade_floor: **0.55**
- current_trade_floor_gap: **0.0624**
...
- support rows / minimum / gap: **44 / 50 / 6**
