...
- current_live_structure_bucket_rows: **97**
...
- support_progress.current_rows / minimum: **97 / 50**
- support_progress.previous_rows: **97**
...
- best_single_component_required_score_delta: **0.3897**
