...
- support_progress.delta_vs_previous: **-91**
...
- support_progress.reason: current q15 exact support 自最近一次已就緒 95/50（heartbeat 1188） 回落；需優先檢查 current bucket / support artifact 是否退化。
...
- best_single_component_required_score_delta: **0.189**
- best_single_component_can_cross_floor: **True**
- reason: feat_4h_bias50 在數學上可單點補足 floor gap（需要 score Δ≈0.189），但 current q15 exact support 尚未達 deployment 門檻，因此不得單靠 component calibration 解除 blocker。
...
- current_entry_quality: **0.4933**
- trade_floor: **0.55**
- current_trade_floor_gap: **-0.0567**
