...
- generated_at: **2026-05-26 21:14:48.332682**
...
- best_single_component_required_score_delta: **0.1203**
- best_single_component_can_cross_floor: **True**
- reason: 目前先被 runtime blocker 擋下（Consecutive loss streak: 79 >= 50; Recent 50-sample win rate: 0.00% < 30%），不能把 q15 floor-cross 當成當前 deploy 入口。
...
- current_entry_quality: **0.5139**
- trade_floor: **0.55**
- current_trade_floor_gap: **-0.0361**
...
- reason: 目前先被 runtime blocker 擋下（Consecutive loss streak: 79 >= 50; Recent 50-sample win rate: 0.00% < 30%），q15 component experiment 只能保留為背景研究。
