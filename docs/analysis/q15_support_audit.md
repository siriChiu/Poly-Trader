...
- allowed_layers: **0** (unsupported_live_structure_bucket_blocks_trade; under_minimum_exact_live_structure_bucket)
...
- reason: feat_4h_bias50 在數學上可單點補足 floor gap（需要 score Δ≈0.7767），但 current q15 exact support 尚未達 deployment 門檻，因此不得單靠 component calibration 解除 blocker。
