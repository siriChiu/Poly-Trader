...
- support_progress.reason: current q15 exact support 目前是 4/50，仍低於 minimum；歷史上同 bucket 曾有 53/50（heartbeat 20260419b），但該 artifact 缺少相同 support_identity / bucket_semantic_signature，只能當 legacy reference，不能宣稱為 same-identity regression。
...
- current_entry_quality: **0.6155**
- trade_floor: **0.55**
- current_trade_floor_gap: **0.0655**
