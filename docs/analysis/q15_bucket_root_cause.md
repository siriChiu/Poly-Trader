...
- generated_at: **2026-04-23 17:15:18.089180**
...
- structure_quality: **0.3228**
- gap_to_q35_boundary: **0.0272**
...
- near_boundary_window: `{'lower': 0.3228, 'upper': 0.35}`
...
- candidate_patch: `{'type': None, 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.4101, 'current_normalized': 0.4101, 'needed_raw_delta_to_cross_q35': 0.08, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.5899, 'needed_raw_delta_to_target_median': 0.5899}`
- verify_next: 先讓 canonical breaker release condition 接近解除，再重跑 hb_predict_probe.py 與 q15 root-cause artifact。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.4101 / norm=0.4101 / Δto_cross_q35=0.08 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.3401 / norm=0.1675 / Δto_cross_q35=0.6594 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=3.881 / norm=0.3881 / Δto_cross_q35=0.8242 / target_p25=5.4449 / target_median=5.5338
