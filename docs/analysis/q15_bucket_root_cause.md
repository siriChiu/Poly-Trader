...
- generated_at: **2026-05-18 16:35:39.972885**
...
- structure_quality: **0.0822**
- gap_to_q35_boundary: **0.2678**
...
## Exact live lane
- rows: **91**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 91}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (91 rows)
- near_boundary_window: `{'lower': 0.0822, 'upper': 0.35}`
- near_boundary_rows: **91**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.1837 / norm=0.1837 / Δto_cross_q35=0.7876 / target_p25=0.3823 / target_median=0.4435
- `feat_4h_dist_bb_lower`: current=0.4776 / norm=0.0597 / Δto_cross_q35=6.4921 / target_p25=0.9739 / target_median=1.1061
- `feat_4h_dist_swing_low`: current=-1.5775 / norm=0.0 / Δto_cross_q35=9.6927 / target_p25=-0.6397 / target_median=0.4187
