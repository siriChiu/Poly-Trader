...
- generated_at: **2026-04-27 17:33:31.029926**
...
- structure_quality: **0.0775**
- gap_to_q35_boundary: **0.2725**
...
- near_boundary_window: `{'lower': 0.0775, 'upper': 0.35}`
- near_boundary_rows: **552**

## Decision
- reason: same exact lane 有明顯鄰近 bucket 樣本，current row 與 q35 support 的差距主要來自結構 component，不是 generic breaker / q35 總體治理。
- candidate_patch: `{'type': 'structure_component_scoring', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.1657, 'current_normalized': 0.1657, 'needed_raw_delta_to_cross_q35': 0.8015, 'target_bucket_p25': 0.7098, 'target_bucket_median': 0.7516, 'needed_raw_delta_to_target_p25': 0.5441, 'needed_raw_delta_to_target_median': 0.5859}`
- verify_next: 比較 current row 與 dominant neighbor bucket 的 4H component 差值，再做最小 counterfactual。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.1657 / norm=0.1657 / Δto_cross_q35=0.8015 / target_p25=0.7098 / target_median=0.7516
- `feat_4h_dist_bb_lower`: current=0.514 / norm=0.0643 / Δto_cross_q35=6.6061 / target_p25=4.2535 / target_median=5.7387
- `feat_4h_dist_swing_low`: current=-0.3148 / norm=0.0 / Δto_cross_q35=8.5724 / target_p25=8.0696 / target_median=9.098
