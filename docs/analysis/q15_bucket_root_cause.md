...
## Exact live lane
- rows: **1527**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q15': 599, 'CAUTION|base_caution_regime_or_bias|q00': 370, 'CAUTION|base_caution_regime_or_bias|q35': 277, 'CAUTION|base_caution_regime_or_bias|q65': 221, 'CAUTION|base_caution_regime_or_bias|q85': 60}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q15** (599 rows)
- near_boundary_window: `{'lower': 0.4006, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.6294 / norm=0.6294 / Δto_cross_q35=0.0 / target_p25=0.2265 / target_median=0.3916
- `feat_4h_dist_bb_lower`: current=1.3277 / norm=0.166 / Δto_cross_q35=0.0 / target_p25=0.859 / target_median=1.185
- `feat_4h_dist_swing_low`: current=3.9958 / norm=0.3996 / Δto_cross_q35=0.0 / target_p25=0.8925 / target_median=1.9581
