...
- generated_at: **2026-05-21 07:12:43.279502**
...
- structure_quality: **0.3023**
- gap_to_q35_boundary: **0.0477**
...
## Exact live lane
- rows: **235**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q65': 67, 'CAUTION|base_caution_regime_or_bias|q00': 63, 'CAUTION|base_caution_regime_or_bias|q15': 57, 'CAUTION|base_caution_regime_or_bias|q85': 27, 'CAUTION|base_caution_regime_or_bias|q35': 21}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** (67 rows)
- near_boundary_window: `{'lower': 0.3023, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5324 / norm=0.5324 / Δto_cross_q35=0.1403 / target_p25=0.7082 / target_median=0.7643
- `feat_4h_dist_bb_lower`: current=1.3248 / norm=0.1656 / Δto_cross_q35=1.1564 / target_p25=5.5052 / target_median=5.8772
- `feat_4h_dist_swing_low`: current=2.0197 / norm=0.202 / Δto_cross_q35=1.4455 / target_p25=8.7982 / target_median=9.2352
