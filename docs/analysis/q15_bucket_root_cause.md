...
- generated_at: **2026-04-25 07:28:02.115827**
...
- support rows/minimum/gap: **80 / 50 / 0**

## Exact live lane
- rows: **1840**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q65': 578, 'CAUTION|base_caution_regime_or_bias|q35': 455, 'CAUTION|base_caution_regime_or_bias|q85': 323, 'CAUTION|base_caution_regime_or_bias|q15': 279, 'CAUTION|base_caution_regime_or_bias|q00': 205}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.4162 / norm=0.4162 / Δto_cross_q35=0.3926 / target_p25=0.7102 / target_median=0.753
- `feat_4h_dist_bb_lower`: current=1.24 / norm=0.155 / Δto_cross_q35=3.2364 / target_p25=4.7576 / target_median=5.7345
- `feat_4h_dist_swing_low`: current=0.7215 / norm=0.0722 / Δto_cross_q35=4.0455 / target_p25=8.0553 / target_median=9.09
