...
- generated_at: **2026-05-19 13:02:21.287239**
...
- structure_quality: **0.2707**
- gap_to_q35_boundary: **0.0793**
...
## Exact live lane
- rows: **137**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 109, 'CAUTION|base_caution_regime_or_bias|q00': 26, 'CAUTION|base_caution_regime_or_bias|q15': 2}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (109 rows)
- near_boundary_window: `{'lower': 0.2707, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5189 / norm=0.5189 / Δto_cross_q35=0.2332 / target_p25=0.3928 / target_median=0.4551
- `feat_4h_dist_bb_lower`: current=1.3263 / norm=0.1658 / Δto_cross_q35=1.9224 / target_p25=0.9986 / target_median=1.1465
- `feat_4h_dist_swing_low`: current=1.1991 / norm=0.1199 / Δto_cross_q35=2.403 / target_p25=-0.566 / target_median=0.5205
