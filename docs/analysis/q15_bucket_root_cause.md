...
- support rows/minimum/gap: **19 / 50 / 31**

## Exact live lane
- rows: **22**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 19, 'CAUTION|structure_quality_caution|q35': 3}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** (3 rows)
- near_boundary_window: `{'lower': 0.3024, 'upper': 0.35}`
- near_boundary_rows: **5**

## Decision
- reason: current-live q15 bucket exact support 目前為 19/50，低於 minimum；這是 current exact support under minimum，不是 boundary candidate。
- candidate_patch: `{}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.6078 / norm=0.6078 / Δto_cross_q35=0.14 / target_p25=0.661 / target_median=0.6644
- `feat_4h_dist_bb_lower`: current=1.3388 / norm=0.1673 / Δto_cross_q35=1.1539 / target_p25=1.7729 / target_median=1.7816
- `feat_4h_dist_swing_low`: current=1.2265 / norm=0.1226 / Δto_cross_q35=1.4424 / target_p25=0.99 / target_median=1.803
