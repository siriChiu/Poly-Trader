...
- generated_at: **2026-05-22 08:11:55.528798**
...
- structure_quality: **0.2177**
- gap_to_q35_boundary: **0.1323**
- non_null_4h_feature_count: **10**
- execution_guardrail_reason: `decision_quality_below_trade_floor; circuit_breaker_active`
- support rows/minimum/gap: **34 / 50 / 16**

## Exact live lane
- rows: **313**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q15': 88, 'CAUTION|base_caution_regime_or_bias|q35': 80, 'CAUTION|base_caution_regime_or_bias|q00': 63, 'CAUTION|base_caution_regime_or_bias|q65': 55, 'CAUTION|base_caution_regime_or_bias|q85': 27}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** (80 rows)
- near_boundary_window: `{'lower': 0.2177, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.43 / norm=0.43 / Δto_cross_q35=0.3891 / target_p25=0.6666 / target_median=0.7042
- `feat_4h_dist_bb_lower`: current=1.0374 / norm=0.1297 / Δto_cross_q35=3.2073 / target_p25=1.6364 / target_median=1.7288
- `feat_4h_dist_swing_low`: current=0.8712 / norm=0.0871 / Δto_cross_q35=4.0091 / target_p25=1.8857 / target_median=2.0629
