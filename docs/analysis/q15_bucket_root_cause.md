...
## Exact live lane
- rows: **142**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 109, 'CAUTION|base_caution_regime_or_bias|q00': 31, 'CAUTION|base_caution_regime_or_bias|q15': 2}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (109 rows)
- near_boundary_window: `{'lower': 0.197, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.3919 / norm=0.3919 / Δto_cross_q35=0.45 / target_p25=0.3928 / target_median=0.4551
- `feat_4h_dist_bb_lower`: current=0.9953 / norm=0.1244 / Δto_cross_q35=3.7091 / target_p25=0.9986 / target_median=1.1465
- `feat_4h_dist_swing_low`: current=0.6884 / norm=0.0688 / Δto_cross_q35=4.6364 / target_p25=-0.566 / target_median=0.5205
