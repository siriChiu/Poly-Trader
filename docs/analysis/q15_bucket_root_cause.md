...
- generated_at: **2026-05-24 17:14:35.040838**
...
- structure_quality: **0.3345**
- gap_to_q35_boundary: **0.0155**
...
## Exact live lane
- rows: **339**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q15': 147, 'CAUTION|base_caution_regime_or_bias|q35': 80, 'CAUTION|base_caution_regime_or_bias|q00': 63, 'CAUTION|base_caution_regime_or_bias|q65': 30, 'CAUTION|base_caution_regime_or_bias|q85': 19}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** (80 rows)
- near_boundary_window: `{'lower': 0.3345, 'upper': 0.35}`
- near_boundary_rows: **14**

## Decision
- reason: current-live q15 bucket exact support 目前為 32/50，低於 minimum；這是 current exact support under minimum，不是 boundary candidate。
- candidate_patch: `{}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5277 / norm=0.5277 / Δto_cross_q35=0.0456 / target_p25=0.6666 / target_median=0.7042
- `feat_4h_dist_bb_lower`: current=1.2932 / norm=0.1616 / Δto_cross_q35=0.3758 / target_p25=1.6364 / target_median=1.7288
- `feat_4h_dist_swing_low`: current=3.0841 / norm=0.3084 / Δto_cross_q35=0.4697 / target_p25=1.8857 / target_median=2.0629
