...
- generated_at: **2026-05-18 09:01:47.130916**
...
- structure_quality: **0.1175**
- gap_to_q35_boundary: **0.2325**
...
## Exact live lane
- rows: **76**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 76}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (76 rows)
- near_boundary_window: `{'lower': 0.1175, 'upper': 0.35}`
- near_boundary_rows: **76**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.2642 / norm=0.2642 / Δto_cross_q35=0.6838 / target_p25=0.3738 / target_median=0.4206
- `feat_4h_dist_bb_lower`: current=0.6712 / norm=0.0839 / Δto_cross_q35=5.6364 / target_p25=0.9296 / target_median=1.0492
- `feat_4h_dist_swing_low`: current=-0.7911 / norm=0.0 / Δto_cross_q35=7.8366 / target_p25=-0.6932 / target_median=0.0457
