...
- generated_at: **2026-05-19 07:09:56.132284**
...
- structure_quality: **0.2449**
- gap_to_q35_boundary: **0.1051**
...
## Exact live lane
- rows: **126**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 107, 'CAUTION|base_caution_regime_or_bias|q00': 19}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (107 rows)
- near_boundary_window: `{'lower': 0.2449, 'upper': 0.35}`
- near_boundary_rows: **32**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5488 / norm=0.5488 / Δto_cross_q35=0.3091 / target_p25=0.3911 / target_median=0.4545
- `feat_4h_dist_bb_lower`: current=1.4139 / norm=0.1767 / Δto_cross_q35=2.5479 / target_p25=0.9982 / target_median=1.1268
- `feat_4h_dist_swing_low`: current=-0.7516 / norm=0.0 / Δto_cross_q35=3.9364 / target_p25=-0.5897 / target_median=0.5321
