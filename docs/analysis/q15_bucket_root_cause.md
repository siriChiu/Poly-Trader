...
- near_boundary_window: `{'lower': 0.4162, 'upper': 0.35}`
- near_boundary_rows: **0**

## Decision
- reason: 目前 live row 已不在 q15/q35 邊界下方，問題改成 exact support 累積，不是 bucket repair。
- candidate_patch: `{'type': 'support_accumulation', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.5762, 'current_normalized': 0.5762, 'needed_raw_delta_to_cross_q35': 0.0, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.4238, 'needed_raw_delta_to_target_median': 0.4238}`
- verify_next: 確認 current_live_structure_bucket_rows 是否增加到 minimum_support_rows。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.5762 / norm=0.5762 / Δto_cross_q35=0.0 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.7941 / norm=0.2243 / Δto_cross_q35=0.0 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=4.4341 / norm=0.4434 / Δto_cross_q35=0.0 / target_p25=5.4449 / target_median=5.5338
