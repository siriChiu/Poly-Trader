...
- generated_at: **2026-05-19 09:01:31.792727**
...
- structure_quality: **0.2747**
- gap_to_q35_boundary: **0.0753**
...
## Exact live lane
- rows: **9**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 5, 'CAUTION|base_caution_regime_or_bias|q00': 4}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (5 rows)
- near_boundary_window: `{'lower': 0.2747, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5209 / norm=0.5209 / Δto_cross_q35=0.2215 / target_p25=0.3734 / target_median=0.3818
- `feat_4h_dist_bb_lower`: current=1.3355 / norm=0.1669 / Δto_cross_q35=1.8255 / target_p25=0.936 / target_median=0.9573
- `feat_4h_dist_swing_low`: current=1.2876 / norm=0.1288 / Δto_cross_q35=2.2818 / target_p25=0.3595 / target_median=0.3852
