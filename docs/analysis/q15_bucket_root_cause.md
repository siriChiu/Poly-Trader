...
## Exact live lane
- rows: **304**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q15': 87, 'CAUTION|base_caution_regime_or_bias|q35': 72, 'CAUTION|base_caution_regime_or_bias|q00': 63, 'CAUTION|base_caution_regime_or_bias|q65': 55, 'CAUTION|base_caution_regime_or_bias|q85': 27}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** (72 rows)
- near_boundary_window: `{'lower': 0.2559, 'upper': 0.35}`
- near_boundary_rows: **78**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.4432 / norm=0.4432 / Δto_cross_q35=0.2768 / target_p25=0.672 / target_median=0.7161
- `feat_4h_dist_bb_lower`: current=1.0802 / norm=0.135 / Δto_cross_q35=2.2812 / target_p25=1.6452 / target_median=1.7542
- `feat_4h_dist_swing_low`: current=1.8383 / norm=0.1838 / Δto_cross_q35=2.8515 / target_p25=1.8754 / target_median=1.9733
