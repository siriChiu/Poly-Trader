...
## Exact live lane
- rows: **1891**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q65': 572, 'CAUTION|base_caution_regime_or_bias|q15': 446, 'CAUTION|base_caution_regime_or_bias|q85': 323, 'CAUTION|base_caution_regime_or_bias|q35': 309, 'CAUTION|base_caution_regime_or_bias|q00': 241}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** (572 rows)
- near_boundary_window: `{'lower': 0.377, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5506 / norm=0.5506 / Δto_cross_q35=0.0 / target_p25=0.7098 / target_median=0.7516
- `feat_4h_dist_bb_lower`: current=1.2619 / norm=0.1577 / Δto_cross_q35=0.0 / target_p25=4.2535 / target_median=5.7387
- `feat_4h_dist_swing_low`: current=4.1737 / norm=0.4174 / Δto_cross_q35=0.0 / target_p25=8.0696 / target_median=9.098
