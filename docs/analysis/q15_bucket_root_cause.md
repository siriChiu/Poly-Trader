...
- generated_at: **2026-05-20 04:14:36.448528**
...
## Exact live lane
- rows: **180**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 109, 'CAUTION|base_caution_regime_or_bias|q00': 37, 'CAUTION|base_caution_regime_or_bias|q15': 34}`
...
## Decision
- reason: current-live q15 bucket exact support 目前為 34/50，低於 minimum；這是 current exact support under minimum，不是 boundary candidate。
- candidate_patch: `{}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5165 / norm=0.5165 / Δto_cross_q35=0.2535 / target_p25=0.3928 / target_median=0.4551
- `feat_4h_dist_bb_lower`: current=1.3308 / norm=0.1663 / Δto_cross_q35=2.0897 / target_p25=0.9986 / target_median=1.1465
- `feat_4h_dist_swing_low`: current=1.008 / norm=0.1008 / Δto_cross_q35=2.6121 / target_p25=-0.566 / target_median=0.5205
