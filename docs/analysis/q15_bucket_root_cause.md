...
## Exact live lane
- rows: **85**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 85}`
- dominant_neighbor_bucket: **None** (0 rows)
- near_boundary_window: `{'lower': 0.2376, 'upper': 0.35}`
- near_boundary_rows: **24**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5338 / norm=0.5338 / Δto_cross_q35=0.3306 / target_p25=None / target_median=None
- `feat_4h_dist_bb_lower`: current=1.3601 / norm=0.17 / Δto_cross_q35=2.7248 / target_p25=None / target_median=None
- `feat_4h_dist_swing_low`: current=-0.1083 / norm=0.0 / Δto_cross_q35=3.5144 / target_p25=None / target_median=None
