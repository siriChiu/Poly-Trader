...
- generated_at: **2026-04-24 22:40:50.593110**
...
- support rows/minimum/gap: **104 / 50 / 0**

## Exact live lane
- rows: **1874**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q65': 578, 'CAUTION|base_caution_regime_or_bias|q35': 489, 'CAUTION|base_caution_regime_or_bias|q85': 323, 'CAUTION|base_caution_regime_or_bias|q15': 279, 'CAUTION|base_caution_regime_or_bias|q00': 205}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** (578 rows)
- near_boundary_window: `{'lower': 0.1541, 'upper': 0.35}`
- near_boundary_rows: **279**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.2976 / norm=0.2976 / Δto_cross_q35=0.5762 / target_p25=0.7102 / target_median=0.753
- `feat_4h_dist_bb_lower`: current=0.9058 / norm=0.1132 / Δto_cross_q35=4.7491 / target_p25=4.7576 / target_median=5.7345
- `feat_4h_dist_swing_low`: current=0.4713 / norm=0.0471 / Δto_cross_q35=5.9364 / target_p25=8.0553 / target_median=9.09
