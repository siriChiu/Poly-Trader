...
## Exact live lane
- rows: **53**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 53}`
- dominant_neighbor_bucket: **None** (0 rows)
- near_boundary_window: `{'lower': 0.2084, 'upper': 0.35}`
- near_boundary_rows: **26**

## Decision
- reason: current-live q15 bucket exact support 目前為 33/50，低於 minimum；這是 current exact support under minimum，不是 boundary candidate。
- candidate_patch: `{}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.4302 / norm=0.4302 / Δto_cross_q35=0.4165 / target_p25=None / target_median=None
- `feat_4h_dist_bb_lower`: current=1.0798 / norm=0.135 / Δto_cross_q35=3.4327 / target_p25=None / target_median=None
- `feat_4h_dist_swing_low`: current=0.5321 / norm=0.0532 / Δto_cross_q35=4.2909 / target_p25=None / target_median=None
