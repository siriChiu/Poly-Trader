...
- generated_at: **2026-04-23 11:01:07.374540**
...
- structure_quality: **0.2381**
- gap_to_q35_boundary: **0.1119**
...
- near_boundary_window: `{'lower': 0.2381, 'upper': 0.35}`
...
- candidate_patch: `{'type': 'structure_component_scoring', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.2662, 'current_normalized': 0.2662, 'needed_raw_delta_to_cross_q35': 0.3291, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.7338, 'needed_raw_delta_to_target_median': 0.7338}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.2662 / norm=0.2662 / Δto_cross_q35=0.3291 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=0.8816 / norm=0.1102 / Δto_cross_q35=2.7127 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=3.3713 / norm=0.3371 / Δto_cross_q35=3.3909 / target_p25=5.4449 / target_median=5.5338
