...
- structure_quality: **0.2064**
- gap_to_q35_boundary: **0.1436**
...
## Exact live lane
- rows: **1899**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q65': 578, 'CAUTION|base_caution_regime_or_bias|q35': 514, 'CAUTION|base_caution_regime_or_bias|q85': 323, 'CAUTION|base_caution_regime_or_bias|q15': 279, 'CAUTION|base_caution_regime_or_bias|q00': 205}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** (578 rows)
- near_boundary_window: `{'lower': 0.2064, 'upper': 0.35}`
- near_boundary_rows: **251**

## Decision
- reason: same exact lane 有明顯鄰近 bucket 樣本，current row 與 q35 support 的差距主要來自結構 component，不是 generic breaker / q35 總體治理。
- candidate_patch: `{'type': 'structure_component_scoring', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.3814, 'current_normalized': 0.3814, 'needed_raw_delta_to_cross_q35': 0.4224, 'target_bucket_p25': 0.7102, 'target_bucket_median': 0.753, 'needed_raw_delta_to_target_p25': 0.3288, 'needed_raw_delta_to_target_median': 0.3716}`
- verify_next: 比較 current row 與 dominant neighbor bucket 的 4H component 差值，再做最小 counterfactual。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.3814 / norm=0.3814 / Δto_cross_q35=0.4224 / target_p25=0.7102 / target_median=0.753
- `feat_4h_dist_bb_lower`: current=1.1623 / norm=0.1453 / Δto_cross_q35=3.4812 / target_p25=4.7576 / target_median=5.7345
- `feat_4h_dist_swing_low`: current=0.871 / norm=0.0871 / Δto_cross_q35=4.3515 / target_p25=8.0553 / target_median=9.09
