...
- structure_quality: **0.2641**
- gap_to_q35_boundary: **0.0859**
...
## Exact live lane
- rows: **9**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 9}`
- dominant_neighbor_bucket: **None** (0 rows)
- near_boundary_window: `{'lower': 0.2641, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5163 / norm=0.5163 / Δto_cross_q35=0.2526 / target_p25=None / target_median=None
- `feat_4h_dist_bb_lower`: current=1.4548 / norm=0.1819 / Δto_cross_q35=2.0824 / target_p25=None / target_median=None
- `feat_4h_dist_swing_low`: current=0.8668 / norm=0.0867 / Δto_cross_q35=2.603 / target_p25=None / target_median=None
