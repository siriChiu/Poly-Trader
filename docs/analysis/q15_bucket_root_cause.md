...
- generated_at: **2026-05-19 00:13:31.195760**
...
- structure_quality: **0.2372**
- gap_to_q35_boundary: **0.1128**
...
## Exact live lane
- rows: **110**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 107, 'CAUTION|base_caution_regime_or_bias|q00': 3}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (107 rows)
- near_boundary_window: `{'lower': 0.2372, 'upper': 0.35}`
- near_boundary_rows: **35**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5306 / norm=0.5306 / Δto_cross_q35=0.3318 / target_p25=0.3911 / target_median=0.4545
- `feat_4h_dist_bb_lower`: current=1.3767 / norm=0.1721 / Δto_cross_q35=2.7345 / target_p25=0.9982 / target_median=1.1268
- `feat_4h_dist_swing_low`: current=-0.7029 / norm=0.0 / Δto_cross_q35=4.1211 / target_p25=-0.5897 / target_median=0.5321
