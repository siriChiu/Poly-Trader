...
- candidate_patch: `{'type': 'scope_generation', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.2874, 'current_normalized': 0.2874, 'needed_raw_delta_to_cross_q35': 0.6356, 'target_bucket_p25': None, 'target_bucket_median': None, 'needed_raw_delta_to_target_p25': None, 'needed_raw_delta_to_target_median': None}`
- verify_next: 重跑 bull_4h_pocket_ablation.py，確認 exact_scope_rows > 0。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.2874 / norm=0.2874 / Δto_cross_q35=0.6356 / target_p25=None / target_median=None
- `feat_4h_dist_bb_lower`: current=0.8086 / norm=0.1011 / Δto_cross_q35=5.2388 / target_p25=None / target_median=None
- `feat_4h_dist_swing_low`: current=0.0864 / norm=0.0086 / Δto_cross_q35=6.5485 / target_p25=None / target_median=None
