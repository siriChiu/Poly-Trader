...
- generated_at: **2026-04-23 09:21:36.174390**
...
- structure_quality: **0.281**
- gap_to_q35_boundary: **0.069**
...
- near_boundary_window: `{'lower': 0.281, 'upper': 0.35}`
...
- candidate_patch: `{'type': 'structure_component_scoring', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.3373, 'current_normalized': 0.3373, 'needed_raw_delta_to_cross_q35': 0.2029, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.6627, 'needed_raw_delta_to_target_median': 0.6627}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.3373 / norm=0.3373 / Δto_cross_q35=0.2029 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.1126 / norm=0.1391 / Δto_cross_q35=1.6727 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=3.6492 / norm=0.3649 / Δto_cross_q35=2.0909 / target_p25=5.4449 / target_median=5.5338
