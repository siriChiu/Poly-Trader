...
- generated_at: **2026-05-18 12:11:57.964453**
...
- structure_quality: **0.2127**
- gap_to_q35_boundary: **0.1373**
...
## Exact live lane
- rows: **83**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 83}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (83 rows)
- near_boundary_window: `{'lower': 0.2127, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.4775 / norm=0.4775 / Δto_cross_q35=0.4038 / target_p25=0.3778 / target_median=0.4435
- `feat_4h_dist_bb_lower`: current=1.2198 / norm=0.1525 / Δto_cross_q35=3.3285 / target_p25=0.94 / target_median=1.1059
- `feat_4h_dist_swing_low`: current=-0.2838 / norm=0.0 / Δto_cross_q35=4.4444 / target_p25=-0.6886 / target_median=0.2523
