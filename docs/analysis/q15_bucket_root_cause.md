...
- near_boundary_window: `{'lower': 0.4604, 'upper': 0.35}`
- near_boundary_rows: **0**

## Decision
- reason: current-live q35 bucket exact support 目前為 21/50，低於 minimum；這是 current exact support under minimum，不是 boundary candidate。
- candidate_patch: `{}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.7127 / norm=0.7127 / Δto_cross_q35=0.0 / target_p25=0.7098 / target_median=0.7516
- `feat_4h_dist_bb_lower`: current=1.8441 / norm=0.2305 / Δto_cross_q35=0.0 / target_p25=4.2535 / target_median=5.7387
- `feat_4h_dist_swing_low`: current=4.303 / norm=0.4303 / Δto_cross_q35=0.0 / target_p25=8.0696 / target_median=9.098
