...
- generated_at: **2026-04-23 19:20:23.116562**
...
- structure_quality: **0.3219**
- gap_to_q35_boundary: **0.0281**
...
- near_boundary_window: `{'lower': 0.3219, 'upper': 0.35}`
...
- candidate_patch: `{'type': None, 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.4087, 'current_normalized': 0.4087, 'needed_raw_delta_to_cross_q35': 0.0826, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.5913, 'needed_raw_delta_to_target_median': 0.5913}`
- verify_next: 先讓 canonical breaker release condition 接近解除，再重跑 hb_predict_probe.py 與 q15 root-cause artifact。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.4087 / norm=0.4087 / Δto_cross_q35=0.0826 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.3356 / norm=0.1669 / Δto_cross_q35=0.6812 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=3.8758 / norm=0.3876 / Δto_cross_q35=0.8515 / target_p25=5.4449 / target_median=5.5338
