...
- generated_at: **2026-05-18 17:15:31.664883**
...
- structure_quality: **0.1111**
- gap_to_q35_boundary: **0.2389**
...
## Exact live lane
- rows: **93**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 93}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (93 rows)
- near_boundary_window: `{'lower': 0.1111, 'upper': 0.35}`
- near_boundary_rows: **93**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.2485 / norm=0.2485 / Δto_cross_q35=0.7026 / target_p25=0.3835 / target_median=0.445
- `feat_4h_dist_bb_lower`: current=0.6439 / norm=0.0805 / Δto_cross_q35=5.7915 / target_p25=0.9775 / target_median=1.1061
- `feat_4h_dist_swing_low`: current=-1.3677 / norm=0.0 / Δto_cross_q35=8.6071 / target_p25=-0.6389 / target_median=0.4636
