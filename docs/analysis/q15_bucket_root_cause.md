...
- generated_at: **2026-05-19 14:05:49.349442**
...
- structure_quality: **0.2597**
- gap_to_q35_boundary: **0.0903**
...
## Exact live lane
- rows: **138**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 109, 'CAUTION|base_caution_regime_or_bias|q00': 27, 'CAUTION|base_caution_regime_or_bias|q15': 2}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (109 rows)
- near_boundary_window: `{'lower': 0.2597, 'upper': 0.35}`
- near_boundary_rows: **18**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.4986 / norm=0.4986 / Δto_cross_q35=0.2656 / target_p25=0.3928 / target_median=0.4551
- `feat_4h_dist_bb_lower`: current=1.278 / norm=0.1598 / Δto_cross_q35=2.1891 / target_p25=0.9986 / target_median=1.1465
- `feat_4h_dist_swing_low`: current=1.1363 / norm=0.1136 / Δto_cross_q35=2.7364 / target_p25=-0.566 / target_median=0.5205
