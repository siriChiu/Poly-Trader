...
- structure_quality: **0.3256**
- gap_to_q35_boundary: **0.0244**
...
- near_boundary_window: `{'lower': 0.3256, 'upper': 0.35}`
...
- candidate_patch: `{'type': 'structure_component_scoring', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.4177, 'current_normalized': 0.4177, 'needed_raw_delta_to_cross_q35': 0.0718, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.5823, 'needed_raw_delta_to_target_median': 0.5823}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.4177 / norm=0.4177 / Δto_cross_q35=0.0718 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.3742 / norm=0.1718 / Δto_cross_q35=0.5915 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=3.8456 / norm=0.3846 / Δto_cross_q35=0.7394 / target_p25=5.4449 / target_median=5.5338
