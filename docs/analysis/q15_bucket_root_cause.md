...
- near_boundary_window: `{'lower': 0.3356, 'upper': 0.35}`
...
- candidate_patch: `{'type': None, 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.4387, 'current_normalized': 0.4387, 'needed_raw_delta_to_cross_q35': 0.0424, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.5613, 'needed_raw_delta_to_target_median': 0.5613}`
- verify_next: 先讓 canonical breaker release condition 接近解除，再重跑 hb_predict_probe.py 與 q15 root-cause artifact。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.4387 / norm=0.4387 / Δto_cross_q35=0.0424 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.4147 / norm=0.1768 / Δto_cross_q35=0.3491 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=3.8827 / norm=0.3883 / Δto_cross_q35=0.4364 / target_p25=5.4449 / target_median=5.5338
