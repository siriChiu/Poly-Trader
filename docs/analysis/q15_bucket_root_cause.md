...
- near_boundary_window: `{'lower': 0.4351, 'upper': 0.35}`
...
- candidate_patch: `{'type': None, 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.5986, 'current_normalized': 0.5986, 'needed_raw_delta_to_cross_q35': 0.0, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.4014, 'needed_raw_delta_to_target_median': 0.4014}`
- verify_next: 先讓 canonical breaker release condition 接近解除，再重跑 hb_predict_probe.py 與 q15 root-cause artifact。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.5986 / norm=0.5986 / Δto_cross_q35=0.0 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.9365 / norm=0.2421 / Δto_cross_q35=0.0 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=4.5982 / norm=0.4598 / Δto_cross_q35=0.0 / target_p25=5.4449 / target_median=5.5338
