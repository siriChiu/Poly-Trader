...
- generated_at: **2026-05-18 07:01:48.670587**
...
- structure_quality: **0.0697**
- gap_to_q35_boundary: **0.2803**
...
## Exact live lane
- rows: **72**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 72}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (72 rows)
- near_boundary_window: `{'lower': 0.0697, 'upper': 0.35}`
- near_boundary_rows: **72**
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.1563 / norm=0.1563 / Δto_cross_q35=0.8244 / target_p25=0.3708 / target_median=0.4198
- `feat_4h_dist_bb_lower`: current=0.4012 / norm=0.0502 / Δto_cross_q35=6.7952 / target_p25=0.9069 / target_median=1.047
- `feat_4h_dist_swing_low`: current=-0.8782 / norm=0.0 / Δto_cross_q35=9.3721 / target_p25=-0.7035 / target_median=-0.3237
