...
- near_boundary_window: `{'lower': 0.0248, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.056 / norm=0.056 / Δto_cross_q35=0.944 / target_p25=0.1116 / target_median=0.2075
- `feat_4h_dist_bb_lower`: current=0.1404 / norm=0.0175 / Δto_cross_q35=7.8596 / target_p25=0.2927 / target_median=0.54
- `feat_4h_dist_swing_low`: current=-1.8641 / norm=0.0 / Δto_cross_q35=11.7186 / target_p25=-0.8836 / target_median=-0.4302
