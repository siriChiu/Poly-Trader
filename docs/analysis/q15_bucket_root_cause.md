...
- generated_at: **2026-05-18 14:01:51.894454**
...
- structure_quality: **0.1057**
- gap_to_q35_boundary: **0.2443**
...
## Exact live lane
- rows: **2**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 2}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (2 rows)
- near_boundary_window: `{'lower': 0.1057, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.2374 / norm=0.2374 / Δto_cross_q35=0.7185 / target_p25=0.4416 / target_median=0.4803
- `feat_4h_dist_bb_lower`: current=0.606 / norm=0.0757 / Δto_cross_q35=5.9224 / target_p25=1.1067 / target_median=1.2015
- `feat_4h_dist_swing_low`: current=-1.0341 / norm=0.0 / Δto_cross_q35=8.4371 / target_p25=0.5753 / target_median=0.6869
