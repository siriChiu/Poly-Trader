...
- generated_at: **2026-05-18 08:02:29.431286**
...
## Exact live lane
- rows: **74**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 74}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (74 rows)
- near_boundary_window: `{'lower': 0.1254, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.282 / norm=0.282 / Δto_cross_q35=0.6606 / target_p25=0.3725 / target_median=0.4201
- `feat_4h_dist_bb_lower`: current=0.7159 / norm=0.0895 / Δto_cross_q35=5.4448 / target_p25=0.9153 / target_median=1.0481
- `feat_4h_dist_swing_low`: current=-0.7356 / norm=0.0 / Δto_cross_q35=7.5417 / target_p25=-0.6998 / target_median=-0.1017
