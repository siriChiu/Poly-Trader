...
- generated_at: **2026-04-22 11:28:51.272837**
...
- near_boundary_window: `{'lower': 0.6676, 'upper': 0.35}`
- near_boundary_rows: **0**

## Decision
- reason: 目前 live row 已不在 q15/q35 邊界下方，問題改成 exact support 累積，不是 bucket repair。
- candidate_patch: `{'type': 'support_accumulation', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 1.0396, 'current_normalized': 1.0, 'needed_raw_delta_to_cross_q35': -0.0396, 'target_bucket_p25': 0.8459, 'target_bucket_median': 0.8907, 'needed_raw_delta_to_target_p25': -0.1937, 'needed_raw_delta_to_target_median': -0.1489}`
- verify_next: 確認 current_live_structure_bucket_rows 是否增加到 minimum_support_rows。

## Component deltas
- `feat_4h_bb_pct_b`: current=1.0396 / norm=1.0 / Δto_cross_q35=-0.0396 / target_p25=0.8459 / target_median=0.8907
- `feat_4h_dist_bb_lower`: current=3.2795 / norm=0.4099 / Δto_cross_q35=0.0 / target_p25=2.8454 / target_median=2.9917
- `feat_4h_dist_swing_low`: current=5.8294 / norm=0.5829 / Δto_cross_q35=0.0 / target_p25=5.0245 / target_median=5.1317
