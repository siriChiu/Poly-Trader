...
- generated_at: **2026-05-19 19:10:20.296350**
...
- structure_quality: **0.2828**
- gap_to_q35_boundary: **0.0672**
...
## Exact live lane
- rows: **151**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 109, 'CAUTION|base_caution_regime_or_bias|q00': 37, 'CAUTION|base_caution_regime_or_bias|q15': 5}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (109 rows)
- near_boundary_window: `{'lower': 0.2828, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5492 / norm=0.5492 / Δto_cross_q35=0.1976 / target_p25=0.3928 / target_median=0.4551
- `feat_4h_dist_bb_lower`: current=1.3911 / norm=0.1739 / Δto_cross_q35=1.6291 / target_p25=0.9986 / target_median=1.1465
- `feat_4h_dist_swing_low`: current=1.171 / norm=0.1171 / Δto_cross_q35=2.0364 / target_p25=-0.566 / target_median=0.5205
