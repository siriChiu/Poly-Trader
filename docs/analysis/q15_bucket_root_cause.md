...
- near_boundary_window: `{'lower': 0.6019, 'upper': 0.35}`
- near_boundary_rows: **0**

## Decision
- reason: 目前 live row 已不在 q15/q35 邊界下方，問題改成 exact support 累積，不是 bucket repair。
- candidate_patch: `{'type': 'support_accumulation', 'feature': 'feat_4h_dist_swing_low', 'current_raw': 5.2067, 'current_normalized': 0.5207, 'needed_raw_delta_to_cross_q35': 0.0, 'target_bucket_p25': 5.2224, 'target_bucket_median': 5.3417, 'needed_raw_delta_to_target_p25': 0.0157, 'needed_raw_delta_to_target_median': 0.135}`
- verify_next: 確認 current_live_structure_bucket_rows 是否增加到 minimum_support_rows。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.9103 / norm=0.9103 / Δto_cross_q35=0.0 / target_p25=1.0253 / target_median=1.1869
- `feat_4h_dist_bb_lower`: current=2.9237 / norm=0.3655 / Δto_cross_q35=0.0 / target_p25=3.5533 / target_median=3.9437
- `feat_4h_dist_swing_low`: current=5.2067 / norm=0.5207 / Δto_cross_q35=0.0 / target_p25=5.2224 / target_median=5.3417
