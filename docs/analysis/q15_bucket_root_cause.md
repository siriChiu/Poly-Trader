...
- near_boundary_window: `{'lower': 0.3392, 'upper': 0.35}`
...
- candidate_patch: `{'type': 'structure_component_scoring', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.4446, 'current_normalized': 0.4446, 'needed_raw_delta_to_cross_q35': 0.0318, 'target_bucket_p25': 1.8718, 'target_bucket_median': 1.9105, 'needed_raw_delta_to_target_p25': 0.5554, 'needed_raw_delta_to_target_median': 0.5554}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.4446 / norm=0.4446 / Δto_cross_q35=0.0318 / target_p25=1.8718 / target_median=1.9105
- `feat_4h_dist_bb_lower`: current=1.434 / norm=0.1792 / Δto_cross_q35=0.2618 / target_p25=4.8843 / target_median=4.995
- `feat_4h_dist_swing_low`: current=3.905 / norm=0.3905 / Δto_cross_q35=0.3273 / target_p25=5.4449 / target_median=5.5338
