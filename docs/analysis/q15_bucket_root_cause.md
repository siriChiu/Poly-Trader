...
- generated_at: **2026-05-24 22:08:41.325569**
...
- structure_quality: **0.3443**
- gap_to_q35_boundary: **0.0057**
...
## Exact live lane
- rows: **340**
- bucket_counts: `{'CAUTION|base_caution_regime_or_bias|q15': 147, 'CAUTION|base_caution_regime_or_bias|q35': 84, 'CAUTION|base_caution_regime_or_bias|q00': 63, 'CAUTION|base_caution_regime_or_bias|q65': 27, 'CAUTION|base_caution_regime_or_bias|q85': 19}`
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** (84 rows)
- near_boundary_window: `{'lower': 0.3443, 'upper': 0.35}`
- near_boundary_rows: **5**

## Decision
- reason: current-live q15 bucket exact support 目前為 24/50，低於 minimum；這是 current exact support under minimum，不是 boundary candidate。
- candidate_patch: `{}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5394 / norm=0.5394 / Δto_cross_q35=0.0168 / target_p25=0.6693 / target_median=0.7103
- `feat_4h_dist_bb_lower`: current=1.3187 / norm=0.1648 / Δto_cross_q35=0.1382 / target_p25=1.6396 / target_median=1.7373
- `feat_4h_dist_swing_low`: current=3.2262 / norm=0.3226 / Δto_cross_q35=0.1727 / target_p25=1.8573 / target_median=1.9943
