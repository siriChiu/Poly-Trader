...
- generated_at: **2026-05-19 08:11:03.645057**
...
- structure_quality: **0.2872**
- gap_to_q35_boundary: **0.0628**
...
## Exact live lane
- rows: **128**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 107, 'CAUTION|base_caution_regime_or_bias|q00': 21}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (107 rows)
- near_boundary_window: `{'lower': 0.2872, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.544 / norm=0.544 / Δto_cross_q35=0.1847 / target_p25=0.3911 / target_median=0.4545
- `feat_4h_dist_bb_lower`: current=1.3908 / norm=0.1739 / Δto_cross_q35=1.5224 / target_p25=0.9982 / target_median=1.1268
- `feat_4h_dist_swing_low`: current=1.3589 / norm=0.1359 / Δto_cross_q35=1.903 / target_p25=-0.5897 / target_median=0.5321
