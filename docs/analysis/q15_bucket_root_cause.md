...
- near_boundary_window: `{'lower': 0.5716, 'upper': 0.35}`
- near_boundary_rows: **0**

## Decision
- reason: 目前 live row 已不在 q15/q35 邊界下方，問題改成 exact support 累積，不是 bucket repair。
- candidate_patch: `{'type': 'support_accumulation', 'feature': 'feat_4h_bb_pct_b', 'current_raw': 0.916, 'current_normalized': 0.916, 'needed_raw_delta_to_cross_q35': 0.0, 'target_bucket_p25': None, 'target_bucket_median': None, 'needed_raw_delta_to_target_p25': None, 'needed_raw_delta_to_target_median': None}`
- verify_next: 確認 current_live_structure_bucket_rows 是否增加到 minimum_support_rows。

## Component deltas
- `feat_4h_bb_pct_b`: current=0.916 / norm=0.916 / Δto_cross_q35=0.0 / target_p25=None / target_median=None
- `feat_4h_dist_bb_lower`: current=2.8195 / norm=0.3524 / Δto_cross_q35=0.0 / target_p25=None / target_median=None
- `feat_4h_dist_swing_low`: current=4.3585 / norm=0.4359 / Δto_cross_q35=0.0 / target_p25=None / target_median=None
