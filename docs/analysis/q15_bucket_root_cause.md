...
- generated_at: **2026-05-19 20:41:51.762186**
...
- structure_quality: **0.2848**
- gap_to_q35_boundary: **0.0652**
...
## Exact live lane
- rows: **153**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 109, 'CAUTION|base_caution_regime_or_bias|q00': 37, 'CAUTION|base_caution_regime_or_bias|q15': 7}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (109 rows)
- near_boundary_window: `{'lower': 0.2848, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5536 / norm=0.5536 / Δto_cross_q35=0.1918 / target_p25=0.3928 / target_median=0.4551
- `feat_4h_dist_bb_lower`: current=1.4109 / norm=0.1764 / Δto_cross_q35=1.5806 / target_p25=0.9986 / target_median=1.1465
- `feat_4h_dist_swing_low`: current=1.1622 / norm=0.1162 / Δto_cross_q35=1.9758 / target_p25=-0.566 / target_median=0.5205
