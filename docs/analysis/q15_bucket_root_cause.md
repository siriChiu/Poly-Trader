...
- generated_at: **2026-05-18 06:09:34.890085**
...
- structure_quality: **0.0281**
- gap_to_q35_boundary: **0.3219**
...
## Exact live lane
- rows: **70**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 70}`
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** (70 rows)
- near_boundary_window: `{'lower': 0.0281, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.0629 / norm=0.0629 / Δto_cross_q35=0.9371 / target_p25=0.3686 / target_median=0.4188
- `feat_4h_dist_bb_lower`: current=0.1632 / norm=0.0204 / Δto_cross_q35=7.8036 / target_p25=0.9044 / target_median=1.0457
- `feat_4h_dist_swing_low`: current=-1.1857 / norm=0.0 / Δto_cross_q35=10.9402 / target_p25=-0.7042 / target_median=-0.5113
