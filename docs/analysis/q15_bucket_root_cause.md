...
- near_boundary_window: `{'lower': 0.3899, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5689 / norm=0.5689 / Δto_cross_q35=0.0 / target_p25=0.7098 / target_median=0.7516
- `feat_4h_dist_bb_lower`: current=1.4717 / norm=0.184 / Δto_cross_q35=0.0 / target_p25=4.2535 / target_median=5.7387
- `feat_4h_dist_swing_low`: current=4.1131 / norm=0.4113 / Δto_cross_q35=0.0 / target_p25=8.0696 / target_median=9.098
