...
- structure_quality: **0.2725**
- gap_to_q35_boundary: **0.0775**
...
## Exact live lane
- rows: **48**
- bucket_counts: `{'CAUTION|structure_quality_caution|q15': 48}`
- dominant_neighbor_bucket: **None** (0 rows)
- near_boundary_window: `{'lower': 0.2725, 'upper': 0.35}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.5484 / norm=0.5484 / Δto_cross_q35=0.2279 / target_p25=None / target_median=None
- `feat_4h_dist_bb_lower`: current=1.3733 / norm=0.1717 / Δto_cross_q35=1.8788 / target_p25=None / target_median=None
- `feat_4h_dist_swing_low`: current=0.8912 / norm=0.0891 / Δto_cross_q35=2.3485 / target_p25=None / target_median=None
