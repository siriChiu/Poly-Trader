...
- near_boundary_window: `{'lower': 0.4538, 'upper': 0.35}`
- near_boundary_rows: **0**

## Decision
- reason: current-live q35 bucket exact support 目前為 22/50，低於 minimum；這是 current exact support under minimum，不是 boundary candidate。
- candidate_patch: `{}`
...
## Component deltas
- `feat_4h_bb_pct_b`: current=0.7006 / norm=0.7006 / Δto_cross_q35=0.0 / target_p25=0.7098 / target_median=0.7516
- `feat_4h_dist_bb_lower`: current=1.814 / norm=0.2268 / Δto_cross_q35=0.0 / target_p25=4.2535 / target_median=5.7387
- `feat_4h_dist_swing_low`: current=4.2666 / norm=0.4267 / Δto_cross_q35=0.0 / target_p25=8.0696 / target_median=9.098
