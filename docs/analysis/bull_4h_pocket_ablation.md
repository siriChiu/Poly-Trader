...
- generated_at: **2026-05-18 06:02:25 UTC**
...
- dominant neighbor bucket: `CAUTION|structure_quality_caution|q15` rows=39
- bucket gap vs dominant neighbor: **39**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / bear (0.9070)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 39 | 0.4615 | 0.1605 | current bucket rows=0 |
