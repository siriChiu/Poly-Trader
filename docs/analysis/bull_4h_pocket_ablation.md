...
- generated_at: **2026-05-24 07:02:43 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=53
- bucket gap vs dominant neighbor: **53**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / chop (0.6235)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 53 | 0.2642 | -0.1174 | current bucket rows=0 |
