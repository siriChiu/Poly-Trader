...
- generated_at: **2026-05-18 07:02:10 UTC**
...
- dominant neighbor bucket: `CAUTION|structure_quality_caution|q15` rows=41
- bucket gap vs dominant neighbor: **41**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / bear (0.9111)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 41 | 0.3902 | 0.0918 | current bucket rows=0 |
