...
- generated_at: **2026-05-13 18:08:42 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=353
- bucket gap vs dominant neighbor: **316**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **37 / chop (0.8980)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q00 | 450 | 0.58 | 0.2137 | current bucket rows=37 |
...
- recent exact live lane rows / win_rate: **450 / 0.5044**
...
- exact lane vs current bucket win Δ / quality Δ: **None / 0.3366**
