...
- generated_at: **2026-05-24 11:37:39 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=39
- bucket gap vs dominant neighbor: **39**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / chop (0.5909)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 39 | 0.0 | -0.3189 | current bucket rows=0 |
