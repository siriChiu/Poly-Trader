...
- generated_at: **2026-05-25 05:40:23 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=14
- bucket gap vs dominant neighbor: **3**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **18 / chop (0.6579)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q35 | 25 | 0.32 | -0.1445 | current bucket rows=11 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q35 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.7778 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q35 | 18 | 0.7778 | 0.3053 | dominant_regime=chop |
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.3928**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / 0.057**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=11
