...
- generated_at: **2026-05-22 08:12:15 UTC**
...
- bull_all rows: **2503** / win_rate **0.4990** / recommended **`current_full_minus_4h_structure_shift`**
- bull_collapse_q35 rows: **921** / win_rate **0.3920** / recommended **`core_plus_macro_plus_all_4h`**
...
- current bucket gap to minimum: **16**
- exact-bucket proxy gap to minimum: **50**
- exact-lane proxy gap to minimum: **42**
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=62
- bucket gap vs dominant neighbor: **28**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **104 / chop (0.5614)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 96 | 0.3854 | 0.0935 | current bucket rows=34 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.8462 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 104 | 0.8462 | 0.4193 | dominant_regime=chop |
...
- recent broader same-bucket rows / dominant regime: **104 / bear**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / -0.0918**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / 0.234**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.7936, "feat_4h_dist_bb_lower": 4.0407, "feat_4h_bb_pct_b": 0.6992}
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=34
