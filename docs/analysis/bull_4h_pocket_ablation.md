...
- generated_at: **2026-04-30 04:02:47 UTC**
...
- broader q65 rows / dominant regime: **14 / chop (0.8293)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 10 | 0.2 | -0.0629 | current bucket rows=10 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 132 | 0.5303030303030303 | None | proxy-vs-broader win Δ=0.3874 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 14 | 0.1429 | -0.1309 | dominant_regime=chop |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **10 / 0.0**
...
- proxy vs current bucket win Δ / row ratio: **0.5303 / 13.2**
- exact lane vs current bucket win Δ / quality Δ: **0.0 / 0.0**
- broader same-bucket vs current bucket win Δ / quality Δ: **0.1429 / -0.068**
...
- exact live structure bucket: `CAUTION|structure_quality_caution|q15` rows=10
