...
- generated_at: **2026-05-24 18:02:02 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=32
- bucket gap vs dominant neighbor: **32**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / chop (0.5517)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 32 | 0.0 | -0.3305 | current bucket rows=0 |
