...
- generated_at: **2026-05-16 02:02:21 UTC**
...
- broader q65 rows / dominant regime: **10 / bear (1.0000)**
...
|---|---|---:|---:|---:|---|
| exact live lane | BLOCK|structure_quality_block|q00 | 10 | 1.0 | 0.7398 | current bucket rows=10 |
| exact bucket proxy | BLOCK|structure_quality_block|q00 | 7 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | BLOCK|structure_quality_block|q00 | 10 | 1.0 | 0.7398 | dominant_regime=bear |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **7 / 0.0**
- recent exact live lane rows / win_rate: **10 / 0.0**
- historical exact-bucket proxy rows / win_rate: **7 / 0.0**
- recent broader same-bucket rows / dominant regime: **10 / bear**
...
- exact live structure bucket: `BLOCK|structure_quality_block|q00` rows=10
