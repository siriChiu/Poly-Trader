...
- generated_at: **2026-05-26 08:11:58 UTC**
...
- broader q65 rows / dominant regime: **7 / chop (0.9079)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 69 | 0.5652 | 0.1951 | current bucket rows=7 |
...
- recent exact live lane rows / win_rate: **69 / 0.6377**
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.3586**
