...
- generated_at: **2026-05-27 19:01:37 UTC**
...
- broader q65 rows / dominant regime: **4 / bear (1.0000)**
...
|---|---|---:|---:|---:|---|
| exact live lane | BLOCK|bear_bias200_hard_block|q00 | 4 | 0.0 | -0.2578 | current bucket rows=4 |
| exact bucket proxy | BLOCK|bear_bias200_hard_block|q00 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | BLOCK|bear_bias200_hard_block|q00 | 4 | 0.0 | -0.2578 | dominant_regime=bear |
...
- exact live structure bucket: `BLOCK|bear_bias200_hard_block|q00` rows=4
