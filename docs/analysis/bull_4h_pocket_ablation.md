...
- generated_at: **2026-05-18 05:01:48 UTC**
...
- bull_all rows: **2513** / win_rate **0.5010** / recommended **`current_full_minus_4h_structure_shift`**
...
- dominant neighbor bucket: `CAUTION|structure_quality_caution|q15` rows=37
- bucket gap vs dominant neighbor: **37**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / bear (0.9024)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 37 | 0.5405 | 0.2395 | current bucket rows=0 |
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.814, "feat_4h_dist_bb_lower": 4.0508, "feat_4h_bb_pct_b": 0.6994}
