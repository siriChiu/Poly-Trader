...
- generated_at: **2026-05-26 10:25:53 UTC**
...
- bull_all rows: **2490** / win_rate **0.4964** / recommended **`current_full_minus_4h_structure_shift`**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=66
- bucket gap vs dominant neighbor: **59**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **7 / chop (0.9125)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 73 | 0.5342 | 0.1698 | current bucket rows=7 |
...
- recent exact live lane rows / win_rate: **73 / 0.6027**
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.3839**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.7677, "feat_4h_dist_bb_lower": 4.0212, "feat_4h_bb_pct_b": 0.6991}
