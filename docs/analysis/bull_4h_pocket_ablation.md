...
- generated_at: **2026-05-16 03:02:07 UTC**
...
- bull_all rows: **2516** / win_rate **0.5008** / recommended **`current_full_minus_4h_structure_shift`**
...
- bull_live_exact_lane_bucket_proxy rows: **7** / win_rate **0.0000** / recommended **`None`**
...
- broader q65 rows / dominant regime: **9 / bear (1.0000)**
...
- decision-quality scope / label: **regime_label+entry_quality_label / B**
...
|---|---|---:|---:|---:|---|
| exact live lane | BLOCK|structure_quality_block|q00 | 9 | 1.0 | 0.7364 | current bucket rows=9 |
| exact bucket proxy | BLOCK|structure_quality_block|q00 | 7 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | BLOCK|structure_quality_block|q00 | 9 | 1.0 | 0.7364 | dominant_regime=bear |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **7 / 0.0**
- recent exact live lane rows / win_rate: **9 / 0.0**
- historical exact-bucket proxy rows / win_rate: **7 / 0.0**
- recent broader same-bucket rows / dominant regime: **9 / bear**
- proxy vs current bucket win Δ / row ratio: **0.0 / 1.0**
- exact lane vs current bucket win Δ / quality Δ: **0.0 / 0.0**
- broader same-bucket vs current bucket win Δ / quality Δ: **1.0 / 0.0**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.8155, "feat_4h_dist_bb_lower": 4.0557, "feat_4h_bb_pct_b": 0.6995}
- exact live structure bucket: `BLOCK|structure_quality_block|q00` rows=9
