...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q35 | 1 | 0.0 | -0.4283 | current bucket rows=1 |
| exact bucket proxy | CAUTION|structure_quality_caution|q35 | 649 | 0.7996918335901386 | None | proxy-vs-broader win Δ=0.7997 |
| broader same bucket | CAUTION|structure_quality_caution|q35 | 1 | 0.0 | -0.4283 | dominant_regime=bull |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **1 / 0.0**
- recent exact live lane rows / win_rate: **1 / 0.0**
- historical exact-bucket proxy rows / win_rate: **649 / 0.7997**
- recent broader same-bucket rows / dominant regime: **1 / bull**
- proxy vs current bucket win Δ / row ratio: **0.7997 / 649.0**
