...
- generated_at: **2026-05-26 13:28:33 UTC**
...
- bull_all rows: **2486** / win_rate **0.4960** / recommended **`current_full_minus_4h_structure_shift`**
- bull_collapse_q35 rows: **912** / win_rate **0.3860** / recommended **`core_plus_macro_plus_all_4h`**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=75
- bucket gap vs dominant neighbor: **68**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **7 / chop (0.9213)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 82 | 0.4756 | 0.1333 | current bucket rows=7 |
...
- recent exact live lane rows / win_rate: **82 / 0.5488**
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.4204**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.762, "feat_4h_dist_bb_lower": 4.0147, "feat_4h_bb_pct_b": 0.699}
