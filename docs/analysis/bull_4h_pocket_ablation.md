...
- generated_at: **2026-05-26 04:19:42 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=49
- bucket gap vs dominant neighbor: **49**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / chop (0.8889)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q35 | 56 | 0.6964 | 0.2819 | current bucket rows=0 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q00 | 0 | 0.0 | None | proxy-vs-broader win Δ=None |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q00 | 0 | None | None | dominant_regime=chop |
...
- supported neighbor buckets from exact scope: ["CAUTION|base_caution_regime_or_bias|q35", "CAUTION|base_caution_regime_or_bias|q15"]
