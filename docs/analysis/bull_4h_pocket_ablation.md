...
- generated_at: **2026-04-18 04:44:44 UTC**
...
- bull_all rows: **1168** / win_rate **0.7594** / recommended **`core_plus_macro_plus_all_4h`**
- bull_collapse_q35 rows: **407** / win_rate **0.6757** / recommended **`core_plus_macro`**
...
|---|---:|---:|---:|---:|---:|---:|
| core_plus_macro_plus_all_4h | 20 | 0.5639 | 0.3351 | 0.0464 | 0.2566 | 0.9800 |
| core_plus_macro_plus_4h_structure_shift | 13 | 0.5619 | 0.3335 | 0.0464 | 0.2532 | 0.9300 |
| core_plus_macro_plus_4h_trend | 13 | 0.5619 | 0.3395 | 0.0309 | 0.2770 | 0.8400 |
| core_plus_macro_plus_4h_momentum | 13 | 0.5619 | 0.3395 | 0.0309 | 0.2854 | 0.8600 |
| core_plus_macro | 10 | 0.5619 | 0.3395 | 0.0309 | 0.3055 | 0.8100 |
| current_full | 131 | 0.4443 | 0.3206 | 0.0619 | 0.3050 | 0.9500 |
| current_full_minus_4h | 121 | 0.4423 | 0.3236 | 0.0464 | 0.3329 | 0.9400 |
| current_full_minus_4h_structure_shift | 128 | 0.4412 | 0.3243 | 0.0464 | 0.3195 | 0.9400 |

## Bull collapse-pocket ranking

| profile | n_features | cv_mean | cv_std | cv_worst | brier | top10 |
|---|---:|---:|---:|---:|---:|---:|
| core_plus_macro | 10 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
| core_plus_macro_plus_4h_structure_shift | 13 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
| core_plus_macro_plus_4h_trend | 13 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
| core_plus_macro_plus_4h_momentum | 13 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
| core_plus_macro_plus_all_4h | 20 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
| current_full_minus_4h_structure_shift | 128 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
| current_full_minus_4h | 121 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
| current_full | 131 | 0.6119 | 0.1642 | 0.4478 | 0.2160 | 0.5714 |
...
| exact bucket proxy | CAUTION|structure_quality_caution|q35 | 0 | 0.0 | None | proxy-vs-broader win Δ=None |
| broader same bucket | CAUTION|structure_quality_caution|q35 | 0 | None | None | dominant_regime=None |
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 2.0359, "feat_4h_dist_bb_lower": 1.4905, "feat_4h_bb_pct_b": 0.4289}
- exact live structure bucket: `CAUTION|structure_quality_caution|q35` rows=0
