...
- generated_at: **2026-04-19 06:30:04 UTC**
...
- bull_all rows: **1367** / win_rate **0.6152** / recommended **`core_plus_macro_plus_4h_trend`**
- bull_collapse_q35 rows: **481** / win_rate **0.7484** / recommended **`core_plus_macro`**
...
|---|---:|---:|---:|---:|---:|---:|
| core_plus_macro_plus_4h_trend | 13 | 0.6322 | 0.3131 | 0.1366 | 0.1827 | 0.8804 |
| core_plus_macro_plus_4h_momentum | 13 | 0.6322 | 0.3131 | 0.1366 | 0.2002 | 0.8696 |
| core_plus_macro_plus_all_4h | 20 | 0.6311 | 0.3145 | 0.1366 | 0.1888 | 0.9457 |
| core_plus_macro_plus_4h_structure_shift | 13 | 0.5683 | 0.2868 | 0.1366 | 0.2108 | 0.8804 |
| core_plus_macro | 10 | 0.5672 | 0.2850 | 0.1366 | 0.2257 | 0.8587 |
| current_full | 131 | 0.5132 | 0.2921 | 0.1366 | 0.2366 | 1.0000 |
| current_full_minus_4h | 121 | 0.5132 | 0.2942 | 0.1366 | 0.2416 | 1.0000 |
| current_full_minus_4h_structure_shift | 128 | 0.5121 | 0.2926 | 0.1366 | 0.2290 | 1.0000 |

## Bull collapse-pocket ranking

| profile | n_features | cv_mean | cv_std | cv_worst | brier | top10 |
|---|---:|---:|---:|---:|---:|---:|
| core_plus_macro | 10 | 0.5125 | 0.4750 | 0.0375 | 0.2665 | 1.0000 |
| core_plus_macro_plus_4h_trend | 13 | 0.5125 | 0.4750 | 0.0375 | 0.2681 | 0.9375 |
| core_plus_macro_plus_4h_momentum | 13 | 0.5125 | 0.4750 | 0.0375 | 0.2691 | 1.0000 |
| core_plus_macro_plus_all_4h | 20 | 0.5125 | 0.4750 | 0.0375 | 0.2739 | 1.0000 |
| current_full_minus_4h_structure_shift | 128 | 0.5125 | 0.4750 | 0.0375 | 0.2747 | 1.0000 |
| current_full | 131 | 0.5125 | 0.4750 | 0.0375 | 0.2792 | 1.0000 |
| core_plus_macro_plus_4h_structure_shift | 13 | 0.5125 | 0.4750 | 0.0375 | 0.2799 | 1.0000 |
| current_full_minus_4h | 121 | 0.5125 | 0.4750 | 0.0375 | 0.2816 | 1.0000 |
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 2.9337, "feat_4h_dist_bb_lower": 1.6069, "feat_4h_bb_pct_b": 0.4875}
