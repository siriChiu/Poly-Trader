...
- generated_at: **2026-05-16 20:02:01 UTC**
...
- broader q65 rows / dominant regime: **9 / bear (0.6923)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 9 | 1.0 | 0.698 | current bucket rows=9 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 9 | 1.0 | 0.698 | dominant_regime=bear |
...
- exact live structure bucket: `CAUTION|structure_quality_caution|q15` rows=9
