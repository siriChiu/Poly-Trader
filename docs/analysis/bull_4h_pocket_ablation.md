...
- generated_at: **2026-05-17 00:09:02 UTC**
...
- broader q65 rows / dominant regime: **2 / chop (0.6667)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 2 | 1.0 | 0.7164 | current bucket rows=2 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 2 | 1.0 | 0.7164 | dominant_regime=chop |
