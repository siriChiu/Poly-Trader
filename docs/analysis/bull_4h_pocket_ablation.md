...
- generated_at: **2026-05-24 02:14:25 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=61
- bucket gap vs dominant neighbor: **53**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **8 / chop (0.6832)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q35 | 69 | 0.2464 | -0.1123 | current bucket rows=8 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q35 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q35 | 8 | 0.0 | -0.2517 | dominant_regime=chop |
...
- exact lane vs current bucket win Δ / quality Δ: **None / 0.1394**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=8
