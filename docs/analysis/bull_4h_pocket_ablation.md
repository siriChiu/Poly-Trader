...
- generated_at: **2026-05-15 06:02:14 UTC**
...
- broader q65 rows / dominant regime: **4 / chop (0.9298)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 4 | 1.0 | 0.6732 | current bucket rows=4 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 152 | 0.5855263157894737 | None | proxy-vs-broader win Δ=-0.4145 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 4 | 1.0 | 0.6732 | dominant_regime=chop |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **4 / 0.75**
- recent exact live lane rows / win_rate: **4 / 0.25**
- historical exact-bucket proxy rows / win_rate: **152 / 0.5855**
- recent broader same-bucket rows / dominant regime: **4 / bear**
- proxy vs current bucket win Δ / row ratio: **-0.1645 / 38.0**
- exact lane vs current bucket win Δ / quality Δ: **-0.5 / 0.0**
- broader same-bucket vs current bucket win Δ / quality Δ: **0.25 / 0.0**
...
- exact live structure bucket: `CAUTION|structure_quality_caution|q15` rows=4
