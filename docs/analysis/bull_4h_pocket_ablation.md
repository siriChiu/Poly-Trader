...
- generated_at: **2026-05-27 23:02:18 UTC**
...
|---|---|---:|---:|---:|---|
| exact live lane | BLOCK|bear_bias200_hard_block|q00 | 7 | 0.0 | -0.2998 | current bucket rows=7 |
| exact bucket proxy | BLOCK|bear_bias200_hard_block|q00 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | BLOCK|bear_bias200_hard_block|q00 | 7 | 0.0 | -0.2998 | dominant_regime=bear |
...
- exact live structure bucket: `BLOCK|bear_bias200_hard_block|q00` rows=7
