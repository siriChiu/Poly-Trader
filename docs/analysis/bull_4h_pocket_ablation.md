...
- generated_at: **2026-05-22 09:14:12 UTC**
...
- broader q65 rows / dominant regime: **103 / chop (0.5872)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 71 | 1.0 | 0.5395 | current bucket rows=66 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.8155 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 103 | 0.8155 | 0.3998 | dominant_regime=chop |
...
- recent broader same-bucket rows / dominant regime: **103 / bear**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / 0.0034**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / -0.1363**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=66
- supported neighbor buckets from exact scope: ["CAUTION|base_caution_regime_or_bias|q35", "CAUTION|base_caution_regime_or_bias|q00"]
