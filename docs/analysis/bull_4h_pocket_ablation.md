...
- generated_at: **2026-05-16 23:02:48 UTC**
...
- broader q65 rows / dominant regime: **4 / chop (0.5000)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 4 | 1.0 | 0.7166 | current bucket rows=4 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 4 | 1.0 | 0.7166 | dominant_regime=chop |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **0 / None**
- recent exact live lane rows / win_rate: **4 / 0.75**
