...
- generated_at: **2026-05-21 20:13:46 UTC**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 6 | 0.5 | 0.1538 | current bucket rows=1 |
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.3521**
