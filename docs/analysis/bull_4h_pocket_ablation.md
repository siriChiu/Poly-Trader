...
- generated_at: **2026-05-22 10:13:07 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=64
- bucket gap vs dominant neighbor: **23**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **103 / chop (0.6105)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 105 | 0.3905 | 0.0923 | current bucket rows=41 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.8155 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 103 | 0.8155 | 0.3962 | dominant_regime=chop |
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.0917**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / 0.2122**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=41
