...
- generated_at: **2026-04-14 19:09:31 UTC**
...
- bull_exact_live_lane_proxy rows: **377** / win_rate **0.8302** / recommended **`core_plus_macro`**
- bull_live_exact_lane_bucket_proxy rows: **114** / win_rate **0.9737** / recommended **`None`**
...
|---|---:|---:|---:|---:|---:|---:|
| core_plus_macro_plus_4h_structure_shift | 13 | 0.7571 | 0.1589 | 0.4603 | 0.1936 | 0.9231 |
| core_plus_macro_plus_all_4h | 20 | 0.6619 | 0.1786 | 0.4365 | 0.2028 | 0.9385 |
| core_plus_macro | 10 | 0.6619 | 0.1786 | 0.4365 | 0.2111 | 0.7538 |
| core_plus_macro_plus_4h_momentum | 13 | 0.6619 | 0.1786 | 0.4365 | 0.2188 | 0.7538 |
| current_full | 131 | 0.6619 | 0.1786 | 0.4365 | 0.2192 | 0.8923 |
| core_plus_macro_plus_4h_trend | 13 | 0.6619 | 0.1786 | 0.4365 | 0.2273 | 0.8154 |
| current_full_minus_4h | 121 | 0.6619 | 0.1786 | 0.4365 | 0.2293 | 0.6923 |
| current_full_minus_4h_structure_shift | 128 | 0.6619 | 0.1786 | 0.4365 | 0.2321 | 0.7231 |

## Bull collapse-pocket ranking

| profile | n_features | cv_mean | cv_std | cv_worst | brier | top10 |
|---|---:|---:|---:|---:|---:|---:|
| core_plus_macro | 10 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
| core_plus_macro_plus_4h_structure_shift | 13 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
| core_plus_macro_plus_4h_trend | 13 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
| core_plus_macro_plus_4h_momentum | 13 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
| core_plus_macro_plus_all_4h | 20 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
| current_full_minus_4h_structure_shift | 128 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
| current_full_minus_4h | 121 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
| current_full | 131 | 0.6589 | 0.1581 | 0.4419 | 0.2701 | 0.6667 |
...
- broader q65 rows / dominant regime: **63 / chop (0.8700)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q35 | 78 | 0.8333 | 0.5429 | current bucket rows=61 |
| exact bucket proxy | CAUTION|structure_quality_caution|q35 | 114 | 0.9736842105263158 | None | proxy-vs-broader win Δ=-0.0104 |
| broader same bucket | CAUTION|structure_quality_caution|q35 | 63 | 0.9841 | 0.6923 | dominant_regime=chop |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **61 / 1.0**
- recent exact live lane rows / win_rate: **78 / 0.9103**
- historical exact-bucket proxy rows / win_rate: **114 / 0.9737**
- recent broader same-bucket rows / dominant regime: **63 / bull**
- proxy vs current bucket win Δ / row ratio: **-0.0263 / 1.8689**
- exact lane vs current bucket win Δ / quality Δ: **-0.0897 / -0.1688**
- broader same-bucket vs current bucket win Δ / quality Δ: **0.0 / -0.0194**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 1.8088, "feat_4h_dist_bb_lower": 0.8161, "feat_4h_bb_pct_b": 0.1337}
- exact live structure bucket: `CAUTION|structure_quality_caution|q35` rows=61
