...
- generated_at: **2026-05-28 03:01:36 UTC**
...
- broader q65 rows / dominant regime: **8 / bear (1.0000)**
...
|---|---|---:|---:|---:|---|
| exact live lane | BLOCK|bear_bias200_hard_block|q00 | 8 | 0.0 | -0.311 | current bucket rows=8 |
| exact bucket proxy | BLOCK|bear_bias200_hard_block|q00 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | BLOCK|bear_bias200_hard_block|q00 | 8 | 0.0 | -0.311 | dominant_regime=bear |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **0 / None**
- recent exact live lane rows / win_rate: **8 / 0.0**
- historical exact-bucket proxy rows / win_rate: **0 / None**
- recent broader same-bucket rows / dominant regime: **8 / bear**
...
- exact live structure bucket: `BLOCK|bear_bias200_hard_block|q00` rows=8
