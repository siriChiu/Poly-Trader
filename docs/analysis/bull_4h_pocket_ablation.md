...
- generated_at: **2026-05-21 18:12:08 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=37
- bucket gap vs dominant neighbor: **24**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **128 / bear (0.7222)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 50 | 0.5 | 0.1934 | current bucket rows=13 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.7734 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 128 | 0.7734 | 0.3616 | dominant_regime=bear |
...
- recent broader same-bucket rows / dominant regime: **128 / bear**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / -0.0326**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / 0.1356**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=13
