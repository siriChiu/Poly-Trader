...
- generated_at: **2026-05-17 22:02:31 UTC**
...
- current bucket gap to minimum: **19**
...
- broader q65 rows / dominant regime: **31 / bear (0.8857)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 31 | 0.8387 | 0.5019 | current bucket rows=31 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.8387 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 31 | 0.8387 | 0.5019 | dominant_regime=bear |
...
- recent broader same-bucket rows / dominant regime: **31 / bear**
...
- exact live structure bucket: `CAUTION|structure_quality_caution|q15` rows=31
