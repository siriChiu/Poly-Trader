...
- generated_at: **2026-05-15 07:02:52 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q00` rows=21
- bucket gap vs dominant neighbor: **20**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **1 / chop (0.6875)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 22 | 0.7273 | 0.3095 | current bucket rows=1 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 1 | 1.0 | 0.3444 | dominant_regime=chop |
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.0349**
