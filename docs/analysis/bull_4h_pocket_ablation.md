...
- generated_at: **2026-05-25 20:02:16 UTC**
...
- bucket gap vs dominant neighbor: **19**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **7 / chop (0.8250)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 33 | 0.9091 | 0.4018 | current bucket rows=7 |
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.1519**
