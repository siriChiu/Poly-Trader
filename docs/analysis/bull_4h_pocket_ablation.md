...
- generated_at: **2026-05-16 21:02:47 UTC**
...
- broader q65 rows / dominant regime: **7 / bear (0.6364)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 7 | 1.0 | 0.6991 | current bucket rows=7 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 7 | 1.0 | 0.6991 | dominant_regime=bear |
...
- exact live structure bucket: `CAUTION|structure_quality_caution|q15` rows=7
