...
- generated_at: **2026-05-02 02:02:55 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q00` rows=2
- bucket gap vs dominant neighbor: **0**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **21 / chop (0.5111)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q35 | 23 | 0.6957 | 0.4237 | current bucket rows=21 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q35 | 1 | 1.0 | None | proxy-vs-broader win Δ=0.3333 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q35 | 21 | 0.6667 | 0.4231 | dominant_regime=chop |
...
- recent broader same-bucket rows / dominant regime: **21 / chop**
- proxy vs current bucket win Δ / row ratio: **0.0 / 1.0**
- exact lane vs current bucket win Δ / quality Δ: **-0.8696 / 0.0006**
- broader same-bucket vs current bucket win Δ / quality Δ: **-0.3333 / 0.0**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=21
