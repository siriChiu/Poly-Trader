...
- generated_at: **2026-05-18 00:01:27 UTC**
...
- dominant neighbor bucket: `CAUTION|structure_quality_caution|q15` rows=36
- bucket gap vs dominant neighbor: **36**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / bear (0.9000)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 36 | 0.6944 | 0.3859 | current bucket rows=0 |
