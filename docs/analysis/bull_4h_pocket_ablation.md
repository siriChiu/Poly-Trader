...
- generated_at: **2026-05-24 14:02:28 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=37
- bucket gap vs dominant neighbor: **37**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / chop (0.5873)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 37 | 0.0 | -0.321 | current bucket rows=0 |
