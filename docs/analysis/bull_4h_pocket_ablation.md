...
- generated_at: **2026-05-22 17:09:25 UTC**
...
- bucket gap vs dominant neighbor: **38**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **1 / chop (0.7346)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q00 | 43 | 0.9767 | 0.5423 | current bucket rows=1 |
...
- exact lane vs current bucket win Δ / quality Δ: **None / 0.0608**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q00` rows=1
