...
- generated_at: **2026-05-24 15:02:19 UTC**
...
- bull_all rows: **2495** / win_rate **0.4974** / recommended **`current_full_minus_4h_structure_shift`**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q00` rows=19
- bucket gap vs dominant neighbor: **12**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **43 / chop (0.5806)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 26 | 0.2308 | -0.1439 | current bucket rows=7 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 43 | 0.0 | -0.3364 | dominant_regime=chop |
...
- recent broader same-bucket rows / dominant regime: **43 / chop**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / 0.2669**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / 0.0744**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.7867, "feat_4h_dist_bb_lower": 4.0272, "feat_4h_bb_pct_b": 0.699}
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=7
