...
- generated_at: **2026-05-17 16:02:19 UTC**
...
- broader q65 rows / dominant regime: **3 / bear (0.7500)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 3 | 0.0 | -0.1499 | current bucket rows=3 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 3 | 0.0 | -0.1499 | dominant_regime=bear |
...
- recent broader same-bucket rows / dominant regime: **3 / bear**
...
- exact live structure bucket: `CAUTION|structure_quality_caution|q15` rows=3
