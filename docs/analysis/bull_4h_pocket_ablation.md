...
- generated_at: **2026-05-16 16:02:25 UTC**
...
|---|---|---:|---:|---:|---|
| exact live lane | BLOCK|structure_quality_block|q00 | 5 | 0.0 | -0.3071 | current bucket rows=5 |
| exact bucket proxy | BLOCK|structure_quality_block|q00 | 7 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | BLOCK|structure_quality_block|q00 | 5 | 0.0 | -0.3071 | dominant_regime=bear |
