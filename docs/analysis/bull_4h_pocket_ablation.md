...
- generated_at: **2026-05-02 03:02:41 UTC**
...
- broader q65 rows / dominant regime: **22 / chop (0.5111)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q35 | 23 | 0.6957 | 0.4349 | current bucket rows=22 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q35 | 1 | 1.0 | None | proxy-vs-broader win Δ=0.3182 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q35 | 22 | 0.6818 | 0.4354 | dominant_regime=chop |
...
- exact lane vs current bucket win Δ / quality Δ: **-0.8696 / -0.0005**
- broader same-bucket vs current bucket win Δ / quality Δ: **-0.3182 / 0.0**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=22
