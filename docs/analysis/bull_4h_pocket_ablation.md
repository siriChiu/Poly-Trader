...
- generated_at: **2026-05-22 14:13:06 UTC**
...
- current bucket gap to minimum: **1**
...
- broader q65 rows / dominant regime: **103 / chop (0.6901)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 53 | 1.0 | 0.5454 | current bucket rows=49 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.8155 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 103 | 0.8155 | 0.389 | dominant_regime=chop |
...
- recent broader same-bucket rows / dominant regime: **103 / chop**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / 0.0**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / -0.1564**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=49
- supported neighbor buckets from exact scope: ["CAUTION|base_caution_regime_or_bias|q00", "CAUTION|base_caution_regime_or_bias|q35"]
