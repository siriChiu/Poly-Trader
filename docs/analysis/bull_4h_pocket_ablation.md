...
- generated_at: **2026-05-17 06:02:28 UTC**
...
- broader q65 rows / dominant regime: **21 / bear (0.5833)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 21 | 1.0 | 0.6838 | current bucket rows=21 |
| exact bucket proxy | CAUTION|structure_quality_caution|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-1.0 |
| broader same bucket | CAUTION|structure_quality_caution|q15 | 21 | 1.0 | 0.6838 | dominant_regime=bear |
...
- recent broader same-bucket rows / dominant regime: **21 / bear**
...
- exact live structure bucket: `CAUTION|structure_quality_caution|q15` rows=21
