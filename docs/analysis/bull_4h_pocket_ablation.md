...
- generated_at: **2026-04-29 09:03:16 UTC**
...
- bull_all rows: **2454** / win_rate **0.5004** / recommended **`core_plus_macro_plus_4h_trend`**
- bull_collapse_q35 rows: **943** / win_rate **0.4411** / recommended **`core_plus_macro_plus_all_4h`**
- bull_exact_live_lane_proxy rows: **822** / win_rate **0.4854** / recommended **`None`**
- bull_live_exact_lane_bucket_proxy rows: **687** / win_rate **0.4745** / recommended **`None`**
- bull_supported_neighbor_buckets_proxy rows: **132** / win_rate **0.5303** / recommended **`None`**
...
- broader q65 rows / dominant regime: **0 / chop (0.8793)**
...
| exact bucket proxy | CAUTION|structure_quality_caution|q35 | 687 | 0.4745269286754003 | None | proxy-vs-broader win Δ=None |
| broader same bucket | CAUTION|structure_quality_caution|q35 | 0 | None | None | dominant_regime=chop |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **0 / None**
- recent exact live lane rows / win_rate: **0 / None**
- historical exact-bucket proxy rows / win_rate: **687 / 0.4745**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.9252, "feat_4h_dist_bb_lower": 4.2511, "feat_4h_bb_pct_b": 0.7066}
- exact live structure bucket: `CAUTION|structure_quality_caution|q35` rows=0
- supported neighbor buckets from exact scope: ["CAUTION|base_caution_regime_or_bias|q00", "CAUTION|base_caution_regime_or_bias|q15", "CAUTION|structure_quality_caution|q15"]
