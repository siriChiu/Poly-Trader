...
- generated_at: **2026-05-25 18:10:52 UTC**
...
- bull_all rows: **2492** / win_rate **0.4968** / recommended **`current_full_minus_4h_structure_shift`**
- bull_collapse_q35 rows: **915** / win_rate **0.3880** / recommended **`core_plus_macro_plus_all_4h`**
...
- current bucket gap to minimum: **24**
...
- broader q65 rows / dominant regime: **33 / chop (0.7879)**
...
- decision-quality scope / label: **regime_gate+entry_quality_label / C**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q35 | 26 | 0.8846 | 0.3609 | current bucket rows=26 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q35 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.8788 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q35 | 33 | 0.8788 | 0.3681 | dominant_regime=chop |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **0 / None**
- recent exact live lane rows / win_rate: **26 / 0.8077**
- historical exact-bucket proxy rows / win_rate: **0 / None**
- recent broader same-bucket rows / dominant regime: **33 / chop**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / 0.0**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / 0.0072**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.781, "feat_4h_dist_bb_lower": 4.023, "feat_4h_bb_pct_b": 0.6991}
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=26
