...
- generated_at: **2026-05-26 00:13:27 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=36
- bucket gap vs dominant neighbor: **29**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **7 / chop (0.8600)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 43 | 0.907 | 0.4038 | current bucket rows=7 |
...
- recent exact live lane rows / win_rate: **43 / 0.8837**
...
- exact lane vs current bucket win Δ / quality Δ: **None / -0.1499**
