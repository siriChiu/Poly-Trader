...
- generated_at: **2026-05-18 04:02:18 UTC**
...
- dominant neighbor bucket: `CAUTION|structure_quality_caution|q15` rows=35
- bucket gap vs dominant neighbor: **35**
- exact bucket root cause: **same_lane_shifted_to_neighbor_bucket**
- broader q65 rows / dominant regime: **0 / bear (0.8974)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|structure_quality_caution|q15 | 35 | 0.6 | 0.2988 | current bucket rows=0 |
