...
- generated_at: **2026-05-21 16:01:45 UTC**
...
- decision-quality scope / label: **regime_gate / C**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 1 | 1.0 | 0.5059 | current bucket rows=1 |
...
- recent exact live lane rows / win_rate: **1 / 0.0**
