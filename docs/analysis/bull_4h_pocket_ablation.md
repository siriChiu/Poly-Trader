...
- generated_at: **2026-05-22 13:01:22 UTC**
...
- bull_all rows: **2502** / win_rate **0.4988** / recommended **`current_full_minus_4h_structure_shift`**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=16
- bucket gap vs dominant neighbor: **10**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **6 / chop (1.0000)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 22 | 0.2273 | -0.044 | current bucket rows=6 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=-0.5 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 6 | 0.5 | 0.1499 | dominant_regime=chop |

## Proxy boundary diagnostics

- recent exact current bucket rows / win_rate: **0 / None**
- recent exact live lane rows / win_rate: **22 / 0.7727**
- historical exact-bucket proxy rows / win_rate: **0 / None**
- recent broader same-bucket rows / dominant regime: **6 / chop**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / -0.1939**
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.792, "feat_4h_dist_bb_lower": 4.0394, "feat_4h_bb_pct_b": 0.6991}
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=6
