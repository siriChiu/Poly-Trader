...
- generated_at: **2026-05-28 06:05:54 UTC**
...
- broader q65 rows / dominant regime: **12 / bear (1.0000)**
...
|---|---|---:|---:|---:|---|
| exact live lane | BLOCK|bear_bias200_hard_block|q00 | 12 | 0.0 | -0.336 | current bucket rows=12 |
| exact bucket proxy | BLOCK|bear_bias200_hard_block|q00 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | BLOCK|bear_bias200_hard_block|q00 | 12 | 0.0 | -0.336 | dominant_regime=bear |
...
- recent broader same-bucket rows / dominant regime: **12 / bear**
...
- exact live structure bucket: `BLOCK|bear_bias200_hard_block|q00` rows=12
