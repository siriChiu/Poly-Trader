...
- generated_at: **2026-05-24 17:14:52 UTC**
...
- current bucket gap to minimum: **18**
...
- broader q65 rows / dominant regime: **39 / chop (0.5517)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 32 | 0.0 | -0.3305 | current bucket rows=32 |
| exact bucket proxy | CAUTION|base_caution_regime_or_bias|q15 | 0 | 0.0 | None | proxy-vs-broader win Δ=0.0 |
| broader same bucket | CAUTION|base_caution_regime_or_bias|q15 | 39 | 0.0 | -0.3449 | dominant_regime=chop |
...
- recent broader same-bucket rows / dominant regime: **39 / chop**
- proxy vs current bucket win Δ / row ratio: **None / None**
- exact lane vs current bucket win Δ / quality Δ: **None / 0.0**
- broader same-bucket vs current bucket win Δ / quality Δ: **None / -0.0144**
...
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q15` rows=32
