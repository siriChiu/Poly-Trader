...
- generated_at: **2026-05-15 09:12:49 UTC**
...
- dominant neighbor bucket: `CAUTION|base_caution_regime_or_bias|q00` rows=40
- bucket gap vs dominant neighbor: **36**
- exact bucket root cause: **exact_bucket_present_but_below_minimum**
- broader q65 rows / dominant regime: **4 / chop (0.8462)**
...
|---|---|---:|---:|---:|---|
| exact live lane | CAUTION|base_caution_regime_or_bias|q15 | 44 | 0.5 | 0.1716 | current bucket rows=4 |
...
- recent exact live lane rows / win_rate: **44 / 0.8864**
...
- exact lane vs current bucket win Δ / quality Δ: **None / 0.189**
