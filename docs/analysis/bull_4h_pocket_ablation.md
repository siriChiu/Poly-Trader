...
- generated_at: **2026-05-21 02:02:40 UTC**
...
- bull_all rows: **2510** / win_rate **0.5004** / recommended **`current_full_minus_4h_structure_shift`**
...
| broader same bucket | CAUTION|base_caution_regime_or_bias|q35 | 0 | None | None | dominant_regime=bear |
...
- thresholds (bull q35): {"feat_4h_dist_swing_low": 4.8124, "feat_4h_dist_bb_lower": 4.0466, "feat_4h_bb_pct_b": 0.6993}
- exact live structure bucket: `CAUTION|base_caution_regime_or_bias|q35` rows=0
- supported neighbor buckets from exact scope: ["CAUTION|base_caution_regime_or_bias|q15", "CAUTION|base_caution_regime_or_bias|q00", "CAUTION|structure_quality_caution|q15"]
