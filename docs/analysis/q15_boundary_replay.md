...
- entry_quality: **0.5176** (trade_floor_gap=-0.0324)
...
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** rows=565

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.6888 → 0.6888**
- structure_quality: **0.3861 → 0.3861**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5176 → 0.5176**
- trade_floor_gap_after: **-0.0324**
