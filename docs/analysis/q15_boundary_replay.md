...
- entry_quality: **0.3862** (trade_floor_gap=-0.1638)
...
- raw before/after: **0.3466 → 0.7407**
- structure_quality: **0.216 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.3862 → 0.4197**
- trade_floor_gap_after: **-0.1303**
