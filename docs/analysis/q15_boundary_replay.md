...
- entry_quality: **0.6636** (trade_floor_gap=0.1136)
...
- raw before/after: **0.7573 → 0.7573**
- structure_quality: **0.4559 → 0.4559**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.6636 → 0.6636**
- trade_floor_gap_after: **0.1136**
