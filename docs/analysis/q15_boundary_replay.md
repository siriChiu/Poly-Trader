...
- entry_quality: **0.6906** (trade_floor_gap=0.1406)
...
- generated_rows_via_boundary_only: **6**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=6)
- dominant_neighbor_bucket: **BLOCK|structure_quality_block|q00** rows=6

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **-0.0105 → None**
- structure_quality: **0.0 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.6906 → 0.7781**
- trade_floor_gap_after: **0.2281**
