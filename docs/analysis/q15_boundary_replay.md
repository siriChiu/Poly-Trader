...
- entry_quality: **0.5231** (trade_floor_gap=-0.0269)
...
- raw before/after: **0.3624 → None**
- structure_quality: **0.1536 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5231 → 0.5722**
- trade_floor_gap_after: **0.0222**
