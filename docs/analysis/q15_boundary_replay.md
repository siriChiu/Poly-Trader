...
- entry_quality: **0.3792** (trade_floor_gap=-0.1708)
...
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** rows=1141

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.3461 → 0.6161**
- structure_quality: **0.2582 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.3792 → 0.4022**
- trade_floor_gap_after: **-0.1478**
