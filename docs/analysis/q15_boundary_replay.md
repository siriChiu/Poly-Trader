...
- entry_quality: **0.5936** (trade_floor_gap=0.0436)
...
- raw before/after: **0.7262 → 0.7262**
- structure_quality: **0.38 → 0.38**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5936 → 0.5936**
- trade_floor_gap_after: **0.0436**
