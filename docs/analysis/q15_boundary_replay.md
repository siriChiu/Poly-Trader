...
- entry_quality: **0.4007** (trade_floor_gap=-0.1493)
...
- raw before/after: **0.3373 → 0.5402**
- structure_quality: **0.281 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4007 → 0.418**
- trade_floor_gap_after: **-0.132**
