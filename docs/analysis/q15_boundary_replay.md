...
- entry_quality: **0.42** (trade_floor_gap=-0.13)
...
- raw before/after: **0.3996 → 0.5184**
- structure_quality: **0.3096 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.42 → 0.4301**
- trade_floor_gap_after: **-0.1199**
