...
- entry_quality: **0.4998** (trade_floor_gap=-0.0502)
...
- generated_rows_via_boundary_only: **295**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=295)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q00** rows=370

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5174 → None**
- structure_quality: **0.2722 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q00**
- entry_quality: **0.4998 → 0.5192**
- trade_floor_gap_after: **-0.0308**
