...
- entry_quality: **0.5775** (trade_floor_gap=0.0275)
...
- raw before/after: **0.5676 → None**
- structure_quality: **0.2833 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5775 → 0.5942**
- trade_floor_gap_after: **0.0442**
