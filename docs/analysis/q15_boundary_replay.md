...
- entry_quality: **0.5721** (trade_floor_gap=0.0221)
...
- raw before/after: **0.3745 → None**
- structure_quality: **0.1616 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5721 → 0.6192**
- trade_floor_gap_after: **0.0692**
