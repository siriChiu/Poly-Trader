...
- entry_quality: **0.6849** (trade_floor_gap=0.1349)
...
- raw before/after: **0.5085 → None**
- structure_quality: **0.2272 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6849 → 0.7156**
- trade_floor_gap_after: **0.1656**
