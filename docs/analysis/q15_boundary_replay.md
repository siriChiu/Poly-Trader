...
- entry_quality: **0.391** (trade_floor_gap=-0.159)
...
- raw before/after: **0.597 → 0.597**
- structure_quality: **0.4283 → 0.4283**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.391 → 0.391**
- trade_floor_gap_after: **-0.159**
