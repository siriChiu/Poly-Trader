...
- entry_quality: **0.3269** (trade_floor_gap=-0.2231)
...
- generated_rows_exceed_replay_scope: **True** (excess=13)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** rows=690

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4153 → 0.5165**
- structure_quality: **0.3156 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.3269 → 0.3355**
- trade_floor_gap_after: **-0.2145**
