...
- generated_rows_via_boundary_only: **402**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=402)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** rows=572

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.3169 → None**
- structure_quality: **0.1449 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4751 → 0.5264**
- trade_floor_gap_after: **-0.0236**
