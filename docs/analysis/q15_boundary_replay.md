...
- entry_quality: **0.6214** (trade_floor_gap=0.0714)
...
- generated_rows_exceed_replay_scope: **True** (excess=203)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q15** rows=122

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2143 → None**
- structure_quality: **0.1009 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.6214 → 0.6837**
- trade_floor_gap_after: **0.1337**
