...
- entry_quality: **0.5862** (trade_floor_gap=0.0362)
...
- raw before/after: **0.3087 → None**
- structure_quality: **0.1379 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5862 → 0.6392**
- trade_floor_gap_after: **0.0892**
