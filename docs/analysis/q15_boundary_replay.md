...
- entry_quality: **0.3473** (trade_floor_gap=-0.2027)
...
- raw before/after: **0.9403 → 0.9403**
- structure_quality: **0.6208 → 0.6208**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.3473 → 0.3473**
- trade_floor_gap_after: **-0.2027**
