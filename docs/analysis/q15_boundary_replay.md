...
- entry_quality: **0.4023** (trade_floor_gap=-0.1477)
...
- raw before/after: **0.8799 → 0.8799**
- structure_quality: **0.5837 → 0.5837**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4023 → 0.4023**
- trade_floor_gap_after: **-0.1477**
