...
- entry_quality: **0.4887** (trade_floor_gap=-0.0613)
...
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** rows=486

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.611 → None**
- structure_quality: **0.3457 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4887 → 0.4897**
- trade_floor_gap_after: **-0.0603**
