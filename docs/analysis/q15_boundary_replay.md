...
- entry_quality: **0.4731** (trade_floor_gap=-0.0769)
...
- raw before/after: **0.4319 → 0.686**
- structure_quality: **0.2636 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4731 → 0.4947**
- trade_floor_gap_after: **-0.0553**
