...
- entry_quality: **0.4077** (trade_floor_gap=-0.1423)
...
- raw before/after: **0.4087 → 0.4913**
- structure_quality: **0.3219 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4077 → 0.4147**
- trade_floor_gap_after: **-0.1353**
