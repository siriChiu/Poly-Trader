...
- entry_quality: **0.5333** (trade_floor_gap=-0.0167)
...
- raw before/after: **0.0445 → None**
- structure_quality: **0.043 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5333 → 0.61**
- trade_floor_gap_after: **0.06**
