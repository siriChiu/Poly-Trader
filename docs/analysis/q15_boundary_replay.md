...
- entry_quality: **0.4587** (trade_floor_gap=-0.0913)
...
- raw before/after: **0.7124 → None**
- structure_quality: **0.3676 → 0.3676**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.4587 → 0.4587**
- trade_floor_gap_after: **-0.0913**
