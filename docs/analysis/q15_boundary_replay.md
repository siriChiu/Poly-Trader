...
- entry_quality: **0.5353** (trade_floor_gap=-0.0147)
...
- raw before/after: **-0.0031 → None**
- structure_quality: **0.018 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5353 → 0.6183**
- trade_floor_gap_after: **0.0683**
