...
- entry_quality: **0.5573** (trade_floor_gap=0.0073)
...
- generated_rows_exceed_replay_scope: **True** (excess=64)
- dominant_neighbor_bucket: **BLOCK|structure_quality_block|q00** rows=90

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.1367 → None**
- structure_quality: **0.0605 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5573 → 0.6297**
- trade_floor_gap_after: **0.0797**
