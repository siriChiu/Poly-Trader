...
- entry_quality: **0.554** (trade_floor_gap=0.004)
...
- raw before/after: **1.1247 → None**
- structure_quality: **0.4759 → 0.4759**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.554 → 0.554**
- trade_floor_gap_after: **0.004**
