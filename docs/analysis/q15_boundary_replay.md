...
- raw before/after: **0.4581 → 0.6575**
- structure_quality: **0.2822 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.5026 → 0.5196**
- trade_floor_gap_after: **-0.0304**
