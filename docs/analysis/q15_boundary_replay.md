...
- entry_quality: **0.5237** (trade_floor_gap=-0.0263)
...
- generated_rows_via_boundary_only: **311**
...
- raw before/after: **0.1282 → 0.8058**
- structure_quality: **0.1196 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.5237 → 0.5813**
- trade_floor_gap_after: **0.0313**
