...
- entry_quality: **0.6927** (trade_floor_gap=0.1427)
...
- raw before/after: **0.304 → None**
- structure_quality: **0.1345 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.6927 → 0.7466**
- trade_floor_gap_after: **0.1966**
