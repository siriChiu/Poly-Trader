...
- entry_quality: **0.6012** (trade_floor_gap=0.0512)
...
- raw before/after: **0.6742 → 0.6742**
- structure_quality: **0.3598 → 0.3598**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.6012 → 0.6012**
- trade_floor_gap_after: **0.0512**
