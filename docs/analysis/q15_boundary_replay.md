...
- entry_quality: **0.4469** (trade_floor_gap=-0.1031)
...
- generated_rows_via_boundary_only: **170**
...
- raw before/after: **0.3291 → 0.7323**
- structure_quality: **0.2129 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4469 → 0.4812**
- trade_floor_gap_after: **-0.0688**
