...
- entry_quality: **0.5896** (trade_floor_gap=0.0396)
...
- raw before/after: **0.6565 → None**
- structure_quality: **0.291 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5896 → 0.6043**
- trade_floor_gap_after: **0.0543**
