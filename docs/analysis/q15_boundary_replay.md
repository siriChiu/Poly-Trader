...
- entry_quality: **0.6281** (trade_floor_gap=0.0781)
...
- replay bucket rows: **36**
- generated_rows_via_boundary_only: **57**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.0**
- generated_rows_exceed_replay_scope: **True** (excess=21)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=57

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.227 → 0.9596**
- structure_quality: **0.1009 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6281 → 0.6904**
- trade_floor_gap_after: **0.1404**
