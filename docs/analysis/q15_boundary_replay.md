...
- entry_quality: **0.4135** (trade_floor_gap=-0.1365)
...
- replay bucket rows: **115**
- generated_rows_via_boundary_only: **0**
- preexisting_rows_in_replay_bucket: **115**
- generated_row_share: **0.0**
- dominant_neighbor_bucket: **BLOCK|bull_high_bias200_overheat_block|q35** rows=122

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2886 → 0.6318**
- structure_quality: **0.2333 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q35**
- entry_quality: **0.4135 → 0.4427**
- trade_floor_gap_after: **-0.1073**
