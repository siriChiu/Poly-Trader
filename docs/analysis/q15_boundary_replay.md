...
- entry_quality: **0.4766** (trade_floor_gap=-0.0734)
...
- generated_rows_via_boundary_only: **478**
...
- raw before/after: **0.027 → 0.9591**
- structure_quality: **0.0331 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4766 → 0.5558**
- trade_floor_gap_after: **0.0058**
