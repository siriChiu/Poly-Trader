...
- entry_quality: **0.5062** (trade_floor_gap=-0.0438)
...
- generated_rows_via_boundary_only: **352**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=352)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** rows=449

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4593 → None**
- structure_quality: **0.2324 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5062 → 0.5356**
- trade_floor_gap_after: **-0.0144**
