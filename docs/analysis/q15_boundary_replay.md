...
- entry_quality: **0.7176** (trade_floor_gap=0.1676)
...
- raw before/after: **0.2535 → None**
- structure_quality: **0.1122 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.7176 → 0.7771**
- trade_floor_gap_after: **0.2271**
