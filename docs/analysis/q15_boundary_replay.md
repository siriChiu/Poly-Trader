...
- entry_quality: **0.6277** (trade_floor_gap=0.0777)
...
- replay bucket rows: **19**
- generated_rows_via_boundary_only: **5**
- preexisting_rows_in_replay_bucket: **14**
- generated_row_share: **0.2632**
