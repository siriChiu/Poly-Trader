...
- entry_quality: **0.5762** (trade_floor_gap=0.0262)
...
- raw before/after: **0.624 → 0.674**
- structure_quality: **0.333 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5762 → 0.5805**
- trade_floor_gap_after: **0.0305**
