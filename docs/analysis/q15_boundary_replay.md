...
- entry_quality: **0.4688** (trade_floor_gap=-0.0812)
...
- generated_rows_via_boundary_only: **256**
...
- raw before/after: **0.2304 → 0.7213**
- structure_quality: **0.1831 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4688 → 0.5105**
