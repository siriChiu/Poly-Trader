...
- entry_quality: **0.6823** (trade_floor_gap=0.1323)
...
- replay bucket rows: **75**
- generated_rows_via_boundary_only: **1**
- preexisting_rows_in_replay_bucket: **74**
- generated_row_share: **0.0133**
- generated_rows_exceed_replay_scope: **False** (excess=0)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=5

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5209 → None**
- structure_quality: **0.2747 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6823 → 0.7012**
- trade_floor_gap_after: **0.1512**
