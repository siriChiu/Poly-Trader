...
- entry_quality: **0.4202** (trade_floor_gap=-0.1298)
...
- raw before/after: **0.4199 → None**
- structure_quality: **0.2214 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4202 → 0.4524**
- trade_floor_gap_after: **-0.0976**
