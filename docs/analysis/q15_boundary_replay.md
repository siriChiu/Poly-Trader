...
- entry_quality: **0.3901** (trade_floor_gap=-0.1599)
...
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=183

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5372 → 0.5372**
- structure_quality: **0.356 → 0.356**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.3901 → 0.3901**
- trade_floor_gap_after: **-0.1599**
