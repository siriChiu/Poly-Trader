...
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** rows=492

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2418 → 0.818**
- structure_quality: **0.1541 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.552 → 0.601**
- trade_floor_gap_after: **0.051**
