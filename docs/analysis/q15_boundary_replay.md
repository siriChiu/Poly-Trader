...
- entry_quality: **0.3948** (trade_floor_gap=-0.1552)
...
- generated_rows_via_boundary_only: **171**
...
- raw before/after: **0.2614 → 0.6502**
- structure_quality: **0.2178 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.3948 → 0.4278**
- trade_floor_gap_after: **-0.1222**
