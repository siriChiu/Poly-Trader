...
- entry_quality: **0.685** (trade_floor_gap=0.135)
...
- raw before/after: **0.403 → 0.8615**
- structure_quality: **0.1941 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.685 → 0.724**
- trade_floor_gap_after: **0.174**
