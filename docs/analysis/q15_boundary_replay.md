...
- entry_quality: **0.4929** (trade_floor_gap=-0.0571)
...
- generated_rows_via_boundary_only: **115**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **4.1071**
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** rows=677

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4191 → 0.6156**
- structure_quality: **0.2832 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.4929 → 0.5096**
- trade_floor_gap_after: **-0.0404**
