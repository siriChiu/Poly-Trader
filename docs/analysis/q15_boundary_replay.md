...
- entry_quality: **0.5773** (trade_floor_gap=0.0273)
...
- preexisting_rows_in_replay_bucket: **53**
...
- raw before/after: **0.8363 → 0.8363**
- structure_quality: **0.4865 → 0.4865**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.5773 → 0.5773**
- trade_floor_gap_after: **0.0273**
