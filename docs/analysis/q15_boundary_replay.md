...
- entry_quality: **0.3429** (trade_floor_gap=-0.2071)
...
- raw before/after: **0.3288 → 0.5582**
- structure_quality: **0.272 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.3429 → 0.3624**
- trade_floor_gap_after: **-0.1876**
