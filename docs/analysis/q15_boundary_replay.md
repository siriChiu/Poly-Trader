...
- entry_quality: **0.4738** (trade_floor_gap=-0.0762)
...
## Boundary replay
- legacy bucket rows: **6**
- replay bucket: **CAUTION|base_caution_regime_or_bias|q65**
- replay bucket rows: **0**
- generated_rows_via_boundary_only: **345**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=345)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** rows=444

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4655 → None**
- structure_quality: **0.2357 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4738 → 0.5023**
- trade_floor_gap_after: **-0.0477**
