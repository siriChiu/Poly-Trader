...
- entry_quality: **0.552** (trade_floor_gap=0.002)
...
- generated_rows_via_boundary_only: **118**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=118)
- dominant_neighbor_bucket: **BLOCK|structure_quality_block|q00** rows=90

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.067 → None**
- structure_quality: **0.0284 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.552 → 0.6324**
- trade_floor_gap_after: **0.0824**
