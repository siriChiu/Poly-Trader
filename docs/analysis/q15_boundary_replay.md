...
- entry_quality: **0.3606** (trade_floor_gap=-0.1894)
...
- raw before/after: **0.5762 → 0.5762**
- structure_quality: **0.4162 → 0.4162**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.3606 → 0.3606**
- trade_floor_gap_after: **-0.1894**
