...
- entry_quality: **0.5756** (trade_floor_gap=0.0256)
...
- generated_rows_exceed_replay_scope: **True** (excess=14)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** rows=80

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5277 → None**
- structure_quality: **0.3345 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.5756 → 0.5795**
- trade_floor_gap_after: **0.0295**
