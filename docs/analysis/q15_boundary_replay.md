...
- entry_quality: **0.596** (trade_floor_gap=0.046)
...
- raw before/after: **0.4072 → None**
- structure_quality: **0.1807 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.596 → 0.6383**
- trade_floor_gap_after: **0.0883**
