...
- entry_quality: **0.5591** (trade_floor_gap=0.0091)
...
- raw before/after: **0.6366 → None**
- structure_quality: **0.2823 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5591 → 0.576**
- trade_floor_gap_after: **0.026**
