...
- entry_quality: **0.6337** (trade_floor_gap=0.0837)
...
- generated_rows_exceed_replay_scope: **True** (excess=83)
- dominant_neighbor_bucket: **BLOCK|structure_quality_block|q00** rows=90

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.0125 → None**
- structure_quality: **0.0055 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.6337 → 0.7198**
- trade_floor_gap_after: **0.1698**
