...
- entry_quality: **0.4266** (trade_floor_gap=-0.1234)
- support_route: **exact_bucket_supported**
- floor_cross_legality: **legal_component_experiment_after_support_ready**

## Boundary replay
- legacy bucket rows: **199**
- replay bucket: **BLOCK|bull_high_bias200_overheat_block|q35**
- replay bucket rows: **15**
- generated_rows_via_boundary_only: **0**
- preexisting_rows_in_replay_bucket: **15**
- generated_row_share: **0.0**
- dominant_neighbor_bucket: **BLOCK|bull_high_bias200_overheat_block|q35** rows=158

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.3884 → 0.5022**
- structure_quality: **0.3113 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q35**
- entry_quality: **0.4266 → 0.4363**
- trade_floor_gap_after: **-0.1137**
