...
- entry_quality: **0.662** (trade_floor_gap=0.112)
...
- raw before/after: **0.0035 → None**
- structure_quality: **0.0016 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.662 → 0.7491**
- trade_floor_gap_after: **0.1991**
