...
- entry_quality: **0.619** (trade_floor_gap=0.069)
...
- generated_rows_via_boundary_only: **186**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=186)
...
- entry_quality: **0.619 → 0.7065**
- trade_floor_gap_after: **0.1565**
