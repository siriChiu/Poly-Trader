...
- entry_quality: **0.5653** (trade_floor_gap=0.0153)
...
- raw before/after: **0.6669 → 0.6725**
- structure_quality: **0.3481 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5653 → 0.5658**
- trade_floor_gap_after: **0.0158**
