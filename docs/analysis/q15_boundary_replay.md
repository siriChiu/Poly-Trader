...
- entry_quality: **0.6894** (trade_floor_gap=0.1394)
...
- replay bucket rows: **77**
- generated_rows_via_boundary_only: **2**
- preexisting_rows_in_replay_bucket: **75**
- generated_row_share: **0.026**
...
- raw before/after: **0.4306 → None**
- structure_quality: **0.1925 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6894 → 0.7288**
- trade_floor_gap_after: **0.1788**
