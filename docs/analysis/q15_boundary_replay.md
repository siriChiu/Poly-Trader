...
- entry_quality: **0.5541** (trade_floor_gap=0.0041)
...
- raw before/after: **0.7607 → 0.7607**
- structure_quality: **0.4734 → 0.4734**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5541 → 0.5541**
- trade_floor_gap_after: **0.0041**
