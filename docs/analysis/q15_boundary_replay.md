...
- entry_quality: **0.5696** (trade_floor_gap=0.0196)
...
- replay bucket rows: **8**
- generated_rows_via_boundary_only: **5**
- preexisting_rows_in_replay_bucket: **3**
- generated_row_share: **0.625**
- generated_rows_exceed_replay_scope: **False** (excess=0)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** rows=84

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5394 → None**
- structure_quality: **0.3443 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.5696 → 0.571**
- trade_floor_gap_after: **0.021**
