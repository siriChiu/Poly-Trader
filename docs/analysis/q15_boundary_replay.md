...
- entry_quality: **0.4692** (trade_floor_gap=-0.0808)
...
- raw before/after: **0.7169 → None**
- structure_quality: **0.3699 → 0.3699**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.4692 → 0.4692**
- trade_floor_gap_after: **-0.0808**
