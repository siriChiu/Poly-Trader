...
- entry_quality: **0.4537** (trade_floor_gap=-0.0963)
...
- raw before/after: **0.151 → 0.8639**
- structure_quality: **0.1076 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4537 → 0.5143**
- trade_floor_gap_after: **-0.0357**
