...
- entry_quality: **0.6164** (trade_floor_gap=0.0664)
...
- raw before/after: **0.4768 → None**
- structure_quality: **0.2355 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.6164 → 0.6451**
- trade_floor_gap_after: **0.0951**
