...
- entry_quality: **0.4309** (trade_floor_gap=-0.1191)
...
- raw before/after: **0.9858 → 0.9858**
- structure_quality: **0.6482 → 0.6482**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4309 → 0.4309**
- trade_floor_gap_after: **-0.1191**
