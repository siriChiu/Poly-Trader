...
- entry_quality: **0.5046** (trade_floor_gap=-0.0454)
...
- generated_rows_via_boundary_only: **564**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=564)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q00** rows=370

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.3481 → None**
- structure_quality: **0.1771 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q00**
- entry_quality: **0.5046 → 0.5479**
- trade_floor_gap_after: **-0.0021**
