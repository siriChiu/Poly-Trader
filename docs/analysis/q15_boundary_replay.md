...
- entry_quality: **0.4729** (trade_floor_gap=-0.0771)
...
- raw before/after: **1.0246 → 1.0**
- structure_quality: **0.6635 → 0.6635**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q35**
- entry_quality: **0.4729 → 0.4729**
- trade_floor_gap_after: **-0.0771**
