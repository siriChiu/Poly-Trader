...
- entry_quality: **0.4249** (trade_floor_gap=-0.1251)
...
- raw before/after: **0.6294 → 0.6294**
- structure_quality: **0.3869 → 0.3869**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4249 → 0.4249**
- trade_floor_gap_after: **-0.1251**
