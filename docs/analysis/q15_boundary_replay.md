...
- entry_quality: **0.6637** (trade_floor_gap=0.1137)
...
- generated_rows_via_boundary_only: **76**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.0**
- generated_rows_exceed_replay_scope: **True** (excess=34)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=76

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2642 → None**
- structure_quality: **0.1175 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6637 → 0.7218**
- trade_floor_gap_after: **0.1718**
