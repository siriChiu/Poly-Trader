...
## Boundary replay
- legacy bucket rows: **55**
- replay bucket: **CAUTION|structure_quality_caution|q35**
- replay bucket rows: **50**
- generated_rows_via_boundary_only: **190**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **3.8**
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** rows=676

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2305 → 0.6214**
- structure_quality: **0.2171 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.3715 → 0.4047**
