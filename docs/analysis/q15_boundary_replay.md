...
- entry_quality: **0.5813** (trade_floor_gap=0.0313)
...
- replay bucket rows: **47**
- generated_rows_via_boundary_only: **0**
- preexisting_rows_in_replay_bucket: **47**
...
- raw before/after: **0.9551 → 0.9551**
- structure_quality: **0.5512 → 0.5512**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.5813 → 0.5814**
- trade_floor_gap_after: **0.0314**
