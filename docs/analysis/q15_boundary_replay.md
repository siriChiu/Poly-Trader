...
- entry_quality: **0.4073** (trade_floor_gap=-0.1427)
...
- raw before/after: **0.4415 → 0.4874**
- structure_quality: **0.3344 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4073 → 0.4112**
- trade_floor_gap_after: **-0.1388**
