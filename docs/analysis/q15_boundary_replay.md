...
- entry_quality: **0.5126** (trade_floor_gap=-0.0374)
...
- generated_rows_exceed_replay_scope: **True** (excess=84)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** rows=484

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5382 → None**
- structure_quality: **0.3071 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5126 → 0.5233**
- trade_floor_gap_after: **-0.0267**
