...
- entry_quality: **0.3381** (trade_floor_gap=-0.2119)
...
- raw before/after: **0.2826 → 0.6129**
- structure_quality: **0.2377 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.3381 → 0.3661**
- trade_floor_gap_after: **-0.1839**
