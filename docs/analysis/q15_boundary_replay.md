...
- entry_quality: **0.4904** (trade_floor_gap=-0.0596)
...
- generated_rows_via_boundary_only: **140**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **2.6415**
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** rows=702

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.3956 → 0.6562**
- structure_quality: **0.2614 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.4904 → 0.5126**
- trade_floor_gap_after: **-0.0374**
