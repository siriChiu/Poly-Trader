...
- entry_quality: **0.3213** (trade_floor_gap=-0.2287)
...
- raw before/after: **0.273 → 0.6195**
- structure_quality: **0.2322 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.3213 → 0.3508**
- trade_floor_gap_after: **-0.1992**
