...
- entry_quality: **0.5609** (trade_floor_gap=0.0109)
...
- raw before/after: **0.7352 → 0.7352**
- structure_quality: **0.4586 → 0.4586**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5609 → 0.5609**
- trade_floor_gap_after: **0.0109**
