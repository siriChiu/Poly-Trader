...
- entry_quality: **0.5284** (trade_floor_gap=-0.0216)
...
- raw before/after: **-0.0324 → None**
- structure_quality: **0.0146 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5284 → 0.6122**
- trade_floor_gap_after: **0.0622**
