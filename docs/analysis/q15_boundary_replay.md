...
- entry_quality: **0.6958** (trade_floor_gap=0.1458)
...
- raw before/after: **0.2595 → None**
- structure_quality: **0.1149 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.6958 → 0.7545**
- trade_floor_gap_after: **0.2045**
