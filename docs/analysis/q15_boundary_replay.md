...
- entry_quality: **0.3285** (trade_floor_gap=-0.2215)
...
- raw before/after: **0.4314 → 0.5926**
- structure_quality: **0.2952 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.3285 → 0.3422**
- trade_floor_gap_after: **-0.2078**
