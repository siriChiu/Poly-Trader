...
- entry_quality: **0.668** (trade_floor_gap=0.118)
...
- generated_rows_via_boundary_only: **102**
...
- raw before/after: **0.3446 → None**
- structure_quality: **0.1541 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.668 → 0.7171**
- trade_floor_gap_after: **0.1671**
