...
- entry_quality: **0.3234** (trade_floor_gap=-0.2266)
...
- replay bucket rows: **120**
- generated_rows_via_boundary_only: **0**
- preexisting_rows_in_replay_bucket: **120**
- generated_row_share: **0.0**
- dominant_neighbor_bucket: **BLOCK|bull_high_bias200_overheat_block|q35** rows=127

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4015 → 0.578**
- structure_quality: **0.29 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q35**
- entry_quality: **0.3234 → 0.3384**
- trade_floor_gap_after: **-0.2116**
