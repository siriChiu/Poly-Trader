...
- entry_quality: **0.4879** (trade_floor_gap=-0.0621)
...
- raw before/after: **0.6484 → None**
- structure_quality: **0.4057 → 0.4057**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.4879 → 0.4879**
- trade_floor_gap_after: **-0.0621**
