...
- entry_quality: **0.4248** (trade_floor_gap=-0.1252)
...
- raw before/after: **0.9467 → 0.9467**
- structure_quality: **0.5955 → 0.5955**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4248 → 0.4248**
- trade_floor_gap_after: **-0.1252**
