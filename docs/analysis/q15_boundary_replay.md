...
- entry_quality: **0.6551** (trade_floor_gap=0.1051)
...
- raw before/after: **0.5229 → None**
- structure_quality: **0.2574 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.6551 → 0.6783**
- trade_floor_gap_after: **0.1283**
