...
- entry_quality: **0.4775** (trade_floor_gap=-0.0725)
...
- raw before/after: **0.5263 → None**
- structure_quality: **0.3373 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q00**
- entry_quality: **0.4775 → 0.4807**
- trade_floor_gap_after: **-0.0693**
