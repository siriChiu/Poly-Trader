...
- entry_quality: **0.4605** (trade_floor_gap=-0.0895)
...
- raw before/after: **1.2075 → 1.0**
- structure_quality: **0.6889 → 0.6889**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q35**
- entry_quality: **0.4605 → 0.4605**
- trade_floor_gap_after: **-0.0895**
