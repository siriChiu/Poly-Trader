...
- entry_quality: **0.5559** (trade_floor_gap=0.0059)
...
- raw before/after: **0.6704 → 0.6704**
- structure_quality: **0.4146 → 0.4146**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5559 → 0.5559**
- trade_floor_gap_after: **0.0059**
