...
- entry_quality: **0.3283** (trade_floor_gap=-0.2217)
...
- raw before/after: **0.4098 → 0.4845**
- structure_quality: **0.3246 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.3283 → 0.3346**
- trade_floor_gap_after: **-0.2154**
