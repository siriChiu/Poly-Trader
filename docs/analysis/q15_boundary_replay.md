...
- entry_quality: **0.3419** (trade_floor_gap=-0.2081)
...
- raw before/after: **0.4833 → 0.5554**
- structure_quality: **0.3255 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.3419 → 0.348**
- trade_floor_gap_after: **-0.202**
