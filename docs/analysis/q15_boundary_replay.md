...
- entry_quality: **0.4951** (trade_floor_gap=-0.0549)
...
- generated_rows_via_boundary_only: **85**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.5741**
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** rows=703

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4942 → 0.5821**
- structure_quality: **0.3201 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.4951 → 0.5026**
- trade_floor_gap_after: **-0.0474**
