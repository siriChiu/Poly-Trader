...
- entry_quality: **0.5826** (trade_floor_gap=0.0326)
...
- raw before/after: **0.6204 → 0.6204**
- structure_quality: **0.3819 → 0.3819**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5826 → 0.5826**
- trade_floor_gap_after: **0.0326**
