...
- entry_quality: **0.497** (trade_floor_gap=-0.053)
...
- generated_rows_via_boundary_only: **116**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **9.6667**
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** rows=661

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4203 → 0.6182**
- structure_quality: **0.2827 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.497 → 0.5139**
- trade_floor_gap_after: **-0.0361**
