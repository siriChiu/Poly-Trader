...
- entry_quality: **0.5596** (trade_floor_gap=0.0096)
...
- raw before/after: **0.658 → None**
- structure_quality: **0.3283 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5596 → 0.565**
- trade_floor_gap_after: **0.015**
