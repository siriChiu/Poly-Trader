...
- entry_quality: **0.5367** (trade_floor_gap=-0.0133)
...
- replay bucket rows: **353**
- generated_rows_via_boundary_only: **863**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.0**
- generated_rows_exceed_replay_scope: **True** (excess=510)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q15** rows=639

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.1422 → None**
- structure_quality: **0.0618 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.5367 → 0.6088**
- trade_floor_gap_after: **0.0588**
