...
- entry_quality: **0.5651** (trade_floor_gap=0.0151)
...
- raw before/after: **0.765 → 0.765**
- structure_quality: **0.4482 → 0.4482**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.5651 → 0.5651**
