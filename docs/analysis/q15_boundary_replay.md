...
- entry_quality: **0.5686** (trade_floor_gap=0.0186)
...
- raw before/after: **0.6233 → None**
- structure_quality: **0.3885 → 0.3885**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.5686 → 0.5686**
- trade_floor_gap_after: **0.0186**
