...
- entry_quality: **0.5434** (trade_floor_gap=-0.0066)
...
- raw before/after: **0.6259 → 0.6327**
- structure_quality: **0.3477 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5434 → 0.544**
- trade_floor_gap_after: **-0.006**
