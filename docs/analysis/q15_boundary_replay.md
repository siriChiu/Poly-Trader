...
- entry_quality: **0.3003** (trade_floor_gap=-0.2497)
...
- raw before/after: **0.5986 → 0.5986**
- structure_quality: **0.4351 → 0.4351**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.3003 → 0.3003**
- trade_floor_gap_after: **-0.2497**
