...
- entry_quality: **0.5048** (trade_floor_gap=-0.0452)
...
- generated_rows_via_boundary_only: **43**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- generated_rows_exceed_replay_scope: **True** (excess=43)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=37

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.1494 → None**
- structure_quality: **0.0716 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.5048 → 0.5744**
- trade_floor_gap_after: **0.0244**
