...
- entry_quality: **0.5711** (trade_floor_gap=0.0211)
...
- replay bucket rows: **50**
- generated_rows_via_boundary_only: **33**
- preexisting_rows_in_replay_bucket: **17**
- generated_row_share: **0.66**
- generated_rows_exceed_replay_scope: **False** (excess=0)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** rows=67

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5506 → None**
- structure_quality: **0.3115 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.5711 → 0.5807**
- trade_floor_gap_after: **0.0307**
