...
- entry_quality: **0.5466** (trade_floor_gap=-0.0034)
...
- raw before/after: **0.2837 → None**
- structure_quality: **0.1203 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5466 → 0.604**
- trade_floor_gap_after: **0.054**
