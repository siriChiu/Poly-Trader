...
- entry_quality: **0.6232** (trade_floor_gap=0.0732)
...
- generated_rows_via_boundary_only: **62**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.0**
- generated_rows_exceed_replay_scope: **True** (excess=26)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=62

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.1439 → 0.9845**
- structure_quality: **0.0642 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6232 → 0.6946**
- trade_floor_gap_after: **0.1446**
