...
- entry_quality: **0.4262** (trade_floor_gap=-0.1238)
...
- raw before/after: **0.8679 → 0.8679**
- structure_quality: **0.5485 → 0.5485**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4262 → 0.4262**
- trade_floor_gap_after: **-0.1238**
