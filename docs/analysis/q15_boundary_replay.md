...
- entry_quality: **0.4294** (trade_floor_gap=-0.1206)
...
- raw before/after: **1.0696 → 1.0**
- structure_quality: **0.6428 → 0.6428**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4294 → 0.4294**
- trade_floor_gap_after: **-0.1206**
