...
- entry_quality: **0.6241** (trade_floor_gap=0.0741)
...
- raw before/after: **0.5316 → None**
- structure_quality: **0.264 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.6241 → 0.6456**
- trade_floor_gap_after: **0.0956**
