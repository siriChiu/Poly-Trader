...
- entry_quality: **0.512** (trade_floor_gap=-0.038)
...
- raw before/after: **0.7662 → None**
- structure_quality: **0.4305 → 0.4305**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.512 → 0.512**
- trade_floor_gap_after: **-0.038**
