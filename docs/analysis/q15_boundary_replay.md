...
- entry_quality: **0.4615** (trade_floor_gap=-0.0885)
...
- raw before/after: **0.3658 → 0.5349**
- structure_quality: **0.2925 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4615 → 0.4758**
- trade_floor_gap_after: **-0.0742**
