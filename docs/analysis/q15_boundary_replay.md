...
- entry_quality: **0.431** (trade_floor_gap=-0.119)
...
- raw before/after: **0.4724 → 0.6553**
- structure_quality: **0.2878 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.431 → 0.4466**
- trade_floor_gap_after: **-0.1034**
