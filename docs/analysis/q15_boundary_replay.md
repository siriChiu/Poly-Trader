...
- entry_quality: **0.6239** (trade_floor_gap=0.0739)
...
- raw before/after: **0.7425 → 0.7425**
- structure_quality: **0.3854 → 0.3854**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.6239 → 0.6239**
- trade_floor_gap_after: **0.0739**
