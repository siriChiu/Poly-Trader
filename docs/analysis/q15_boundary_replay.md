...
- reason: q15 root-cause verdict=current_bucket_exact_support_already_closed，不是 boundary_sensitivity_candidate；boundary replay 本輪不適用，舊 boundary counterfactual 不可當 current truth。
...
- raw before/after: **0.9546 → None**
- structure_quality: **0.5313 → 0.5313**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4838 → 0.4838**
- trade_floor_gap_after: **-0.0662**
