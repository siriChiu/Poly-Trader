...
- entry_quality: **0.5839** (trade_floor_gap=0.0339)
- support_route: **exact_bucket_present_but_below_minimum**
- floor_cross_legality: **floor_crossed_but_support_not_ready**

## Boundary replay
- legacy bucket rows: **25**
- replay bucket: **CAUTION|base_caution_regime_or_bias|q35**
- replay bucket rows: **54**
- generated_rows_via_boundary_only: **17**
- preexisting_rows_in_replay_bucket: **37**
- generated_row_share: **0.3148**
- generated_rows_exceed_replay_scope: **False** (excess=0)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** rows=70

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5711 → None**
- structure_quality: **0.3225 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.5839 → 0.5907**
- trade_floor_gap_after: **0.0407**
