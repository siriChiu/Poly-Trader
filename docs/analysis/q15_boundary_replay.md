...
- entry_quality: **0.5138** (trade_floor_gap=-0.0362)
...
- raw before/after: **0.4 → 0.7003**
- structure_quality: **0.2479 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5138 → 0.5394**
- trade_floor_gap_after: **-0.0106**
