...
- entry_quality: **0.4539** (trade_floor_gap=-0.0961)
...
- raw before/after: **0.7127 → None**
- structure_quality: **0.4604 → 0.4604**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4539 → 0.4539**
- trade_floor_gap_after: **-0.0961**
