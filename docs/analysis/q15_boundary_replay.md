...
- entry_quality: **0.4459** (trade_floor_gap=-0.1041)
...
- replay bucket rows: **48**
- generated_rows_via_boundary_only: **119**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **2.4792**
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q35** rows=697

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4276 → 0.6323**
- structure_quality: **0.2804 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.4459 → 0.4633**
- trade_floor_gap_after: **-0.0867**
