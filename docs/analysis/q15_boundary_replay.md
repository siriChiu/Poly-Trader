...
- entry_quality: **0.5361** (trade_floor_gap=-0.0139)
...
- raw before/after: **0.8741 → 0.8741**
- structure_quality: **0.4938 → 0.4938**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.5361 → 0.5362**
- trade_floor_gap_after: **-0.0138**
