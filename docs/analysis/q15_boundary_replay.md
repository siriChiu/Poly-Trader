...
- entry_quality: **0.6935** (trade_floor_gap=0.1435)
...
- preexisting_rows_in_replay_bucket: **51**
- generated_row_share: **0.0377**
- generated_rows_exceed_replay_scope: **False** (excess=0)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=2

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2374 → None**
- structure_quality: **0.1057 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6935 → 0.7545**
