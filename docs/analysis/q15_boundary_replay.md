...
- entry_quality: **0.3233** (trade_floor_gap=-0.2267)
...
- generated_rows_via_boundary_only: **237**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.0**
- generated_rows_exceed_replay_scope: **True** (excess=236)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q65** rows=578

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4715 → None**
- structure_quality: **0.2487 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.3233 → 0.3486**
- trade_floor_gap_after: **-0.2014**
