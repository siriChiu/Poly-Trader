...
- entry_quality: **0.4833** (trade_floor_gap=-0.0667)
...
- generated_rows_via_boundary_only: **257**
...
- raw before/after: **0.2163 → 0.7313**
- structure_quality: **0.1749 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4833 → 0.527**
- trade_floor_gap_after: **-0.023**
