...
- entry_quality: **0.4178** (trade_floor_gap=-0.1322)
...
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=218

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.5381 → 0.5381**
- structure_quality: **0.3565 → 0.3565**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.4178 → 0.4179**
- trade_floor_gap_after: **-0.1321**
