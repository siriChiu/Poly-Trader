...
- reason: q15 root-cause verdict=insufficient_scope_data，不是 boundary_sensitivity_candidate；boundary replay 本輪不適用，舊 boundary counterfactual 不可當 current truth。
...
- entry_quality: **0.6477** (trade_floor_gap=0.0977)
...
- generated_rows_via_boundary_only: **20**
...
- raw before/after: **0.4676 → None**
- structure_quality: **0.2293 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.6477 → 0.6779**
- trade_floor_gap_after: **0.1279**
