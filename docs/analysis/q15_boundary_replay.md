...
- entry_quality: **0.5687** (trade_floor_gap=0.0187)
...
- generated_rows_via_boundary_only: **4**
...
- raw before/after: **0.5807 → None**
- structure_quality: **0.2508 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5687 → 0.5935**
- trade_floor_gap_after: **0.0435**
