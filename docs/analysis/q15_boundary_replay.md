...
- entry_quality: **0.3537** (trade_floor_gap=-0.1963)
...
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=182

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.6079 → 0.6079**
- structure_quality: **0.3958 → 0.3958**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.3537 → 0.3537**
- trade_floor_gap_after: **-0.1963**
