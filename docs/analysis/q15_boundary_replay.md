...
- entry_quality: **0.5978** (trade_floor_gap=0.0478)
...
- raw before/after: **0.7911 → 0.7911**
- structure_quality: **0.4327 → 0.4327**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5978 → 0.5978**
- trade_floor_gap_after: **0.0478**
