...
- entry_quality: **0.4232** (trade_floor_gap=-0.1268)
...
- raw before/after: **0.8557 → 0.8557**
- structure_quality: **0.5414 → 0.5414**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4232 → 0.4232**
- trade_floor_gap_after: **-0.1268**
