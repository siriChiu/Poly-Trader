...
- replay bucket rows: **44**
- generated_rows_via_boundary_only: **246**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.0**
- generated_rows_exceed_replay_scope: **True** (excess=202)
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q15** rows=122

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2437 → None**
- structure_quality: **0.1097 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.5643 → 0.6244**
- trade_floor_gap_after: **0.0744**
