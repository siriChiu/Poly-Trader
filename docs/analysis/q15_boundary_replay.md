...
- entry_quality: **0.4337** (trade_floor_gap=-0.1163)
...
- generated_rows_via_boundary_only: **193**
...
- raw before/after: **0.3288 → 0.7538**
- structure_quality: **0.2055 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4337 → 0.4698**
- trade_floor_gap_after: **-0.0802**
