...
- entry_quality: **0.5831** (trade_floor_gap=0.0331)
...
- generated_rows_exceed_replay_scope: **True** (excess=140)
- dominant_neighbor_bucket: **BLOCK|structure_quality_block|q00** rows=90

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.0389 → None**
- structure_quality: **0.0166 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5831 → 0.6665**
