...
- entry_quality: **0.6878** (trade_floor_gap=0.1378)
...
- raw before/after: **0.5575 → None**
- structure_quality: **0.277 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.6878 → 0.7061**
- trade_floor_gap_after: **0.1561**
