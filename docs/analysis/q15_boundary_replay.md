...
- entry_quality: **0.4323** (trade_floor_gap=-0.1177)
...
- raw before/after: **0.4875 → 0.4875**
- structure_quality: **0.3645 → 0.3645**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.4323 → 0.4322**
- trade_floor_gap_after: **-0.1178**
