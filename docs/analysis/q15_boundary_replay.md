...
- entry_quality: **0.3918** (trade_floor_gap=-0.1582)
...
- raw before/after: **1.1712 → 1.0**
- structure_quality: **0.6934 → 0.6934**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q35**
- entry_quality: **0.3918 → 0.3918**
- trade_floor_gap_after: **-0.1582**
