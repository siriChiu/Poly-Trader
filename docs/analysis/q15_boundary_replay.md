...
- entry_quality: **0.6783** (trade_floor_gap=0.1283)
...
- generated_rows_exceed_replay_scope: **True** (excess=82)
- dominant_neighbor_bucket: **BLOCK|structure_quality_block|q00** rows=90

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.0138 → None**
- structure_quality: **0.0062 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.6783 → 0.7643**
- trade_floor_gap_after: **0.2143**
