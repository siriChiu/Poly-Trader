...
- entry_quality: **0.6449** (trade_floor_gap=0.0949)
...
- preexisting_rows_in_replay_bucket: **65**
- generated_row_share: **0.0441**
...
- raw before/after: **0.5739 → None**
- structure_quality: **0.2961 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.6449 → 0.6584**
- trade_floor_gap_after: **0.1084**
