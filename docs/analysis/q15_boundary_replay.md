...
- entry_quality: **0.5617** (trade_floor_gap=0.0117)
...
- raw before/after: **0.7137 → None**
- structure_quality: **0.3215 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q35**
- entry_quality: **0.5617 → 0.5689**
- trade_floor_gap_after: **0.0189**
