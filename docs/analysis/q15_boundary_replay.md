...
- preexisting_rows_in_replay_bucket: **44**
...
- raw before/after: **0.603 → 0.603**
- structure_quality: **0.3741 → 0.3741**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q15**
- entry_quality: **0.5703 → 0.5703**
- trade_floor_gap_after: **0.0203**
