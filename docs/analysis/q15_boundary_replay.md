...
- entry_quality: **0.478** (trade_floor_gap=-0.072)
...
- generated_rows_via_boundary_only: **240**
...
- raw before/after: **0.2447 → 0.7947**
- structure_quality: **0.163 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.478 → 0.5247**
- trade_floor_gap_after: **-0.0253**
