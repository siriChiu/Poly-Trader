...
- entry_quality: **0.5178** (trade_floor_gap=-0.0322)
...
- generated_rows_via_boundary_only: **292**
...
- raw before/after: **0.2127 → 0.8395**
- structure_quality: **0.1369 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.5178 → 0.5711**
