...
- entry_quality: **0.5502** (trade_floor_gap=0.0002)
...
- raw before/after: **0.7132 → 0.7132**
- structure_quality: **0.3992 → 0.3992**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.5502 → 0.5502**
- trade_floor_gap_after: **0.0002**
