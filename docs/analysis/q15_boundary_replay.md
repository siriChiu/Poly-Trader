...
- entry_quality: **0.5778** (trade_floor_gap=0.0278)
...
- raw before/after: **0.2181 → None**
- structure_quality: **0.1136 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5778 → 0.637**
- trade_floor_gap_after: **0.087**
