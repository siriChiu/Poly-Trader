...
- entry_quality: **0.5607** (trade_floor_gap=0.0107)
...
- raw before/after: **0.1533 → None**
- structure_quality: **0.0666 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q85**
- entry_quality: **0.5607 → 0.6316**
- trade_floor_gap_after: **0.0816**
