...
- entry_quality: **0.3784** (trade_floor_gap=-0.1716)
...
- generated_rows_via_boundary_only: **87**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **None**
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q35** rows=1142

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.337 → 0.6223**
- structure_quality: **0.253 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.3784 → 0.4027**
- trade_floor_gap_after: **-0.1473**
