...
- entry_quality: **0.4381** (trade_floor_gap=-0.1119)
...
- generated_rows_via_boundary_only: **160**
...
- raw before/after: **0.2921 → 0.6789**
- structure_quality: **0.2185 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4381 → 0.471**
- trade_floor_gap_after: **-0.079**
