...
- entry_quality: **0.5859** (trade_floor_gap=0.0359)
...
- dominant_neighbor_bucket: **CAUTION|base_caution_regime_or_bias|q85** rows=228

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.9162 → None**
- structure_quality: **0.5046 → 0.5046**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q85**
- entry_quality: **0.5859 → 0.5859**
- trade_floor_gap_after: **0.0359**
