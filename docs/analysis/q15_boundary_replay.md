...
- entry_quality: **0.3881** (trade_floor_gap=-0.1619)
...
- raw before/after: **0.5023 → 0.5023**
- structure_quality: **0.3738 → 0.3738**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.3881 → 0.3881**
- trade_floor_gap_after: **-0.1619**
