...
- entry_quality: **0.616** (trade_floor_gap=0.066)
...
- replay bucket rows: **37**
- generated_rows_via_boundary_only: **64**
- preexisting_rows_in_replay_bucket: **0**
- generated_row_share: **1.0**
- generated_rows_exceed_replay_scope: **True** (excess=27)
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=64

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.1844 → None**
- structure_quality: **0.0822 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.616 → 0.6829**
- trade_floor_gap_after: **0.1329**
