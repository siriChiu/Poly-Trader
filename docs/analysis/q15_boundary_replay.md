...
- entry_quality: **0.5221** (trade_floor_gap=-0.0279)
...
- raw before/after: **0.6965 → None**
- structure_quality: **0.3084 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5221 → 0.5326**
- trade_floor_gap_after: **-0.0174**
