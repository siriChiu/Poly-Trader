...
- entry_quality: **0.4043** (trade_floor_gap=-0.1457)
...
- replay bucket rows: **119**
- generated_rows_via_boundary_only: **0**
- preexisting_rows_in_replay_bucket: **119**
- generated_row_share: **0.0**
- dominant_neighbor_bucket: **BLOCK|bull_high_bias200_overheat_block|q35** rows=126

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.2862 → 0.6336**
- structure_quality: **0.2319 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q35**
- entry_quality: **0.4043 → 0.4338**
- trade_floor_gap_after: **-0.1162**
