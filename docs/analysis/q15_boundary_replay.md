...
- entry_quality: **0.5968** (trade_floor_gap=0.0468)
...
- dominant_neighbor_bucket: **CAUTION|structure_quality_caution|q15** rows=83

## feat_4h_bb_pct_b minimal counterfactual
- raw before/after: **0.4775 → None**
- structure_quality: **0.2127 → 0.35**
- bucket_after: **CAUTION|structure_quality_caution|q15**
- entry_quality: **0.5968 → 0.6311**
- trade_floor_gap_after: **0.0811**
