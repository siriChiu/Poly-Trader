...
- entry_quality: **0.4388** (trade_floor_gap=-0.1112)
...
- generated_rows_via_boundary_only: **145**
...
- raw before/after: **0.2836 → 0.6586**
- structure_quality: **0.2225 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4388 → 0.4707**
- trade_floor_gap_after: **-0.0793**
