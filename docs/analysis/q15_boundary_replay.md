...
- entry_quality: **0.4408** (trade_floor_gap=-0.1092)
...
- raw before/after: **0.7154 → None**
- structure_quality: **0.4618 → 0.4618**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.4408 → 0.4408**
- trade_floor_gap_after: **-0.1092**
