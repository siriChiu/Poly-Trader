...
- entry_quality: **0.6383** (trade_floor_gap=0.0883)
...
- raw before/after: **0.5324 → None**
- structure_quality: **0.3023 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q65**
- entry_quality: **0.6383 → 0.6502**
- trade_floor_gap_after: **0.1002**
