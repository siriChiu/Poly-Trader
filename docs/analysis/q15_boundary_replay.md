...
- entry_quality: **0.3082** (trade_floor_gap=-0.2418)
...
- raw before/after: **0.4177 → 0.4895**
- structure_quality: **0.3256 → 0.35**
- bucket_after: **BLOCK|bull_high_bias200_overheat_block|q65**
- entry_quality: **0.3082 → 0.3143**
- trade_floor_gap_after: **-0.2357**
