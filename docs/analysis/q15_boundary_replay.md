...
- entry_quality: **0.4119** (trade_floor_gap=-0.1381)
...
- generated_rows_via_boundary_only: **245**
...
- raw before/after: **0.2232 → 0.6764**
- structure_quality: **0.1959 → 0.35**
- bucket_after: **CAUTION|base_caution_regime_or_bias|q35**
- entry_quality: **0.4119 → 0.4504**
- trade_floor_gap_after: **-0.0996**
