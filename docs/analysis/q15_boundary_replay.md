...
- entry_quality: **0.5407** (trade_floor_gap=-0.0093)
...
- replay bucket rows: **2**
- generated_rows_via_boundary_only: **0**
- preexisting_rows_in_replay_bucket: **2**
...
- raw before/after: **0.2793 → None**
- structure_quality: **0.1371 → 0.35**
- bucket_after: **BLOCK|structure_quality_block|q00**
- entry_quality: **0.5407 → 0.5939**
- trade_floor_gap_after: **0.0439**
