...
- generated_at: `2026-05-24T05:16:16.978911+00:00`
- source live probe generated_at: `2026-05-24T05:16:12.078082Z`
- source q15 audit generated_at: `2026-05-24 05:15:34.247564`
...
- current exact identity rows before bucket filter: **61** (non-current-bucket: **59**; reference only, not deployment support)
- gap_to_minimum: **48**
...
- joined labeled rows: **24809**
- current calibration window filled: **True**
- features_normalized: count=25239, range=`2024-04-14 07:00:00.000000` → `2026-05-24 05:15:34.247564`
- labels: count=68004, range=`2024-04-14 07:00:00.000000` → `2026-05-24 02:13:59.514353`
- raw_market_data: count=34278, range=`2024-04-13 22:00:00.000000` → `2026-05-24 05:15:34.247564`
...
| --- | ---: | ---: | --- | --- | --- | --- |
| 100 | 11 | 0 | reference_only_calibration_window_mismatch | False | None | win=None, pnl=None, quality=None |
| 200 | 61 | 2 | current_support_identity | False | 2026-05-21 09:15:55.081165 | win=0.0, pnl=-0.0088, quality=-0.2618 |
...
| 5000 | 386 | 78 | reference_only_calibration_window_mismatch | False | 2026-05-21 09:15:55.081165 | win=0.2692, pnl=-0.0028, quality=-0.0026 |
