...
- generated_at: `2026-05-21T22:11:56.418537+00:00`
- source live probe generated_at: `2026-05-21T22:11:52.822198Z`
- source q15 audit generated_at: `2026-05-21 22:11:14.044039`
...
- joined labeled rows: **24563**
- current calibration window filled: **True**
- features_normalized: count=24993, range=`2024-04-14 07:00:00.000000` → `2026-05-21 22:11:14.044039`
- labels: count=67516, range=`2024-04-14 07:00:00.000000` → `2026-05-21 19:11:08.954723`
- raw_market_data: count=33980, range=`2024-04-13 22:00:00.000000` → `2026-05-21 22:11:14.044039`
...
- engineering_next_gate: exact current support rows 21/50 must reach minimum; gap=29; reference rows stay non-deployable until identity is deliberately rebaselined and reverified
...
| --- | ---: | ---: | --- | --- | --- | --- |
| 100 | 63 | 21 | reference_only_calibration_window_mismatch | False | 2026-05-20 23:04:52.364671 | win=0.7143, pnl=0.0023, quality=0.3084 |
| 200 | 63 | 21 | current_support_identity | False | 2026-05-20 23:04:52.364671 | win=0.7143, pnl=0.0023, quality=0.3084 |
| 600 | 90 | 23 | reference_only_calibration_window_mismatch | False | 2026-05-20 23:04:52.364671 | win=0.6957, pnl=0.0019, quality=0.2861 |
| 1000 | 156 | 23 | reference_only_calibration_window_mismatch | False | 2026-05-20 23:04:52.364671 | win=0.6957, pnl=0.0019, quality=0.2861 |
| 5000 | 302 | 70 | reference_only_calibration_window_mismatch | False | 2026-05-20 23:04:52.364671 | win=0.9, pnl=0.0135, quality=0.5151 |
| all | 1392 | 313 | reference_only_calibration_window_mismatch | False | 2026-05-20 23:04:52.364671 | win=0.9553, pnl=0.0202, quality=0.6154 |

## Recommended actions

- **keep_deployment_fail_closed** (P0): 維持 deployable=false / allowed_layers=0；current support identity exact rows 21/50，未達門檻前 reference windows 不可直接算作 deployment support。
