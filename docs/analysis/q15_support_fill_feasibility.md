...
- generated_at: `2026-05-22T09:21:28.712023+00:00`
- source live probe generated_at: `2026-05-22T09:21:12.700785Z`
- source q15 audit generated_at: `2026-05-22 09:20:57.889317`
...
- joined labeled rows: **24615**
- current calibration window filled: **True**
- features_normalized: count=25046, range=`2024-04-14 07:00:00.000000` → `2026-05-22 09:20:57.889317`
- labels: count=67620, range=`2024-04-14 07:00:00.000000` → `2026-05-22 06:15:25.893720`
- raw_market_data: count=34044, range=`2024-04-13 22:00:00.000000` → `2026-05-22 09:20:57.889317`
...
- engineering_next_gate: exact current support rows 66/50 already meet minimum; keep deployable=false until circuit breaker, Top-K deployability, and venue/execution gates pass; reference rows stay non-deployable unless identity is deliberately rebaselined and reverified
...
| 200 | 71 | 66 | current_support_identity | True | 2026-05-20 06:10:25.311341 | win=1.0, pnl=0.0093, quality=0.5361 |
...
- **keep_deployment_fail_closed** (P0): 維持 deployable=false / allowed_layers=0；current support identity exact rows 66/50 已達門檻，但 support gate 不是 deployment closure；reference windows 仍不可直接算作額外 deployment support。
