...
- generated_at: `2026-05-25T18:16:42.160198Z`
...
- `recent_window_no_new_risk_falsification`: status=`shadow_only_no_new_risk_falsification`, deployable=`False`, live_exposure_allowed=`False`, best_gate=`dominant_regime_shadow_gate`, kept=`21`, kept_win_rate=`0.8571`, loss_capture=`0.7`
...
## Next gate
circuit_breaker release_ready=True，current exact support rows 26/50 必須補齊；同時 Top-K deployable_rows>0、venue runtime lifecycle proof complete，才允許最小 canary review。
