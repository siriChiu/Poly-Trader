...
- generated_at: `2026-05-22T05:08:52.004474Z`
...
## Next gate
current exact support rows 2/50 必須補齊；同時 Top-K deployable_rows>0、venue runtime lifecycle proof complete，才允許最小 canary review。
