...
- generated_at: `2026-05-25T21:11:29.785695Z`
...
- `recent_window_no_new_risk_falsification`: status=`shadow_only_no_new_risk_falsification`, deployable=`False`, live_exposure_allowed=`False`, best_gate=`dominant_regime_shadow_gate`, kept=`83`, kept_win_rate=`0.9759`, loss_capture=`0.6`
