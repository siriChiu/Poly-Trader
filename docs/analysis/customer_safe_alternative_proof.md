...
- generated_at: `2026-05-26T01:14:43.999901Z`
...
- circuit_breaker_release_ready: `True` (wins `44/15`, gap `0`)
...
- `recent_window_no_new_risk_falsification`: status=`shadow_only_no_new_risk_falsification`, deployable=`False`, live_exposure_allowed=`False`, best_gate=`observable_4h_shift_shadow_gate`, kept=`69`, kept_win_rate=`1.0`, loss_capture=`1.0`
