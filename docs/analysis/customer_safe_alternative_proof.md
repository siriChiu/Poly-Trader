...
- generated_at: `2026-05-26T23:19:28.137401Z`
...
- `recent_window_no_new_risk_falsification`: status=`shadow_only_no_new_risk_falsification`, deployable=`False`, live_exposure_allowed=`False`, best_gate=`observable_4h_shift_shadow_gate`, kept=`25`, kept_win_rate=`0.4`, loss_capture=`0.8333`
