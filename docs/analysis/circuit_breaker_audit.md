# Circuit Breaker Audit（Heartbeat #1442）
_generated_at: 2026-05-22T17:09:26.985633Z_

## 結論
- verdict: **mixed_horizon_false_positive**
- summary: 混合 horizon breaker 會被 240m tail labels 觸發（streak=16，recent50 win_rate=0.2200），但 1440m canonical live horizon 目前 release-ready。
...
- aligned_scope_now: streak=11, win_rate=0.48
