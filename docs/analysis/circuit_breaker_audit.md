# Circuit Breaker Audit（Heartbeat #1259）

## 結論
- verdict: **mixed_horizon_false_positive**
- summary: 混合 horizon breaker 會被 240m tail labels 觸發（streak=3，recent50 win_rate=0.2600），但 1440m canonical live horizon 目前 release-ready。
...
- aligned_scope_now: streak=20, win_rate=0.6
- additional recent-window wins needed: 0
- tail pathology: losses=20 / wins=30 / loss_share=0.4