...
- feature_timestamp: **2026-04-24 01:50:14.374702**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.5433**
- layers: **0 → 0**
...
- final entry_quality: **0.391** / trade_floor **0.55** / gap **-0.159**
- base_quality: **0.3786** × weight **0.75**
- structure_quality: **0.4283** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.392 (w=0.18, contrib=0.0706), feat_pulse=0.5955 (w=0.27, contrib=0.1608), feat_ear=0.9815 (w=0.15, contrib=0.1472)
- structure components: feat_4h_bb_pct_b=0.597 (w=0.34, contrib=0.203), feat_4h_dist_bb_lower=0.2319 (w=0.33, contrib=0.0765), feat_4h_dist_swing_low=0.4509 (w=0.33, contrib=0.1488)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.159**
- base_group_max_entry_gain: **0.4661** | structure_group_max_entry_gain: **0.143**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.53, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.53)
- bias50 fully relaxed: entry≈**0.691** / layers≈**0** / required_bias50_cap≈**-0.25**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 495 | 0.5515 | 0.1817 | 0.2786 | 0.6694 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 495 | 0.5515 | 0.1817 | 0.2786 | 0.6694 | 0 | False |
