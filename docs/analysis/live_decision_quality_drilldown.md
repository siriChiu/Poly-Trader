...
- feature_timestamp: **2026-05-16 03:30:19.086310**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 20.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 10/50，至少還差 5 勝。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，27 筆 / 勝率 50.0% / 品質 0.197，明顯劣於 精準即時路徑 勝率 100.0% / 品質 0.726。**
...
- 建議修補特徵: None
- 建議修補說明: 精準樣本 8/50（缺口 42） 未達目前即時精準樣本門檻；較寬範圍或近似樣本只可作治理參考。
...
- 基礎品質: **0.7161** × 權重 **0.75**
- 結構品質: **0.1183** × 權重 **0.25**
- base components: feat_4h_bias50=0.8038 (w=0.4, contrib=0.3215), feat_nose=0.3197 (w=0.18, contrib=0.0576), feat_pulse=0.6944 (w=0.27, contrib=0.1875), feat_ear=0.997 (w=0.15, contrib=0.1495)
- structure components: feat_4h_bb_pct_b=0.2267 (w=0.34, contrib=0.0771), feat_4h_dist_bb_lower=0.0717 (w=0.33, contrib=0.0237), feat_4h_dist_swing_low=0.0532 (w=0.33, contrib=0.0176)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2129** | structure_group_max_entry_gain: **0.2204**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 100 | 0.6 | 0.2883 | 0.1922 | 0.522 | 10 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 8 | 1.0 | 0.7261 | 0.058 | 0.1114 | 8 | False |
| narrow `regime_label+entry_quality_label` | 29 | 1.0 | 0.6955 | 0.0893 | 0.2634 | 8 | False |
| broad `regime_gate+entry_quality_label` | 8 | 1.0 | 0.7261 | 0.058 | 0.1114 | 8 | False |
