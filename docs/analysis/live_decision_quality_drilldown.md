...
- feature_timestamp: **2026-04-22 12:49:13.198706**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.3992**
- layers: **0 → 0**
...
- final entry_quality: **0.4262** / trade_floor **0.55** / gap **-0.1238**
- base_quality: **0.3854** × weight **0.75**
- structure_quality: **0.5485** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.5661 (w=0.18, contrib=0.1019), feat_pulse=0.4971 (w=0.27, contrib=0.1342), feat_ear=0.9953 (w=0.15, contrib=0.1493)
- structure components: feat_4h_bb_pct_b=0.8679 (w=0.34, contrib=0.2951), feat_4h_dist_bb_lower=0.3377 (w=0.33, contrib=0.1114), feat_4h_dist_swing_low=0.4304 (w=0.33, contrib=0.142)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1238**
- base_group_max_entry_gain: **0.4609** | structure_group_max_entry_gain: **0.1128**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.4127, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.4127)
- bias50 fully relaxed: entry≈**0.7262** / layers≈**0** / required_bias50_cap≈**0.3365**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 116 | 0.6379 | 0.2749 | 0.2657 | 0.6103 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 116 | 0.6379 | 0.2749 | 0.2657 | 0.6103 | 0 | False |
