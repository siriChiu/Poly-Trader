...
- feature_timestamp: **2026-04-24 00:45:10.194245**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.6105**
- layers: **0 → 0**
...
- final entry_quality: **0.345** / trade_floor **0.55** / gap **-0.205**
- base_quality: **0.3153** × weight **0.75**
- structure_quality: **0.434** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.3537 (w=0.18, contrib=0.0637), feat_pulse=0.3857 (w=0.27, contrib=0.1041), feat_ear=0.9832 (w=0.15, contrib=0.1475)
- structure components: feat_4h_bb_pct_b=0.6068 (w=0.34, contrib=0.2063), feat_4h_dist_bb_lower=0.2355 (w=0.33, contrib=0.0777), feat_4h_dist_swing_low=0.4544 (w=0.33, contrib=0.15)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.205**
- base_group_max_entry_gain: **0.5136** | structure_group_max_entry_gain: **0.1415**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.6833, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.6833)
- bias50 fully relaxed: entry≈**0.645** / layers≈**0** / required_bias50_cap≈**-1.0165**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 492 | 0.5589 | 0.1846 | 0.2747 | 0.6501 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 492 | 0.5589 | 0.1846 | 0.2747 | 0.6501 | 0 | False |
