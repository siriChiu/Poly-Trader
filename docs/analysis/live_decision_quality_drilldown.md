...
- generated_at: **2026-07-28T14:46:12.733253Z**
- feature_timestamp: **2026-07-28 14:33:27.381993**
- live_probe_generated_at: **2026-07-28T14:46:12.500752Z**
...
- current-bucket root cause: verdict=執行期阻塞優先於分桶根因分析 / patch=None / feature=None / exact_support=0/50 / gap=50 / neighbor=阻塞｜structure_overextended_block｜q85
- 精準樣本修補: **未啟用** | 支持路徑 **精準樣本尚未建立** | 跨越門檻 **執行期阻塞優先於跨門檻分析**
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 26.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 13/50，至少還差 2 勝。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，65 筆 / 勝率 72.7% / 品質 0.298，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.655** / trade_floor **0.55** / gap **0.105**
- 基礎品質: **0.8702** × 權重 **0.75**
- 結構品質: **0.0091** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.709 (w=0.18, contrib=0.1276), feat_pulse=0.7171 (w=0.27, contrib=0.1936), feat_ear=0.9934 (w=0.15, contrib=0.149)
- structure components: feat_4h_bb_pct_b=0.0216 (w=0.34, contrib=0.0073), feat_4h_dist_bb_lower=0.0053 (w=0.33, contrib=0.0017), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.0973** | structure_group_max_entry_gain: **0.2478**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.63 | 0.219 | 0.1411 | 0.4615 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 10 | 1.0 | 0.5907 | 0.0272 | 0.1125 | 0 | False |
