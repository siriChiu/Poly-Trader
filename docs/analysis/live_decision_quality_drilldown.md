...
- feature_timestamp: **2026-04-21 11:37:21.661499**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.4113**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5556（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，43 rows / WR 0.0% / 品質 -0.250，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5556** / trade_floor **0.55** / gap **0.0056**
- base_quality: **0.5736** × weight **0.75**
- structure_quality: **0.5019** × weight **0.25**
- base components: feat_4h_bias50=0.051 (w=0.0, contrib=0.0), feat_nose=0.322 (w=0.6, contrib=0.1932), feat_pulse=0.7592 (w=0.0, contrib=0.0), feat_ear=0.9509 (w=0.4, contrib=0.3804)
- structure components: feat_4h_bb_pct_b=0.8093 (w=0.34, contrib=0.2752), feat_4h_dist_bb_lower=0.3087 (w=0.33, contrib=0.1019), feat_4h_dist_swing_low=0.3783 (w=0.33, contrib=0.1248)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.3198** | structure_group_max_entry_gain: **0.1245**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7297** / layers≈**2** / required_bias50_cap≈**0.395**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.695 | 0.3413 | 0.222 | 0.4504 | 12 | False |
