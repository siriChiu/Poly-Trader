...
- feature_timestamp: **2026-04-21 06:51:38.316218**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.4716**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5597（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，69 rows / WR 0.0% / 品質 -0.262，明顯劣於 exact live lane WR — / 品質 —。**
...
- structure_quality: **0.4031** × weight **0.25**
- base components: feat_4h_bias50=0.1796 (w=0.0, contrib=0.0), feat_nose=0.3359 (w=0.45, contrib=0.1512), feat_pulse=0.8378 (w=0.55, contrib=0.4608), feat_ear=0.9851 (w=0.0, contrib=0.0)
- structure components: feat_4h_bb_pct_b=0.6506 (w=0.34, contrib=0.2212), feat_4h_dist_bb_lower=0.2486 (w=0.33, contrib=0.082), feat_4h_dist_swing_low=0.3026 (w=0.33, contrib=0.0999)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.291** | structure_group_max_entry_gain: **0.1492**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7266** / layers≈**2** / required_bias50_cap≈**0.3435**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 69 | 0.1739 | -0.1431 | 0.3029 | 0.7602 | 12 | True |
