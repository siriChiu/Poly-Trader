...
- feature_timestamp: **2026-04-20 00:17:47.396233**
...
- final entry_quality: **0.4537** / trade_floor **0.55** / gap **-0.0963**
- base_quality: **0.5691** × weight **0.75**
- structure_quality: **0.1076** × weight **0.25**
- base components: feat_4h_bias50=0.5266 (w=0.4, contrib=0.2106), feat_nose=0.6886 (w=0.18, contrib=0.1239), feat_pulse=0.3562 (w=0.27, contrib=0.0962), feat_ear=0.9223 (w=0.15, contrib=0.1383)
- structure components: feat_4h_bb_pct_b=0.151 (w=0.34, contrib=0.0514), feat_4h_dist_bb_lower=0.0591 (w=0.33, contrib=0.0195), feat_4h_dist_swing_low=0.1112 (w=0.33, contrib=0.0367)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0963**
- base_group_max_entry_gain: **0.3231** | structure_group_max_entry_gain: **0.2231**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.321, max_gain≈0.142）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.321), feat_pulse (Δscore≈0.4756)
