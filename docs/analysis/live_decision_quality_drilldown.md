...
- feature_timestamp: **2026-05-24 13:12:20.868244**
...
- deployment_blocker: 精準樣本未達最小門檻 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 1/50（缺 49），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2756；目前維持不可部署治理。
...
- runtime closure summary: **當前即時分桶 觀察｜基線觀察（市場狀態 / 偏離）｜q35 的精準樣本仍未就緒（1/50，路徑=精準樣本未達最小門檻 / 治理=目前即時分桶精準樣本未達最小門檻）；較寬範圍 / 近似樣本 目前都只屬僅供治理參考，不可視為部署閉環。 阻塞點=當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 1/50（缺 49），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2756；目前維持不可部署治理。 精準路徑與外溢對照：同品質寬範圍出現 熊市｜觀察 外溢，9 筆 / 勝率 0.0% / 品質 -0.334，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.355。**
- q35 scaling audit: overall=bias50_formula_may_be_too_harsh / redesign=base_stack_redesign_discriminative_reweight_crosses_floor_but_執行_blocked / runtime_gap=0.0402 / mode=exact_lane_formula_review / next_patch=feat_4h_bias50_formula
- q35 runtime truth: redesign_entry_quality=0.5514 / redesign_layers_after=0 / runtime_layers=0 / blocker=精準樣本未達最小門檻 / exact_support=1/50 / support_gap=49
...
- final entry_quality: **0.5098** / trade_floor **0.55** / gap **-0.0402**
- 基礎品質: **0.5321** × 權重 **0.75**
- 結構品質: **0.4429** × 權重 **0.25**
- base components: feat_4h_bias50=0.4946 (w=0.4, contrib=0.1978), feat_nose=0.3553 (w=0.18, contrib=0.064), feat_pulse=0.4569 (w=0.27, contrib=0.1234), feat_ear=0.9794 (w=0.15, contrib=0.1469)
- structure components: feat_4h_bb_pct_b=0.7324 (w=0.34, contrib=0.249), feat_4h_dist_bb_lower=0.2243 (w=0.33, contrib=0.074), feat_4h_dist_swing_low=0.3631 (w=0.33, contrib=0.1198)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0402**
- base_group_max_entry_gain: **0.3509** | structure_group_max_entry_gain: **0.1392**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.134, max_gain≈0.1516）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.134), feat_pulse (Δscore≈0.1985), feat_nose (Δscore≈0.2978), feat_4h_dist_bb_lower (Δscore≈0.4873)
- bias50 fully relaxed: entry≈**0.6614** / layers≈**1** / required_bias50_cap≈**-0.743**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 47 | 0.0 | -0.3555 | 0.3904 | 0.9093 | 1 | True |
| exact `regime_label+regime_gate+entry_quality_label` | 47 | 0.0 | -0.3555 | 0.3904 | 0.9093 | 1 | True |
| narrow `regime_label+entry_quality_label` | 47 | 0.0 | -0.3555 | 0.3904 | 0.9093 | 1 | True |
| broad `regime_gate+entry_quality_label` | 53 | 0.0 | -0.353 | 0.3917 | 0.9128 | 1 | True |
