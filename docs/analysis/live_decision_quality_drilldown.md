...
- feature_timestamp: **2026-04-23 23:55:30.948572**
...
- runtime closure summary: **circuit breaker active：Recent 50-sample win rate: 24.00% < 30%; release condition = streak < 50 且 recent 50 win rate >= 30%；目前 recent 50 只贏 12/50，至少還差 3 勝。 exact-vs-spillover=同 regime 寬 scope 出現 bull|ALLOW spillover，548 rows / WR 40.2% / 品質 0.020，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.4022** / trade_floor **0.55** / gap **-0.1478**
- base_quality: **0.3976** × weight **0.75**
- structure_quality: **0.4161** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.339 (w=0.18, contrib=0.061), feat_pulse=0.7038 (w=0.27, contrib=0.19), feat_ear=0.9773 (w=0.15, contrib=0.1466)
- structure components: feat_4h_bb_pct_b=0.5745 (w=0.34, contrib=0.1953), feat_4h_dist_bb_lower=0.2295 (w=0.33, contrib=0.0757), feat_4h_dist_swing_low=0.4393 (w=0.33, contrib=0.145)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1478**
- base_group_max_entry_gain: **0.4518** | structure_group_max_entry_gain: **0.1461**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.4927, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.4927)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 466 | 0.5365 | 0.1758 | 0.2702 | 0.6349 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 466 | 0.5365 | 0.1758 | 0.2702 | 0.6349 | 0 | False |
