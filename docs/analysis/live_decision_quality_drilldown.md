...
- feature_timestamp: **2026-05-27 13:12:46.741296**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 122 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 122 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 122 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['constant_target'] win_rate=0.0 avg_pnl=-0.0128 avg_品質=-0.302 window=2026-05-25 08:07:19.739998->2026-05-26 14:00:00 adverse_連續虧損筆數=100x0 (2026-05-25 08:07:19.739998->2026-05-26 14:00:00) vs sibling prev_win_rate=0.77 Δwin_rate=-0.77 prev_品質=0.3526 Δ品質=-0.6546 prev_pnl=0.0044 Δpnl=-0.0172 top_shifts=feat_4h_dist_swing_low(3.4869→1.9572), feat_4h_dist_bb_lower(1.627→1.0644), feat_4h_bb_pct_b(0.6752→0.5163)。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，54 筆 / 勝率 85.1% / 品質 0.385，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.5831** / trade_floor **0.55** / gap **0.0331**
- 基礎品質: **0.7473** × 權重 **0.75**
- 結構品質: **0.0903** × 權重 **0.25**
- base components: feat_4h_bias50=0.8073 (w=0.4, contrib=0.3229), feat_nose=0.6416 (w=0.18, contrib=0.1155), feat_pulse=0.5967 (w=0.27, contrib=0.1611), feat_ear=0.9854 (w=0.15, contrib=0.1478)
- structure components: feat_4h_bb_pct_b=0.2128 (w=0.34, contrib=0.0724), feat_4h_dist_bb_lower=0.0545 (w=0.33, contrib=0.018), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1895** | structure_group_max_entry_gain: **0.2274**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.385 | 0.0253 | 0.2011 | 0.5529 | 0 | True |
