...
- feature_timestamp: **2026-05-17 13:02:08.359263**
...
- runtime_blocker: circuit_breaker | reason: 最近 50 筆勝率: 28.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 28.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 14/50，至少還差 1 勝。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，71 筆 / 勝率 0.0% / 品質 -0.348，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6241** / trade_floor **0.55** / gap **0.0741**
- 基礎品質: **0.7442** × 權重 **0.75**
- 結構品質: **0.264** × 權重 **0.25**
- base components: feat_4h_bias50=0.9352 (w=0.4, contrib=0.3741), feat_nose=0.3978 (w=0.18, contrib=0.0716), feat_pulse=0.5681 (w=0.27, contrib=0.1534), feat_ear=0.9673 (w=0.15, contrib=0.1451)
- structure components: feat_4h_bb_pct_b=0.5316 (w=0.34, contrib=0.1808), feat_4h_dist_bb_lower=0.1668 (w=0.33, contrib=0.0551), feat_4h_dist_swing_low=0.0855 (w=0.33, contrib=0.0282)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1919** | structure_group_max_entry_gain: **0.1839**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 40 | 0.3 | -0.0622 | 0.2177 | 0.6835 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 40 | 0.3 | -0.0622 | 0.2177 | 0.6835 | 0 | False |
