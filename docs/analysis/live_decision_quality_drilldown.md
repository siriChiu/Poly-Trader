...
- feature_timestamp: **2026-05-17 14:02:35.701094**
- target: `simulated_pyramid_win`
- live path: **熊市 / 觀察 / C**
- signal: **HOLD** @ confidence **0.3524**
- layers: **1 → 0**
- allowed_layers_raw_reason: 進場品質_C_single_layer
- allowed_layers_reason: 精準樣本尚未建立
- execution_guardrail_reason: 精準樣本尚未建立
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜結構品質觀察｜q15` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=所有支持路徑仍不足，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.0423；目前維持不可部署治理。
...
- final entry_quality: **0.6477** / trade_floor **0.55** / gap **0.0977**
- 基礎品質: **0.7872** × 權重 **0.75**
- 結構品質: **0.2293** × 權重 **0.25**
- base components: feat_4h_bias50=0.9729 (w=0.4, contrib=0.3892), feat_nose=0.4448 (w=0.18, contrib=0.0801), feat_pulse=0.6307 (w=0.27, contrib=0.1703), feat_ear=0.9844 (w=0.15, contrib=0.1477)
- structure components: feat_4h_bb_pct_b=0.4676 (w=0.34, contrib=0.159), feat_4h_dist_bb_lower=0.1471 (w=0.33, contrib=0.0485), feat_4h_dist_swing_low=0.066 (w=0.33, contrib=0.0218)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1597** | structure_group_max_entry_gain: **0.1928**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 44 | 0.3409 | -0.0264 | 0.2026 | 0.6401 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 44 | 0.3409 | -0.0264 | 0.2026 | 0.6401 | 0 | False |
| broad `regime_gate+entry_quality_label` | 2 | 0.0 | -0.2682 | 0.3219 | 0.953 | 0 | False |
