...
- feature_timestamp: **2026-05-23 19:13:41.389213**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 12.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 6/50，至少還差 9 勝。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，119 筆 / 勝率 19.5% / 品質 -0.123，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.181。**
...
- final entry_quality: **0.5896** / trade_floor **0.55** / gap **0.0396**
- 基礎品質: **0.6891** × 權重 **0.75**
- 結構品質: **0.291** × 權重 **0.25**
- base components: feat_4h_bias50=0.8648 (w=0.4, contrib=0.3459), feat_nose=0.1449 (w=0.18, contrib=0.0261), feat_pulse=0.6585 (w=0.27, contrib=0.1778), feat_ear=0.9286 (w=0.15, contrib=0.1393)
- structure components: feat_4h_bb_pct_b=0.6565 (w=0.34, contrib=0.2232), feat_4h_dist_bb_lower=0.2055 (w=0.33, contrib=0.0678), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2332** | structure_group_max_entry_gain: **0.1772**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 36 | 0.3056 | -0.0585 | 0.3132 | 0.7612 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 4 | 0.0 | -0.1812 | 0.3423 | 0.9174 | 0 | False |
| narrow `regime_label+entry_quality_label` | 36 | 0.3056 | -0.0585 | 0.3132 | 0.7612 | 0 | False |
| broad `regime_gate+entry_quality_label` | 4 | 0.0 | -0.1812 | 0.3423 | 0.9174 | 0 | False |
