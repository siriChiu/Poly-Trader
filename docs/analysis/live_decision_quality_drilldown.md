...
- feature_timestamp: **2026-05-14 07:11:28.239114**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 22.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 11/50，至少還差 4 勝。 精準路徑與外溢對照：同 gate 寬 範圍 出現 牛市|警戒 外溢，560 筆 / 勝率 41.9% / 品質 0.103，明顯劣於 精準即時路徑 勝率 65.0% / 品質 0.350。**
...
- final entry_quality: **0.5857** / trade_floor **0.55** / gap **0.0357**
- base_quality: **0.7024** × weight **0.75**
- structure_quality: **0.2358** × weight **0.25**
- base components: feat_4h_bias50=0.7128 (w=0.4, contrib=0.2851), feat_nose=0.4583 (w=0.18, contrib=0.0825), feat_pulse=0.6959 (w=0.27, contrib=0.1879), feat_ear=0.9792 (w=0.15, contrib=0.1469)
- structure components: feat_4h_bb_pct_b=0.5455 (w=0.34, contrib=0.1855), feat_4h_dist_bb_lower=0.1523 (w=0.33, contrib=0.0503), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2232** | structure_group_max_entry_gain: **0.191**
