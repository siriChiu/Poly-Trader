...
- feature_timestamp: **2026-05-17 12:01:57.351618**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 20.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 10/50，至少還差 5 勝。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，67 筆 / 勝率 0.0% / 品質 -0.348，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.5775** / trade_floor **0.55** / gap **0.0275**
- 基礎品質: **0.6756** × 權重 **0.75**
- 結構品質: **0.2833** × 權重 **0.25**
- base components: feat_4h_bias50=0.9142 (w=0.4, contrib=0.3657), feat_nose=0.2765 (w=0.18, contrib=0.0498), feat_pulse=0.4278 (w=0.27, contrib=0.1155), feat_ear=0.9643 (w=0.15, contrib=0.1446)
- structure components: feat_4h_bb_pct_b=0.5676 (w=0.34, contrib=0.193), feat_4h_dist_bb_lower=0.1773 (w=0.33, contrib=0.0585), feat_4h_dist_swing_low=0.0964 (w=0.33, contrib=0.0318)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2433** | structure_group_max_entry_gain: **0.1792**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 36 | 0.2222 | -0.1225 | 0.2371 | 0.7418 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 36 | 0.2222 | -0.1225 | 0.2371 | 0.7418 | 0 | False |
