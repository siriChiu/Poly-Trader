...
- feature_timestamp: **2026-04-20 13:46:12.211916**
- target: `simulated_pyramid_win`
- live path: **chop / CAUTION / D**
- signal: **HOLD** @ confidence **0.1805**
- layers: **0 → 0**
...
- final entry_quality: **0.4727** / trade_floor **0.55** / gap **-0.0773**
- base_quality: **0.5022** × weight **0.75**
- structure_quality: **0.3841** × weight **0.25**
- base components: feat_4h_bias50=0.2667 (w=0.4, contrib=0.1067), feat_nose=0.4929 (w=0.18, contrib=0.0887), feat_pulse=0.5981 (w=0.27, contrib=0.1615), feat_ear=0.9686 (w=0.15, contrib=0.1453)
- structure components: feat_4h_bb_pct_b=0.6357 (w=0.34, contrib=0.2161), feat_4h_dist_bb_lower=0.2458 (w=0.33, contrib=0.0811), feat_4h_dist_swing_low=0.2633 (w=0.33, contrib=0.0869)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0773**
- base_group_max_entry_gain: **0.3734** | structure_group_max_entry_gain: **0.154**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.2577, max_gain≈0.22）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.2577), feat_pulse (Δscore≈0.3817)
- bias50 fully relaxed: entry≈**0.6927** / layers≈**2** / required_bias50_cap≈**-0.222**
...
| broad `regime_gate+entry_quality_label` | 54 | 0.4444 | 0.0567 | 0.3668 | 0.6796 | 0 | False |
