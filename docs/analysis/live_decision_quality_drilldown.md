...
- feature_timestamp: **2026-05-24 15:39:52.599691**
- target: `simulated_pyramid_win`
- live path: **熊市 / 觀察 / C**
- signal: **觀望** @ confidence **0.3094**
- layers: **1 → 0**
- allowed_layers_raw_reason: 進場品質_C_single_layer
- allowed_layers_reason: 精準樣本未達最小門檻
- execution_guardrail_reason: 精準樣本未達最小門檻
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本未達最小門檻 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 7/50（缺 43），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2697；目前維持不可部署治理。
...
- 基礎品質: **0.7349** × 權重 **0.75**
- 結構品質: **0.3048** × 權重 **0.25**
- base components: feat_4h_bias50=0.6469 (w=0.4, contrib=0.2588), feat_nose=0.7387 (w=0.18, contrib=0.133), feat_pulse=0.7334 (w=0.27, contrib=0.198), feat_ear=0.9674 (w=0.15, contrib=0.1451)
- structure components: feat_4h_bb_pct_b=0.4731 (w=0.34, contrib=0.1609), feat_4h_dist_bb_lower=0.1484 (w=0.33, contrib=0.049), feat_4h_dist_swing_low=0.2876 (w=0.33, contrib=0.0949)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1989** | structure_group_max_entry_gain: **0.1739**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 103 | 0.7282 | 0.4281 | 0.2163 | 0.5678 | 7 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 26 | 0.2308 | -0.1439 | 0.3733 | 0.9073 | 7 | False |
| narrow `regime_label+entry_quality_label` | 103 | 0.7282 | 0.4281 | 0.2163 | 0.5678 | 7 | False |
| broad `regime_gate+entry_quality_label` | 61 | 0.0984 | -0.2466 | 0.3729 | 0.8548 | 42 | True |
