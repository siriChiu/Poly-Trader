...
- feature_timestamp: **2026-04-23 16:08:35.125976**
...
- runtime closure summary: **circuit breaker active：Recent 50-sample win rate: 14.00% < 30%; release condition = streak < 50 且 recent 50 win rate >= 30%；目前 recent 50 只贏 7/50，至少還差 8 勝。 exact-vs-spillover=同 regime 寬 scope 出現 bull|ALLOW spillover，408 rows / WR 42.4% / 品質 0.112，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.3003** / trade_floor **0.55** / gap **-0.2497**
- base_quality: **0.2554** × weight **0.75**
- structure_quality: **0.4351** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.2205 (w=0.18, contrib=0.0397), feat_pulse=0.2775 (w=0.27, contrib=0.0749), feat_ear=0.9383 (w=0.15, contrib=0.1407)
- structure components: feat_4h_bb_pct_b=0.5986 (w=0.34, contrib=0.2035), feat_4h_dist_bb_lower=0.2421 (w=0.33, contrib=0.0799), feat_4h_dist_swing_low=0.4598 (w=0.33, contrib=0.1517)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.2497**
- base_group_max_entry_gain: **0.5584** | structure_group_max_entry_gain: **0.1412**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.8323, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.8323)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 406 | 0.4557 | 0.1503 | 0.222 | 0.554 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 406 | 0.4557 | 0.1503 | 0.222 | 0.554 | 0 | False |
