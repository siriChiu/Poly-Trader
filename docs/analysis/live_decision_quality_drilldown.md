...
- feature_timestamp: **2026-05-28 02:13:03.267190**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 165 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 165 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 165 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['constant_target'] win_rate=0.0 avg_pnl=-0.0135 avg_品質=-0.3179 window=2026-05-25 19:10:56.152903->2026-05-27 03:00:00 adverse_連續虧損筆數=100x0 (2026-05-25 19:10:56.152903->2026-05-27 03:00:00) vs sibling prev_win_rate=0.34 Δwin_rate=-0.34 prev_品質=0.0355 Δ品質=-0.3534 prev_pnl=-0.0033 Δpnl=-0.0102 top_shifts=feat_4h_dist_swing_low(3.2972→0.6618), feat_4h_dist_bb_lower(1.4547→0.5394), feat_4h_bb_pct_b(0.6503→0.2668)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜阻塞 外溢，37 筆 / 勝率 0.0% / 品質 -0.311，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.300。**
...
- final entry_quality: **0.619** / trade_floor **0.55** / gap **0.069**
- 基礎品質: **0.8253** × 權重 **0.75**
- 結構品質: **0.0** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.5967 (w=0.18, contrib=0.1074), feat_pulse=0.6418 (w=0.27, contrib=0.1733), feat_ear=0.9641 (w=0.15, contrib=0.1446)
...
- base_group_max_entry_gain: **0.1309** | structure_group_max_entry_gain: **0.25**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.17 | -0.1412 | 0.2434 | 0.6422 | 31 | True |
