...
- feature_timestamp: **2026-05-21 17:17:47.493801**
...
- deployment_blocker: 精準樣本未達最小門檻 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 1/50（缺 49），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.2111；目前維持不可部署治理。
...
- final entry_quality: **0.5205** / trade_floor **0.55** / gap **-0.0295**
- 基礎品質: **0.5778** × 權重 **0.75**
- 結構品質: **0.3485** × 權重 **0.25**
- base components: feat_4h_bias50=0.5957 (w=0.4, contrib=0.2383), feat_nose=0.3112 (w=0.18, contrib=0.056), feat_pulse=0.4977 (w=0.27, contrib=0.1344), feat_ear=0.9942 (w=0.15, contrib=0.1491)
- structure components: feat_4h_bb_pct_b=0.6244 (w=0.34, contrib=0.2123), feat_4h_dist_bb_lower=0.1871 (w=0.33, contrib=0.0617), feat_4h_dist_swing_low=0.2258 (w=0.33, contrib=0.0745)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0295**
- base_group_max_entry_gain: **0.3167** | structure_group_max_entry_gain: **0.1629**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.0983, max_gain≈0.1213）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.0983), feat_pulse (Δscore≈0.1457), feat_nose (Δscore≈0.2185), feat_4h_bb_pct_b (Δscore≈0.3471)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 50 | 0.46 | 0.174 | 0.0744 | 0.2448 | 11 | False |
