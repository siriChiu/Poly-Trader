...
- feature_timestamp: **2026-04-20 18:36:25.251411**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.4543**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5606（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，132 rows / WR 0.0% / 品質 -0.230，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5606** / trade_floor **0.55** / gap **0.0106**
- base_quality: **0.5715** × weight **0.75**
- structure_quality: **0.528** × weight **0.25**
- base components: feat_4h_bias50=0.0712 (w=0.0, contrib=0.0), feat_nose=0.2291 (w=0.5, contrib=0.1145), feat_pulse=0.6561 (w=0.05, contrib=0.0328), feat_ear=0.9425 (w=0.45, contrib=0.4241)
- structure components: feat_4h_bb_pct_b=0.8697 (w=0.34, contrib=0.2957), feat_4h_dist_bb_lower=0.3343 (w=0.33, contrib=0.1103), feat_4h_dist_swing_low=0.3697 (w=0.33, contrib=0.122)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.3214** | structure_group_max_entry_gain: **0.118**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7018** / layers≈**2** / required_bias50_cap≈**-0.0695**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 132 | 0.0909 | -0.1714 | 0.2547 | 0.7342 | 12 | True |
