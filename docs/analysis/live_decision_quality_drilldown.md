...
- feature_timestamp: **2026-04-20 20:47:17.285088**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.4714**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5562（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，125 rows / WR 0.0% / 品質 -0.230，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5562** / trade_floor **0.55** / gap **0.0062**
- base_quality: **0.5754** × weight **0.75**
- structure_quality: **0.4987** × weight **0.25**
- base components: feat_4h_bias50=0.0561 (w=0.0, contrib=0.0), feat_nose=0.5532 (w=0.95, contrib=0.5255), feat_pulse=0.5141 (w=0.0, contrib=0.0), feat_ear=0.9975 (w=0.05, contrib=0.0499)
- structure components: feat_4h_bb_pct_b=0.8303 (w=0.34, contrib=0.2823), feat_4h_dist_bb_lower=0.3188 (w=0.33, contrib=0.1052), feat_4h_dist_swing_low=0.3368 (w=0.33, contrib=0.1112)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.3184** | structure_group_max_entry_gain: **0.1253**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7157** / layers≈**2** / required_bias50_cap≈**0.161**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 125 | 0.096 | -0.168 | 0.2559 | 0.7218 | 12 | True |
