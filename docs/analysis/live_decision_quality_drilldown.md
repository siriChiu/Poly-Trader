...
- feature_timestamp: **2026-05-21 00:18:45.205994**
- target: `simulated_pyramid_win`
- live path: **盤整 / 觀察 / C**
- signal: **觀望** @ confidence **0.5555**
- layers: **1 → 0**
- allowed_layers_raw_reason: 進場品質_C_single_layer
- allowed_layers_reason: 精準樣本尚未建立
- execution_guardrail_reason: 精準樣本尚未建立
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=所有支持路徑仍不足，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.2323；目前維持不可部署治理。
...
- 基礎品質: **0.6497** × 權重 **0.75**
- 結構品質: **0.3343** × 權重 **0.25**
- base components: feat_4h_bias50=0.7103 (w=0.4, contrib=0.2841), feat_nose=0.5036 (w=0.18, contrib=0.0907), feat_pulse=0.4729 (w=0.27, contrib=0.1277), feat_ear=0.9819 (w=0.15, contrib=0.1473)
- structure components: feat_4h_bb_pct_b=0.6078 (w=0.34, contrib=0.2066), feat_4h_dist_bb_lower=0.1859 (w=0.33, contrib=0.0613), feat_4h_dist_swing_low=0.2008 (w=0.33, contrib=0.0663)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2626** | structure_group_max_entry_gain: **0.1664**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.59 | 0.2014 | 0.1603 | 0.5147 | 116 | False |
...
| broad `regime_gate+entry_quality_label` | 178 | 0.5787 | 0.1991 | 0.1575 | 0.5037 | 105 | False |
