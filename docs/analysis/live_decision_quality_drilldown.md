...
- feature_timestamp: **2026-05-20 21:11:13.617137**
- target: `simulated_pyramid_win`
- live path: **盤整 / 觀察 / D**
- signal: **觀望** @ confidence **0.5579**
- layers: **0 → 0**
- allowed_layers_raw_reason: 進場品質低於交易門檻
- allowed_layers_reason: 精準樣本尚未建立
- execution_guardrail_reason: 精準樣本尚未建立
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.1715；目前維持不可部署治理。
...
- runtime closure summary: **當前即時分桶 觀察｜基線觀察（市場狀態 / 偏離）｜q35 的精準樣本仍未就緒（0/50，路徑=精準樣本尚未建立 / 治理=exact_live_lane_proxy_available）；較寬範圍 / 近似樣本 目前都只屬僅供治理參考，不可視為部署閉環。 阻塞點=當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.1715；目前維持不可部署治理。 精準路徑與外溢對照：同 gate 寬範圍出現 熊市｜觀察 外溢，200 筆 / 勝率 51.0% / 品質 0.134，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
- q35 scaling audit: overall=bias50_formula_may_be_too_harsh / redesign=base_stack_redesign_discriminative_reweight_crosses_floor_but_執行_blocked / runtime_gap=0.0185 / mode=exact_lane_formula_review / next_patch=feat_4h_bias50_formula
- q35 runtime truth: redesign_entry_quality=0.554 / redesign_layers_after=0 / runtime_layers=0 / blocker=精準樣本尚未建立 / exact_support=0/50 / support_gap=50
...
- final entry_quality: **0.5315** / trade_floor **0.55** / gap **-0.0185**
- 基礎品質: **0.5809** × 權重 **0.75**
- 結構品質: **0.3833** × 權重 **0.25**
- base components: feat_4h_bias50=0.6931 (w=0.4, contrib=0.2772), feat_nose=0.2431 (w=0.18, contrib=0.0438), feat_pulse=0.4192 (w=0.27, contrib=0.1132), feat_ear=0.9783 (w=0.15, contrib=0.1467)
- structure components: feat_4h_bb_pct_b=0.7071 (w=0.34, contrib=0.2404), feat_4h_dist_bb_lower=0.2151 (w=0.33, contrib=0.071), feat_4h_dist_swing_low=0.2178 (w=0.33, contrib=0.0719)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0185**
- base_group_max_entry_gain: **0.3143** | structure_group_max_entry_gain: **0.1542**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.0617, max_gain≈0.0921）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.0617), feat_pulse (Δscore≈0.0914), feat_nose (Δscore≈0.137), feat_4h_bb_pct_b (Δscore≈0.2176)
- bias50 fully relaxed: entry≈**0.6236** / layers≈**1** / required_bias50_cap≈**-1.374**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.51 | 0.1335 | 0.1815 | 0.5507 | 0 | False |
