...
- feature_timestamp: **2026-05-19 16:03:31.310518**
- target: `simulated_pyramid_win`
- live path: **熊市 / 觀察 / C**
- signal: **觀望** @ confidence **0.3528**
- layers: **1 → 0**
...
- final entry_quality: **0.6187** / trade_floor **0.55** / gap **0.0687**
- 基礎品質: **0.7593** × 權重 **0.75**
- 結構品質: **0.197** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.5564 (w=0.18, contrib=0.1001), feat_pulse=0.4199 (w=0.27, contrib=0.1134), feat_ear=0.9716 (w=0.15, contrib=0.1457)
- structure components: feat_4h_bb_pct_b=0.3919 (w=0.34, contrib=0.1333), feat_4h_dist_bb_lower=0.1244 (w=0.33, contrib=0.0411), feat_4h_dist_swing_low=0.0688 (w=0.33, contrib=0.0227)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1806** | structure_group_max_entry_gain: **0.2007**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 159 | 0.2264 | -0.0755 | 0.2233 | 0.655 | 2 | True |
| exact `regime_label+regime_gate+entry_quality_label` | 101 | 0.198 | -0.0946 | 0.2466 | 0.6727 | 2 | True |
| narrow `regime_label+entry_quality_label` | 159 | 0.2264 | -0.0755 | 0.2233 | 0.655 | 2 | True |
| broad `regime_gate+entry_quality_label` | 101 | 0.198 | -0.0946 | 0.2466 | 0.6727 | 2 | True |
...
- worst_pathology_scope: **regime_label+regime_gate+entry_quality_label** rows=101 win_rate=0.198 quality=-0.0946
