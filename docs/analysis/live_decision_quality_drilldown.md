...
- feature_timestamp: **2026-05-24 18:01:33.341382**
...
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2437；目前維持不可部署治理。
...
- runtime closure summary: **當前即時分桶 觀察｜基線觀察（市場狀態 / 偏離）｜q35 的精準樣本仍未就緒（0/50，路徑=精準樣本尚未建立 / 治理=精準即時代理路徑僅供治理參考）；較寬範圍 / 近似樣本 目前都只屬僅供治理參考，不可視為部署閉環。 阻塞點=當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2437；目前維持不可部署治理。 精準路徑與外溢對照：同 gate 寬範圍出現 盤整｜觀察 外溢，71 筆 / 勝率 0.0% / 品質 -0.364，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.331。**
- q35 scaling audit: overall=bias50_formula_may_be_too_harsh / redesign=base_stack_redesign_discriminative_reweight_crosses_floor_but_執行_blocked / runtime_gap=-0.0156 / mode=exact_lane_formula_review / next_patch=feat_4h_bias50_formula
- q35 runtime truth: redesign_entry_quality=0.5982 / redesign_layers_after=0 / runtime_layers=0 / blocker=精準樣本尚未建立 / exact_support=0/50 / support_gap=50
...
- final entry_quality: **0.5656** / trade_floor **0.55** / gap **0.0156**
- 基礎品質: **0.6358** × 權重 **0.75**
- 結構品質: **0.3553** × 權重 **0.25**
- base components: feat_4h_bias50=0.5735 (w=0.4, contrib=0.2294), feat_nose=0.6791 (w=0.18, contrib=0.1222), feat_pulse=0.5014 (w=0.27, contrib=0.1354), feat_ear=0.9917 (w=0.15, contrib=0.1487)
- structure components: feat_4h_bb_pct_b=0.5672 (w=0.34, contrib=0.1928), feat_4h_dist_bb_lower=0.1726 (w=0.33, contrib=0.057), feat_4h_dist_swing_low=0.3198 (w=0.33, contrib=0.1055)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2732** | structure_group_max_entry_gain: **0.1612**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.6936** / layers≈**2** / required_bias50_cap≈**-0.4675**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `entry_quality_label` | 143 | 0.5804 | 0.2753 | 0.2424 | 0.5976 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 32 | 0.0 | -0.3305 | 0.3864 | 0.838 | 0 | True |
| narrow `regime_label+entry_quality_label` | 32 | 0.0 | -0.3305 | 0.3864 | 0.838 | 0 | True |
| broad `regime_gate+entry_quality_label` | 58 | 0.1034 | -0.2468 | 0.3805 | 0.8691 | 0 | True |
