...
- feature_timestamp: **2026-04-29 21:16:07.738776**
- target: `simulated_pyramid_win`
- live path: **bear / BLOCK / C**
- signal: **HOLD** @ confidence **0.5399**
- layers: **0 → 0**
...
- base_quality: **0.7247** × weight **0.75**
- structure_quality: **0.1254** × weight **0.25**
- base components: feat_4h_bias50=0.8995 (w=0.4, contrib=0.3598), feat_nose=0.636 (w=0.18, contrib=0.1145), feat_pulse=0.4158 (w=0.27, contrib=0.1123), feat_ear=0.9212 (w=0.15, contrib=0.1382)
- structure components: feat_4h_bb_pct_b=0.2588 (w=0.34, contrib=0.088), feat_4h_dist_bb_lower=0.0911 (w=0.33, contrib=0.0301), feat_4h_dist_swing_low=0.0222 (w=0.33, contrib=0.0073)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2065** | structure_group_max_entry_gain: **0.2187**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 400 | 0.3825 | 0.0605 | 0.1744 | 0.5737 | 0 | False |
