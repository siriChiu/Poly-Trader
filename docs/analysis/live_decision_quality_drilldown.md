...
- feature_timestamp: **2026-05-24 04:21:38.673443**
- target: `simulated_pyramid_win`
- live path: **盤整 / 觀察 / D**
- signal: **觀望** @ confidence **0.3953**
- layers: **0 → 0**
- allowed_layers_raw_reason: 進場品質低於交易門檻
- allowed_layers_reason: 精準樣本未達最小門檻
- execution_guardrail_reason: 精準樣本未達最小門檻
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本未達最小門檻 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 1/50（缺 49），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2731；目前維持不可部署治理。
...
- runtime closure summary: **當前即時分桶 觀察｜基線觀察（市場狀態 / 偏離）｜q35 的精準樣本仍未就緒（1/50，路徑=精準樣本未達最小門檻 / 治理=目前即時分桶精準樣本未達最小門檻）；較寬範圍 / 近似樣本 目前都只屬僅供治理參考，不可視為部署閉環。 阻塞點=當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 1/50（缺 49），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2731；目前維持不可部署治理。 精準路徑與外溢對照：同品質寬範圍出現 熊市｜觀察 外溢，8 筆 / 勝率 0.0% / 品質 -0.334，明顯劣於 精準即時路徑 勝率 3.4% / 品質 -0.296。**
- q35 scaling audit: overall=bias50_formula_may_be_too_harsh / redesign=base_stack_redesign_discriminative_reweight_crosses_floor_but_執行_blocked / runtime_gap=0.0129 / mode=exact_lane_formula_review / next_patch=feat_4h_bias50_formula
- q35 runtime truth: redesign_entry_quality=0.5627 / redesign_layers_after=0 / runtime_layers=0 / blocker=精準樣本未達最小門檻 / exact_support=1/50 / support_gap=49
...
- final entry_quality: **0.5371** / trade_floor **0.55** / gap **-0.0129**
- 基礎品質: **0.5539** × 權重 **0.75**
- 結構品質: **0.4868** × 權重 **0.25**
- base components: feat_4h_bias50=0.5721 (w=0.4, contrib=0.2288), feat_nose=0.4242 (w=0.18, contrib=0.0764), feat_pulse=0.3834 (w=0.27, contrib=0.1035), feat_ear=0.968 (w=0.15, contrib=0.1452)
- structure components: feat_4h_bb_pct_b=0.8539 (w=0.34, contrib=0.2903), feat_4h_dist_bb_lower=0.262 (w=0.33, contrib=0.0865), feat_4h_dist_swing_low=0.3334 (w=0.33, contrib=0.11)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0129**
- base_group_max_entry_gain: **0.3346** | structure_group_max_entry_gain: **0.1283**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.043, max_gain≈0.1284）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.043), feat_pulse (Δscore≈0.0637), feat_nose (Δscore≈0.0956), feat_4h_dist_bb_lower (Δscore≈0.1564)
- bias50 fully relaxed: entry≈**0.6655** / layers≈**1** / required_bias50_cap≈**-0.6755**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 59 | 0.0339 | -0.2956 | 0.3418 | 0.8022 | 1 | True |
| exact `regime_label+regime_gate+entry_quality_label` | 59 | 0.0339 | -0.2956 | 0.3418 | 0.8022 | 1 | True |
| narrow `regime_label+entry_quality_label` | 59 | 0.0339 | -0.2956 | 0.3418 | 0.8022 | 1 | True |
| broad `regime_gate+entry_quality_label` | 65 | 0.0308 | -0.2992 | 0.3474 | 0.8149 | 1 | True |
