...
- feature_timestamp: **2026-05-23 10:18:05.927569**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 93 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 93 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['標籤失衡'] win_rate=0.07 avg_pnl=-0.0117 avg_品質=-0.2544 window=2026-05-21 14:01:25.932251->2026-05-22 11:12:34.311190 adverse_連續虧損筆數=93x0 (2026-05-21 15:13:35.056906->2026-05-22 11:12:34.311190) vs sibling prev_win_rate=0.37 Δwin_rate=-0.3 prev_品質=0.0534 Δ品質=-0.3078 prev_pnl=-0.0017 Δpnl=-0.01 top_shifts=feat_4h_dist_swing_low(2.0588→1.7263), feat_4h_dist_bb_lower(1.4631→1.1472), feat_4h_bb_pct_b(0.596→0.4735)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，13 筆 / 勝率 38.5% / 品質 -0.042，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6783** / trade_floor **0.55** / gap **0.1283**
- 基礎品質: **0.9024** × 權重 **0.75**
- 結構品質: **0.0062** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.8938 (w=0.18, contrib=0.1609), feat_pulse=0.7363 (w=0.27, contrib=0.1988), feat_ear=0.9511 (w=0.15, contrib=0.1427)
- structure components: feat_4h_bb_pct_b=0.0138 (w=0.34, contrib=0.0047), feat_4h_dist_bb_lower=0.0045 (w=0.33, contrib=0.0015), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.0732** | structure_group_max_entry_gain: **0.2484**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.22 | -0.1005 | 0.253 | 0.6477 | 0 | True |
