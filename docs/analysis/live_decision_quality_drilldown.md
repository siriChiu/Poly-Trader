...
- feature_timestamp: **2026-05-22 12:10:25.112669**
...
- current-bucket root cause: verdict=執行期阻塞優先於分桶根因分析 / patch=None / feature=None / exact_support=6/50 / gap=44 / neighbor=觀察｜基線觀察（市場狀態 / 偏離）｜q65
- 精準樣本修補: **未啟用** | 支持路徑 **精準樣本未達最小門檻** | 跨越門檻 **執行期阻塞優先於跨門檻分析**
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 28.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 14/50，至少還差 1 勝。 精準路徑與外溢對照：同 gate 寬範圍出現 盤整｜觀察 外溢，178 筆 / 勝率 42.6% / 品質 0.113，明顯劣於 精準即時路徑 勝率 22.7% / 品質 -0.044。**
...
- 基礎品質: **0.5975** × 權重 **0.75**
- 結構品質: **0.2324** × 權重 **0.25**
- base components: feat_4h_bias50=0.643 (w=0.4, contrib=0.2572), feat_nose=0.5155 (w=0.18, contrib=0.0928), feat_pulse=0.3681 (w=0.27, contrib=0.0994), feat_ear=0.9875 (w=0.15, contrib=0.1481)
- structure components: feat_4h_bb_pct_b=0.4593 (w=0.34, contrib=0.1562), feat_4h_dist_bb_lower=0.1391 (w=0.33, contrib=0.0459), feat_4h_dist_swing_low=0.0919 (w=0.33, contrib=0.0303)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0438**
- base_group_max_entry_gain: **0.3019** | structure_group_max_entry_gain: **0.1919**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.146, max_gain≈0.1071）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.146), feat_pulse (Δscore≈0.2163), feat_nose (Δscore≈0.3244), feat_4h_bb_pct_b (Δscore≈0.5153)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 137 | 0.3942 | 0.0879 | 0.1499 | 0.4605 | 55 | False |
