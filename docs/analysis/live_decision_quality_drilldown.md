...
- feature_timestamp: **2026-05-23 17:08:36.763298**
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 122 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，32 筆 / 勝率 15.6% / 品質 -0.169，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.5652** / trade_floor **0.55** / gap **0.0152**
- 基礎品質: **0.679** × 權重 **0.75**
- 結構品質: **0.2239** × 權重 **0.25**
- base components: feat_4h_bias50=0.9548 (w=0.4, contrib=0.3819), feat_nose=0.1844 (w=0.18, contrib=0.0332), feat_pulse=0.4507 (w=0.27, contrib=0.1217), feat_ear=0.9477 (w=0.15, contrib=0.1421)
- structure components: feat_4h_bb_pct_b=0.5034 (w=0.34, contrib=0.1712), feat_4h_dist_bb_lower=0.1597 (w=0.33, contrib=0.0527), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2408** | structure_group_max_entry_gain: **0.194**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `entry_quality_label` | 122 | 0.2213 | -0.1039 | 0.2667 | 0.6743 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 26 | 0.1923 | -0.1307 | 0.3104 | 0.7095 | 0 | False |
