...
- feature_timestamp: **2026-05-17 10:01:42.765006**
...
- runtime_blocker: circuit_breaker | reason: 最近 50 筆勝率: 8.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 8.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 4/50，至少還差 11 勝。 同時近期病態=近期範圍切片 30 筆 顯示 分佈病態 警示=['標籤失衡'] win_rate=0.0667 avg_pnl=-0.0106 avg_品質=-0.2404 window=2026-05-15 13:41:22.217602->2026-05-16 11:00:00 adverse_連續虧損筆數=28x0 (2026-05-15 13:41:22.217602->2026-05-16 09:01:34.702823)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，61 筆 / 勝率 0.0% / 品質 -0.348，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6446** / trade_floor **0.55** / gap **0.0946**
- 基礎品質: **0.7753** × 權重 **0.75**
- 結構品質: **0.2524** × 權重 **0.25**
- base components: feat_4h_bias50=0.9602 (w=0.4, contrib=0.3841), feat_nose=0.288 (w=0.18, contrib=0.0518), feat_pulse=0.7026 (w=0.27, contrib=0.1897), feat_ear=0.9977 (w=0.15, contrib=0.1497)
- structure components: feat_4h_bb_pct_b=0.5116 (w=0.34, contrib=0.1739), feat_4h_dist_bb_lower=0.1607 (w=0.33, contrib=0.053), feat_4h_dist_swing_low=0.0772 (w=0.33, contrib=0.0255)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1685** | structure_group_max_entry_gain: **0.1868**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 30 | 0.0667 | -0.2404 | 0.2723 | 0.8398 | 0 | True |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 30 | 0.0667 | -0.2404 | 0.2723 | 0.8398 | 0 | True |
| broad `regime_gate+entry_quality_label` | 4 | 0.0 | -0.2808 | 0.3076 | 0.9213 | 0 | False |
