...
- feature_timestamp: **2026-05-20 22:11:32.960610**
- target: `simulated_pyramid_win`
- live path: **盤整 / 觀察 / C**
- signal: **觀望** @ confidence **0.5988**
- layers: **1 → 0**
- allowed_layers_raw_reason: 進場品質_C_single_layer
- allowed_layers_reason: 精準樣本尚未建立
- execution_guardrail_reason: 精準樣本尚未建立
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=所有支持路徑仍不足，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.1905；目前維持不可部署治理。
...
- final entry_quality: **0.6025** / trade_floor **0.55** / gap **0.0525**
- 基礎品質: **0.7041** × 權重 **0.75**
- 結構品質: **0.2979** × 權重 **0.25**
- base components: feat_4h_bias50=0.7853 (w=0.4, contrib=0.3141), feat_nose=0.6192 (w=0.18, contrib=0.1115), feat_pulse=0.4787 (w=0.27, contrib=0.1293), feat_ear=0.9948 (w=0.15, contrib=0.1492)
- structure components: feat_4h_bb_pct_b=0.5469 (w=0.34, contrib=0.1859), feat_4h_dist_bb_lower=0.1681 (w=0.33, contrib=0.0555), feat_4h_dist_swing_low=0.1711 (w=0.33, contrib=0.0565)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.222** | structure_group_max_entry_gain: **0.1755**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.535 | 0.1546 | 0.1747 | 0.5393 | 105 | False |
...
| broad `regime_gate+entry_quality_label` | 178 | 0.5169 | 0.1466 | 0.1737 | 0.5314 | 94 | False |
