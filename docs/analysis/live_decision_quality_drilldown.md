...
- feature_timestamp: **2026-05-27 15:14:16.416552**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 127 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 127 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 127 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['constant_target'] win_rate=0.0 avg_pnl=-0.0129 avg_品質=-0.3084 window=2026-05-25 09:11:08.310435->2026-05-26 16:00:00 adverse_連續虧損筆數=100x0 (2026-05-25 09:11:08.310435->2026-05-26 16:00:00) vs sibling prev_win_rate=0.72 Δwin_rate=-0.72 prev_品質=0.3194 Δ品質=-0.6278 prev_pnl=0.0036 Δpnl=-0.0165 top_shifts=feat_4h_dist_swing_low(3.518→1.7945), feat_4h_dist_bb_lower(1.5936→1.0205), feat_4h_bb_pct_b(0.6658→0.4969)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，10 筆 / 勝率 60.0% / 品質 0.245，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6457** / trade_floor **0.55** / gap **0.0957**
- 基礎品質: **0.8577** × 權重 **0.75**
- 結構品質: **0.0096** × 權重 **0.25**
- base components: feat_4h_bias50=0.9042 (w=0.4, contrib=0.3617), feat_nose=0.8315 (w=0.18, contrib=0.1497), feat_pulse=0.7546 (w=0.27, contrib=0.2038), feat_ear=0.9507 (w=0.15, contrib=0.1426)
- structure components: feat_4h_bb_pct_b=0.0226 (w=0.34, contrib=0.0077), feat_4h_dist_bb_lower=0.0059 (w=0.33, contrib=0.002), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1066** | structure_group_max_entry_gain: **0.2476**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.36 | 0.0055 | 0.2076 | 0.5666 | 0 | True |
