...
- feature_timestamp: **2026-05-16 10:12:23.798962**
...
- runtime_blocker: circuit_breaker | reason: 連續虧損筆數： 57 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 57 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 57 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，47 筆 / 勝率 94.3% / 品質 0.623，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6921** / trade_floor **0.55** / gap **0.1421**
- 基礎品質: **0.9228** × 權重 **0.75**
- 結構品質: **0.0** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.917 (w=0.18, contrib=0.1651), feat_pulse=0.814 (w=0.27, contrib=0.2198), feat_ear=0.9197 (w=0.15, contrib=0.138)
...
- base_group_max_entry_gain: **0.0579** | structure_group_max_entry_gain: **0.25**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.465 | 0.1369 | 0.2256 | 0.5774 | 12 | False |
