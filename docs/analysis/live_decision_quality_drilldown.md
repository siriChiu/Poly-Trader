...
- feature_timestamp: **2026-04-21 07:32:22.326895**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.3750**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5559（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，60 rows / WR 0.0% / 品質 -0.264，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5559** / trade_floor **0.55** / gap **0.0059**
- base_quality: **0.603** × weight **0.75**
- structure_quality: **0.4146** × weight **0.25**
- base components: feat_4h_bias50=0.1649 (w=0.0, contrib=0.0), feat_nose=0.2694 (w=0.5, contrib=0.1347), feat_pulse=0.7656 (w=0.1, contrib=0.0766), feat_ear=0.9793 (w=0.4, contrib=0.3917)
- structure components: feat_4h_bb_pct_b=0.6704 (w=0.34, contrib=0.228), feat_4h_dist_bb_lower=0.2559 (w=0.33, contrib=0.0844), feat_4h_dist_swing_low=0.3097 (w=0.33, contrib=0.1022)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2978** | structure_group_max_entry_gain: **0.1463**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7053** / layers≈**2** / required_bias50_cap≈**-0.013**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 60 | 0.2 | -0.127 | 0.3132 | 0.7888 | 12 | True |
