...
- feature_timestamp: **2026-05-19 18:01:46.402682**
- target: `simulated_pyramid_win`
- live path: **熊市 / 觀察 / C**
- signal: **觀望** @ confidence **0.3957**
- layers: **1 → 0**
...
- final entry_quality: **0.6547** / trade_floor **0.55** / gap **0.1047**
- 基礎品質: **0.7872** × 權重 **0.75**
- 結構品質: **0.2574** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.4753 (w=0.18, contrib=0.0856), feat_pulse=0.5706 (w=0.27, contrib=0.1541), feat_ear=0.9836 (w=0.15, contrib=0.1475)
- structure components: feat_4h_bb_pct_b=0.5021 (w=0.34, contrib=0.1707), feat_4h_dist_bb_lower=0.16 (w=0.33, contrib=0.0528), feat_4h_dist_swing_low=0.1027 (w=0.33, contrib=0.0339)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1596** | structure_group_max_entry_gain: **0.1856**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 106 | 0.2358 | -0.0687 | 0.2377 | 0.6462 | 2 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 106 | 0.2358 | -0.0687 | 0.2377 | 0.6462 | 2 | False |
| narrow `regime_label+entry_quality_label` | 160 | 0.2562 | -0.0534 | 0.2158 | 0.639 | 2 | False |
| broad `regime_gate+entry_quality_label` | 106 | 0.2358 | -0.0687 | 0.2377 | 0.6462 | 2 | False |
