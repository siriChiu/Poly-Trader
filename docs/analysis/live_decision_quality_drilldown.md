...
- feature_timestamp: **2026-04-22 17:39:48.348106**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.3790**
- layers: **0 → 0**
...
- final entry_quality: **0.4023** / trade_floor **0.55** / gap **-0.1477**
- base_quality: **0.3418** × weight **0.75**
- structure_quality: **0.5837** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.4751 (w=0.18, contrib=0.0855), feat_pulse=0.4189 (w=0.27, contrib=0.1131), feat_ear=0.9547 (w=0.15, contrib=0.1432)
- structure components: feat_4h_bb_pct_b=0.8799 (w=0.34, contrib=0.2992), feat_4h_dist_bb_lower=0.3531 (w=0.33, contrib=0.1165), feat_4h_dist_swing_low=0.5091 (w=0.33, contrib=0.168)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1477**
- base_group_max_entry_gain: **0.4937** | structure_group_max_entry_gain: **0.1041**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.4923, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.4923)
- bias50 fully relaxed: entry≈**0.7023** / layers≈**0** / required_bias50_cap≈**-0.0615**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 136 | 0.6912 | 0.3286 | 0.2577 | 0.5857 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 136 | 0.6912 | 0.3286 | 0.2577 | 0.5857 | 0 | False |
