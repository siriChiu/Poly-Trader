...
- feature_timestamp: **2026-05-18 10:02:19.836904**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 12.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 6/50，至少還差 9 勝。 精準路徑與外溢對照：同 gate 寬範圍出現 盤整｜觀察 外溢，70 筆 / 勝率 0.0% / 品質 -0.316，明顯劣於 精準即時路徑 勝率 26.2% / 品質 -0.038。**
...
- final entry_quality: **0.6661** / trade_floor **0.55** / gap **0.1161**
- 基礎品質: **0.8561** × 權重 **0.75**
- 結構品質: **0.0962** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.5284 (w=0.18, contrib=0.0951), feat_pulse=0.7988 (w=0.27, contrib=0.2157), feat_ear=0.9687 (w=0.15, contrib=0.1453)
- structure components: feat_4h_bb_pct_b=0.2161 (w=0.34, contrib=0.0735), feat_4h_dist_bb_lower=0.0688 (w=0.33, contrib=0.0227), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1079** | structure_group_max_entry_gain: **0.2259**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 42 | 0.2619 | -0.0376 | 0.2012 | 0.5456 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 42 | 0.2619 | -0.0376 | 0.2012 | 0.5456 | 0 | False |
| narrow `regime_label+entry_quality_label` | 100 | 0.27 | -0.0403 | 0.1904 | 0.5912 | 0 | False |
| broad `regime_gate+entry_quality_label` | 46 | 0.2391 | -0.0587 | 0.2105 | 0.5782 | 0 | False |
