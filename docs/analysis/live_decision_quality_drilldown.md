...
- feature_timestamp: **2026-05-26 18:10:56.278013**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 66 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 66 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 66 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，114 筆 / 勝率 36.4% / 品質 0.024，明顯劣於 精準即時路徑 勝率 100.0% / 品質 0.603。**
...
- final entry_quality: **0.5491** / trade_floor **0.55** / gap **-0.0009**
- 基礎品質: **0.7321** × 權重 **0.75**
- 結構品質: **0.0** × 權重 **0.25**
- base components: feat_4h_bias50=0.7173 (w=0.4, contrib=0.2869), feat_nose=0.8234 (w=0.18, contrib=0.1482), feat_pulse=0.5786 (w=0.27, contrib=0.1562), feat_ear=0.9383 (w=0.15, contrib=0.1407)
...
- base_group_max_entry_gain: **0.2008** | structure_group_max_entry_gain: **0.25**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.003, max_gain≈0.0848）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.003), feat_pulse (Δscore≈0.0044), feat_nose (Δscore≈0.0067), feat_ear (Δscore≈0.008)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.615 | 0.2265 | 0.1308 | 0.407 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 6 | 1.0 | 0.6031 | 0.0005 | 0.005 | 0 | False |
| narrow `regime_label+entry_quality_label` | 13 | 0.9231 | 0.491 | 0.0356 | 0.0663 | 0 | False |
| broad `regime_gate+entry_quality_label` | 6 | 1.0 | 0.6031 | 0.0005 | 0.005 | 0 | False |
