...
- feature_timestamp: **2026-05-13 15:11:15.852329**
- target: `simulated_pyramid_win`
- live path: **chop / CAUTION / C**
- signal: **HOLD** @ confidence **0.3464**
- layers: **1 → 0**
...
- base_quality: **0.7619** × weight **0.75**
- structure_quality: **0.0** × weight **0.25**
- base components: feat_4h_bias50=0.803 (w=0.4, contrib=0.3212), feat_nose=0.7995 (w=0.18, contrib=0.1439), feat_pulse=0.601 (w=0.27, contrib=0.1623), feat_ear=0.897 (w=0.15, contrib=0.1345)
...
- base_group_max_entry_gain: **0.1786** | structure_group_max_entry_gain: **0.25**
