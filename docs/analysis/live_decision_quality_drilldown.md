...
- feature_timestamp: **2026-05-19 14:05:49.349442**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 28.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 14/50，至少還差 1 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['標籤失衡'] win_rate=0.19 avg_pnl=-0.0056 avg_品質=-0.1027 window=2026-05-16 18:13:08.065081->2026-05-18 15:00:00 adverse_連續虧損筆數=31x0 (2026-05-16 23:02:20.327320->2026-05-17 12:01:57.351618) vs sibling prev_win_rate=0.2727 Δwin_rate=-0.0827 prev_品質=-0.0476 Δ品質=-0.0551 prev_pnl=-0.0054 Δpnl=-0.0002 top_shifts=feat_4h_dist_bb_lower(0.399→0.9365), feat_4h_dist_swing_low(-0.2725→-0.0453), feat_4h_bb_pct_b(0.1556→0.3715)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜阻塞 外溢，103 筆 / 勝率 20.4% / 品質 -0.105，明顯劣於 精準即時路徑 勝率 18.6% / 品質 -0.108。**
...
- final entry_quality: **0.6492** / trade_floor **0.55** / gap **0.0992**
- 基礎品質: **0.779** × 權重 **0.75**
- 結構品質: **0.2597** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.5395 (w=0.18, contrib=0.0971), feat_pulse=0.4907 (w=0.27, contrib=0.1325), feat_ear=0.9959 (w=0.15, contrib=0.1494)
- structure components: feat_4h_bb_pct_b=0.4986 (w=0.34, contrib=0.1695), feat_4h_dist_bb_lower=0.1597 (w=0.33, contrib=0.0527), feat_4h_dist_swing_low=0.1136 (w=0.33, contrib=0.0375)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1658** | structure_group_max_entry_gain: **0.185**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 155 | 0.2194 | -0.0831 | 0.2281 | 0.6707 | 2 | True |
| exact `regime_label+regime_gate+entry_quality_label` | 97 | 0.1856 | -0.1076 | 0.2554 | 0.6985 | 2 | True |
| narrow `regime_label+entry_quality_label` | 155 | 0.2194 | -0.0831 | 0.2281 | 0.6707 | 2 | True |
| broad `regime_gate+entry_quality_label` | 97 | 0.1856 | -0.1076 | 0.2554 | 0.6985 | 2 | True |
...
- worst_pathology_scope: **regime_label+entry_quality_label** rows=155 win_rate=0.2194 quality=-0.0831
