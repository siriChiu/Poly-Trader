...
- feature_timestamp: **2026-04-23 11:01:07.374540**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.4554**
- layers: **0 → 0**
...
- base_quality: **0.4925** × weight **0.75**
- structure_quality: **0.2381** × weight **0.25**
- base components: feat_4h_bias50=0.0942 (w=0.4, contrib=0.0377), feat_nose=0.6953 (w=0.18, contrib=0.1251), feat_pulse=0.6824 (w=0.27, contrib=0.1843), feat_ear=0.9695 (w=0.15, contrib=0.1454)
- structure components: feat_4h_bb_pct_b=0.2662 (w=0.34, contrib=0.0905), feat_4h_dist_bb_lower=0.1102 (w=0.33, contrib=0.0364), feat_4h_dist_swing_low=0.3371 (w=0.33, contrib=0.1113)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1211**
- base_group_max_entry_gain: **0.3805** | structure_group_max_entry_gain: **0.1905**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.4037, max_gain≈0.2717）
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 407 | 0.4373 | 0.1438 | 0.2147 | 0.5625 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 407 | 0.4373 | 0.1438 | 0.2147 | 0.5625 | 0 | False |
