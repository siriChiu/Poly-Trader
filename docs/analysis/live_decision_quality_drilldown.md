...
- feature_timestamp: **2026-05-20 03:13:57.762992**
- target: `simulated_pyramid_win`
- live path: **熊市 / 觀察 / B**
- signal: **觀望** @ confidence **0.3971**
- layers: **2 → 0**
...
- deployment_blocker: 精準樣本未達最小門檻 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 2/50（缺 48），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.0312；目前維持不可部署治理。
...
- final entry_quality: **0.6944** / trade_floor **0.55** / gap **0.1444**
- 基礎品質: **0.8554** × 權重 **0.75**
- 結構品質: **0.2116** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.5646 (w=0.18, contrib=0.1016), feat_pulse=0.7667 (w=0.27, contrib=0.207), feat_ear=0.9783 (w=0.15, contrib=0.1467)
- structure components: feat_4h_bb_pct_b=0.4197 (w=0.34, contrib=0.1427), feat_4h_dist_bb_lower=0.1349 (w=0.33, contrib=0.0445), feat_4h_dist_swing_low=0.074 (w=0.33, contrib=0.0244)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1084** | structure_group_max_entry_gain: **0.1971**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 200 | 0.295 | -0.0123 | 0.1937 | 0.5974 | 34 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 13 | 0.4615 | 0.0628 | 0.2258 | 0.6489 | 2 | False |
| narrow `regime_label+entry_quality_label` | 19 | 0.4211 | 0.0564 | 0.2 | 0.4832 | 2 | False |
| broad `regime_gate+entry_quality_label` | 13 | 0.4615 | 0.0628 | 0.2258 | 0.6489 | 2 | False |
