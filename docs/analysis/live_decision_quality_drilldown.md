...
- feature_timestamp: **2026-04-24 01:02:30.271505**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.6199**
- layers: **0 → 0**
...
- final entry_quality: **0.3606** / trade_floor **0.55** / gap **-0.1894**
- base_quality: **0.3421** × weight **0.75**
- structure_quality: **0.4162** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.3836 (w=0.18, contrib=0.069), feat_pulse=0.4628 (w=0.27, contrib=0.125), feat_ear=0.9873 (w=0.15, contrib=0.1481)
- structure components: feat_4h_bb_pct_b=0.5762 (w=0.34, contrib=0.1959), feat_4h_dist_bb_lower=0.2243 (w=0.33, contrib=0.074), feat_4h_dist_swing_low=0.4434 (w=0.33, contrib=0.1463)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1894**
- base_group_max_entry_gain: **0.4934** | structure_group_max_entry_gain: **0.1459**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.6313, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.6313)
- bias50 fully relaxed: entry≈**0.6606** / layers≈**0** / required_bias50_cap≈**-0.7565**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 492 | 0.561 | 0.1884 | 0.2765 | 0.6546 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 492 | 0.561 | 0.1884 | 0.2765 | 0.6546 | 0 | False |
