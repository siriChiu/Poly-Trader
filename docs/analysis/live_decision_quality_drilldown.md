...
- feature_timestamp: **2026-05-18 12:11:57.964453**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 20.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 10/50，至少還差 5 勝。 精準路徑與外溢對照：同 gate 寬範圍出現 盤整｜觀察 外溢，69 筆 / 勝率 0.0% / 品質 -0.316，明顯劣於 精準即時路徑 勝率 23.3% / 品質 -0.104。**
...
- final entry_quality: **0.5968** / trade_floor **0.55** / gap **0.0468**
- 基礎品質: **0.7248** × 權重 **0.75**
- 結構品質: **0.2127** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.3555 (w=0.18, contrib=0.064), feat_pulse=0.4233 (w=0.27, contrib=0.1143), feat_ear=0.9766 (w=0.15, contrib=0.1465)
- structure components: feat_4h_bb_pct_b=0.4775 (w=0.34, contrib=0.1624), feat_4h_dist_bb_lower=0.1525 (w=0.33, contrib=0.0503), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2064** | structure_group_max_entry_gain: **0.1968**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 43 | 0.2326 | -0.1038 | 0.2423 | 0.6439 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 43 | 0.2326 | -0.1038 | 0.2423 | 0.6439 | 0 | False |
| narrow `regime_label+entry_quality_label` | 101 | 0.2574 | -0.0685 | 0.208 | 0.6326 | 0 | False |
| broad `regime_gate+entry_quality_label` | 47 | 0.2128 | -0.1189 | 0.2478 | 0.6675 | 1 | False |
