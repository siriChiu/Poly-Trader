...
- feature_timestamp: **2026-04-30 03:02:11.116119**
- target: `simulated_pyramid_win`
- live path: **bear / BLOCK / C**
- signal: **HOLD** @ confidence **0.4450**
- layers: **0 → 0**
...
- final entry_quality: **0.6157** / trade_floor **0.55** / gap **0.0657**
- base_quality: **0.7763** × weight **0.75**
- structure_quality: **0.1339** × weight **0.25**
- base components: feat_4h_bias50=0.9294 (w=0.4, contrib=0.3717), feat_nose=0.3985 (w=0.18, contrib=0.0717), feat_pulse=0.7082 (w=0.27, contrib=0.1912), feat_ear=0.944 (w=0.15, contrib=0.1416)
- structure components: feat_4h_bb_pct_b=0.2874 (w=0.34, contrib=0.0977), feat_4h_dist_bb_lower=0.1011 (w=0.33, contrib=0.0334), feat_4h_dist_swing_low=0.0086 (w=0.33, contrib=0.0029)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1678** | structure_group_max_entry_gain: **0.2166**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 100 | 0.24 | -0.057 | 0.2492 | 0.6371 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 2 | 0.0 | -0.1663 | 0.3489 | 0.5299 | 0 | False |
