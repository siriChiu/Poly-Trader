...
- feature_timestamp: **2026-05-17 09:01:44.593847**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 2.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 1/50，至少還差 14 勝。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜阻塞 外溢，82 筆 / 勝率 20.3% / 品質 -0.092，明顯劣於 精準即時路徑 勝率 100.0% / 品質 0.684。**
...
- final entry_quality: **0.6184** / trade_floor **0.55** / gap **0.0684**
- 基礎品質: **0.7524** × 權重 **0.75**
- 結構品質: **0.2162** × 權重 **0.25**
- base components: feat_4h_bias50=0.9993 (w=0.4, contrib=0.3997), feat_nose=0.3272 (w=0.18, contrib=0.0589), feat_pulse=0.5359 (w=0.27, contrib=0.1447), feat_ear=0.9941 (w=0.15, contrib=0.1491)
- structure components: feat_4h_bb_pct_b=0.445 (w=0.34, contrib=0.1513), feat_4h_dist_bb_lower=0.1398 (w=0.33, contrib=0.0461), feat_4h_dist_swing_low=0.0569 (w=0.33, contrib=0.0188)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1857** | structure_group_max_entry_gain: **0.196**
...
| narrow `regime_label+entry_quality_label` | 60 | 0.5333 | 0.235 | 0.1792 | 0.5435 | 21 | False |
