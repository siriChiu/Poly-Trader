...
- feature_timestamp: **2026-05-23 11:15:03.694725**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 97 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 97 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 97 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['標籤失衡'] win_rate=0.03 avg_pnl=-0.0128 avg_品質=-0.2926 window=2026-05-21 15:00:00->2026-05-22 12:10:25.112669 adverse_連續虧損筆數=97x0 (2026-05-21 15:13:35.056906->2026-05-22 12:10:25.112669) vs sibling prev_win_rate=0.4 Δwin_rate=-0.37 prev_品質=0.0706 Δ品質=-0.3632 prev_pnl=-0.0015 Δpnl=-0.0113 top_shifts=feat_4h_dist_swing_low(2.0486→1.7065), feat_4h_dist_bb_lower(1.4337→1.1625), feat_4h_bb_pct_b(0.5843→0.4798)。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，128 筆 / 勝率 29.3% / 品質 -0.042，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6644** / trade_floor **0.55** / gap **0.1144**
- 基礎品質: **0.8805** × 權重 **0.75**
- 結構品質: **0.0161** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.8374 (w=0.18, contrib=0.1507), feat_pulse=0.695 (w=0.27, contrib=0.1877), feat_ear=0.9471 (w=0.15, contrib=0.1421)
- structure components: feat_4h_bb_pct_b=0.0361 (w=0.34, contrib=0.0123), feat_4h_dist_bb_lower=0.0116 (w=0.33, contrib=0.0038), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.0898** | structure_group_max_entry_gain: **0.2459**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.215 | -0.111 | 0.2604 | 0.6617 | 0 | True |
