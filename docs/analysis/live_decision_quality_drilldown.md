...
- feature_timestamp: **2026-04-21 00:52:45.941761**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.4173**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5685（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，108 rows / WR 0.0% / 品質 -0.233，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5685** / trade_floor **0.55** / gap **0.0185**
- base_quality: **0.6246** × weight **0.75**
- structure_quality: **0.4001** × weight **0.25**
- base components: feat_4h_bias50=0.1761 (w=0.0, contrib=0.0), feat_nose=0.3469 (w=0.55, contrib=0.1908), feat_pulse=0.9641 (w=0.45, contrib=0.4338), feat_ear=0.9996 (w=0.0, contrib=0.0)
- structure components: feat_4h_bb_pct_b=0.6519 (w=0.34, contrib=0.2217), feat_4h_dist_bb_lower=0.2496 (w=0.33, contrib=0.0824), feat_4h_dist_swing_low=0.2911 (w=0.33, contrib=0.0961)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2815** | structure_group_max_entry_gain: **0.15**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7545** / layers≈**2** / required_bias50_cap≈**0.8095**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 108 | 0.1111 | -0.1604 | 0.2632 | 0.7013 | 12 | True |
