...
- feature_timestamp: **2026-04-24 15:00:53.067369**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.4796**
- layers: **0 → 0**
...
- final entry_quality: **0.4291** / trade_floor **0.55** / gap **-0.1209**
- base_quality: **0.4823** × weight **0.75**
- structure_quality: **0.2696** × weight **0.25**
- base components: feat_4h_bias50=0.0966 (w=0.4, contrib=0.0387), feat_nose=0.5622 (w=0.18, contrib=0.1012), feat_pulse=0.7238 (w=0.27, contrib=0.1954), feat_ear=0.9798 (w=0.15, contrib=0.147)
- structure components: feat_4h_bb_pct_b=0.4892 (w=0.34, contrib=0.1663), feat_4h_dist_bb_lower=0.1881 (w=0.33, contrib=0.0621), feat_4h_dist_swing_low=0.1248 (w=0.33, contrib=0.0412)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1209**
- base_group_max_entry_gain: **0.3883** | structure_group_max_entry_gain: **0.1826**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.403, max_gain≈0.271）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.403)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 42 | 0.5238 | 0.1755 | 0.1991 | 0.3384 | 35 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 42 | 0.5238 | 0.1755 | 0.1991 | 0.3384 | 35 | False |
| narrow `regime_label+entry_quality_label` | 708 | 0.5734 | 0.1888 | 0.2647 | 0.6178 | 35 | False |
| broad `regime_gate+entry_quality_label` | 42 | 0.5238 | 0.1755 | 0.1991 | 0.3384 | 35 | False |
