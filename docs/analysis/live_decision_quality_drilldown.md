...
- feature_timestamp: **2026-05-23 18:19:42.413188**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 12.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 6/50，至少還差 9 勝。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，122 筆 / 勝率 18.9% / 品質 -0.125，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.5591** / trade_floor **0.55** / gap **0.0091**
- 基礎品質: **0.6514** × 權重 **0.75**
- 結構品質: **0.2823** × 權重 **0.25**
- base components: feat_4h_bias50=0.8764 (w=0.4, contrib=0.3506), feat_nose=0.1232 (w=0.18, contrib=0.0222), feat_pulse=0.5165 (w=0.27, contrib=0.1395), feat_ear=0.9281 (w=0.15, contrib=0.1392)
- structure components: feat_4h_bb_pct_b=0.6366 (w=0.34, contrib=0.2165), feat_4h_dist_bb_lower=0.1994 (w=0.33, contrib=0.0658), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2615** | structure_group_max_entry_gain: **0.1794**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 32 | 0.3438 | -0.0432 | 0.3096 | 0.7416 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 32 | 0.3438 | -0.0432 | 0.3096 | 0.7416 | 0 | False |
