...
- feature_timestamp: **2026-04-23 09:21:36.174390**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.4253**
- layers: **0 → 0**
...
- final entry_quality: **0.4007** / trade_floor **0.55** / gap **-0.1493**
- base_quality: **0.4406** × weight **0.75**
- structure_quality: **0.281** × weight **0.25**
- base components: feat_4h_bias50=0.0367 (w=0.4, contrib=0.0147), feat_nose=0.6354 (w=0.18, contrib=0.1144), feat_pulse=0.6035 (w=0.27, contrib=0.1629), feat_ear=0.9905 (w=0.15, contrib=0.1486)
- structure components: feat_4h_bb_pct_b=0.3373 (w=0.34, contrib=0.1147), feat_4h_dist_bb_lower=0.1391 (w=0.33, contrib=0.0459), feat_4h_dist_swing_low=0.3649 (w=0.33, contrib=0.1204)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1493**
- base_group_max_entry_gain: **0.4196** | structure_group_max_entry_gain: **0.1797**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.4977, max_gain≈0.289）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.4977)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 407 | 0.4373 | 0.1447 | 0.2155 | 0.5892 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 407 | 0.4373 | 0.1447 | 0.2155 | 0.5892 | 0 | False |
