...
- feature_timestamp: **2026-05-18 09:01:47.130916**
...
- runtime closure summary: **風控熔斷啟用中：最近 50 筆勝率: 12.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 6/50，至少還差 9 勝。 精準路徑與外溢對照：同 gate 寬範圍出現 盤整｜觀察 外溢，70 筆 / 勝率 0.0% / 品質 -0.316，明顯劣於 精準即時路徑 勝率 28.6% / 品質 -0.013。**
...
- final entry_quality: **0.6637** / trade_floor **0.55** / gap **0.1137**
- 基礎品質: **0.8458** × 權重 **0.75**
- 結構品質: **0.1175** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.4014 (w=0.18, contrib=0.0722), feat_pulse=0.8628 (w=0.27, contrib=0.233), feat_ear=0.9369 (w=0.15, contrib=0.1405)
- structure components: feat_4h_bb_pct_b=0.2642 (w=0.34, contrib=0.0898), feat_4h_dist_bb_lower=0.0839 (w=0.33, contrib=0.0277), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1157** | structure_group_max_entry_gain: **0.2206**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 42 | 0.2857 | -0.0125 | 0.1947 | 0.5323 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 42 | 0.2857 | -0.0125 | 0.1947 | 0.5323 | 0 | False |
| narrow `regime_label+entry_quality_label` | 100 | 0.28 | -0.0298 | 0.1877 | 0.5856 | 0 | False |
| broad `regime_gate+entry_quality_label` | 46 | 0.2609 | -0.0358 | 0.2045 | 0.5661 | 0 | False |
