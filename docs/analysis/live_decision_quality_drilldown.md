...
- feature_timestamp: **2026-05-20 15:09:05.149234**
- target: `simulated_pyramid_win`
- live path: **盤整 / 觀察 / C**
- signal: **觀望** @ confidence **0.5955**
- layers: **1 → 0**
- allowed_layers_raw_reason: 進場品質_C_single_layer
- allowed_layers_reason: 精準樣本尚未建立
- execution_guardrail_reason: 精準樣本尚未建立
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=所有支持路徑仍不足，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.1104；目前維持不可部署治理。
...
- final entry_quality: **0.6703** / trade_floor **0.55** / gap **0.1203**
- 基礎品質: **0.7774** × 權重 **0.75**
- 結構品質: **0.3488** × 權重 **0.25**
- base components: feat_4h_bias50=0.8147 (w=0.4, contrib=0.3259), feat_nose=0.5987 (w=0.18, contrib=0.1078), feat_pulse=0.7181 (w=0.27, contrib=0.1939), feat_ear=0.9994 (w=0.15, contrib=0.1499)
- structure components: feat_4h_bb_pct_b=0.6612 (w=0.34, contrib=0.2248), feat_4h_dist_bb_lower=0.2043 (w=0.33, contrib=0.0674), feat_4h_dist_swing_low=0.1714 (w=0.33, contrib=0.0566)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.167** | structure_group_max_entry_gain: **0.1628**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.42 | 0.0687 | 0.1916 | 0.5741 | 76 | False |
...
| broad `regime_gate+entry_quality_label` | 169 | 0.4024 | 0.0582 | 0.1939 | 0.5877 | 65 | False |
