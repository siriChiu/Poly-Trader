...
- feature_timestamp: **2026-04-21 08:09:08.315057**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5645（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，58 rows / WR 0.0% / 品質 -0.263，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5645** / trade_floor **0.55** / gap **0.0145**
- base_quality: **0.6164** × weight **0.75**
- structure_quality: **0.409** × weight **0.25**
- base components: feat_4h_bias50=0.17 (w=0.0, contrib=0.0), feat_nose=0.2662 (w=0.5, contrib=0.1331), feat_pulse=0.3169 (w=0.0, contrib=0.0), feat_ear=0.9666 (w=0.5, contrib=0.4833)
- structure components: feat_4h_bb_pct_b=0.6501 (w=0.34, contrib=0.221), feat_4h_dist_bb_lower=0.2488 (w=0.33, contrib=0.0821), feat_4h_dist_swing_low=0.3207 (w=0.33, contrib=0.1058)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2877** | structure_group_max_entry_gain: **0.1477**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.6111** / layers≈**1** / required_bias50_cap≈**-1.5815**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 58 | 0.2069 | -0.1218 | 0.3152 | 0.7926 | 12 | False |
