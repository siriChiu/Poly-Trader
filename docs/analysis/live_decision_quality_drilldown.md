...
- feature_timestamp: **2026-04-20 22:15:35.699412**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.3916**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.6636（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，119 rows / WR 0.0% / 品質 -0.231，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.6636** / trade_floor **0.55** / gap **0.1136**
- base_quality: **0.7328** × weight **0.75**
- structure_quality: **0.4559** × weight **0.25**
- base components: feat_4h_bias50=0.1112 (w=0.0, contrib=0.0), feat_nose=0.7328 (w=1.0, contrib=0.7328), feat_pulse=0.6968 (w=0.0, contrib=0.0), feat_ear=0.9811 (w=0.0, contrib=0.0)
- structure components: feat_4h_bb_pct_b=0.7573 (w=0.34, contrib=0.2575), feat_4h_dist_bb_lower=0.2911 (w=0.33, contrib=0.0961), feat_4h_dist_swing_low=0.3101 (w=0.33, contrib=0.1023)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2004** | structure_group_max_entry_gain: **0.136**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7644** / layers≈**2** / required_bias50_cap≈**0.9725**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 119 | 0.1008 | -0.1653 | 0.258 | 0.7144 | 12 | True |
