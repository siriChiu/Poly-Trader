...
- feature_timestamp: **2026-05-27 14:12:08.417203**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 123 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 123 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 123 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['constant_target'] win_rate=0.0 avg_pnl=-0.0128 avg_品質=-0.303 window=2026-05-25 08:13:47.878872->2026-05-26 15:00:00 adverse_連續虧損筆數=100x0 (2026-05-25 08:13:47.878872->2026-05-26 15:00:00) vs sibling prev_win_rate=0.76 Δwin_rate=-0.76 prev_品質=0.3459 Δ品質=-0.6489 prev_pnl=0.0042 Δpnl=-0.017 top_shifts=feat_4h_dist_swing_low(3.4939→1.9275), feat_4h_dist_bb_lower(1.621→1.0577), feat_4h_bb_pct_b(0.6736→0.5135)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，7 筆 / 勝率 85.7% / 品質 0.484，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.68** / trade_floor **0.55** / gap **0.13**
- 基礎品質: **0.9067** × 權重 **0.75**
- 結構品質: **0.0** × 權重 **0.25**
- base components: feat_4h_bias50=0.9376 (w=0.4, contrib=0.3751), feat_nose=0.927 (w=0.18, contrib=0.1669), feat_pulse=0.8224 (w=0.27, contrib=0.222), feat_ear=0.9517 (w=0.15, contrib=0.1428)
...
- base_group_max_entry_gain: **0.07** | structure_group_max_entry_gain: **0.25**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.38 | 0.0214 | 0.2024 | 0.556 | 0 | True |
