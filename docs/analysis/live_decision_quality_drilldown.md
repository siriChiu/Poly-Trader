...
- feature_timestamp: **2026-05-16 17:02:21.102229**
...
- runtime_blocker: circuit_breaker | reason: 連續虧損筆數： 79 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 79 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜阻塞 外溢，36 筆 / 勝率 0.0% / 品質 -0.297，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.307。**
...
- final entry_quality: **0.5862** / trade_floor **0.55** / gap **0.0362**
- 基礎品質: **0.7356** × 權重 **0.75**
- 結構品質: **0.1379** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.2533 (w=0.18, contrib=0.0456), feat_pulse=0.5249 (w=0.27, contrib=0.1417), feat_ear=0.9888 (w=0.15, contrib=0.1483)
- structure components: feat_4h_bb_pct_b=0.3087 (w=0.34, contrib=0.1049), feat_4h_dist_bb_lower=0.0999 (w=0.33, contrib=0.033), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1983** | structure_group_max_entry_gain: **0.2156**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 100 | 0.21 | -0.1051 | 0.2898 | 0.7517 | 14 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 5 | 0.0 | -0.3071 | 0.3211 | 0.652 | 5 | False |
| narrow `regime_label+entry_quality_label` | 18 | 0.7222 | 0.4135 | 0.1527 | 0.4183 | 5 | False |
