...
- feature_timestamp: **2026-05-21 21:11:17.337237**
...
- deployment_blocker: 精準樣本未達最小門檻 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 1/50（缺 49），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.2196；目前維持不可部署治理。
...
- 基礎品質: **0.5512** × 權重 **0.75**
- 結構品質: **0.3413** × 權重 **0.25**
- base components: feat_4h_bias50=0.5922 (w=0.4, contrib=0.2369), feat_nose=0.2938 (w=0.18, contrib=0.0529), feat_pulse=0.4297 (w=0.27, contrib=0.116), feat_ear=0.9694 (w=0.15, contrib=0.1454)
- structure components: feat_4h_bb_pct_b=0.6076 (w=0.34, contrib=0.2066), feat_4h_dist_bb_lower=0.1835 (w=0.33, contrib=0.0605), feat_4h_dist_swing_low=0.2247 (w=0.33, contrib=0.0741)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0513**
- base_group_max_entry_gain: **0.3365** | structure_group_max_entry_gain: **0.1648**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.171, max_gain≈0.1223）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.171), feat_pulse (Δscore≈0.2533), feat_nose (Δscore≈0.38), feat_4h_dist_bb_lower (Δscore≈0.6218)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 67 | 0.4925 | 0.1818 | 0.0961 | 0.2827 | 18 | False |
