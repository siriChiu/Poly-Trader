...
- feature_timestamp: **2026-04-30 05:26:49.411071**
- target: `simulated_pyramid_win`
- live path: **bear / BLOCK / C**
- signal: **HOLD** @ confidence **0.4432**
- layers: **0 → 0**
...
- final entry_quality: **0.6119** / trade_floor **0.55** / gap **0.0619**
- base_quality: **0.7821** × weight **0.75**
- structure_quality: **0.1012** × weight **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.616 (w=0.18, contrib=0.1109), feat_pulse=0.4635 (w=0.27, contrib=0.1252), feat_ear=0.974 (w=0.15, contrib=0.1461)
- structure components: feat_4h_bb_pct_b=0.2213 (w=0.34, contrib=0.0752), feat_4h_dist_bb_lower=0.0787 (w=0.33, contrib=0.026), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1633** | structure_group_max_entry_gain: **0.2247**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 100 | 0.25 | -0.0459 | 0.2474 | 0.6315 | 0 | False |
