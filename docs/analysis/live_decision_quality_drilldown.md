...
- feature_timestamp: **2026-05-21 02:13:09.928568**
- target: `simulated_pyramid_win`
- live path: **盤整 / 觀察 / C**
- signal: **觀望** @ confidence **0.5745**
- layers: **1 → 0**
- allowed_layers_raw_reason: 進場品質_C_single_layer
- allowed_layers_reason: 精準樣本尚未建立
- execution_guardrail_reason: 精準樣本尚未建立
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.2547；目前維持不可部署治理。
...
- runtime closure summary: **當前即時分桶 觀察｜基線觀察（市場狀態 / 偏離）｜q35 的精準樣本仍未就緒（0/50，路徑=精準樣本尚未建立 / 治理=精準即時代理路徑僅供治理參考）；較寬範圍 / 近似樣本 目前都只屬僅供治理參考，不可視為部署閉環。 阻塞點=當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.2547；目前維持不可部署治理。 精準路徑與外溢對照：同品質寬範圍出現 熊市｜觀察 外溢，175 筆 / 勝率 59.4% / 品質 0.215，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
- q35 scaling audit: overall=bias50_formula_may_be_too_harsh / redesign=base_stack_redesign_discriminative_reweight_crosses_floor_but_執行_blocked / runtime_gap=-0.0395 / mode=exact_lane_formula_review / next_patch=feat_4h_bias50_formula
...
- 基礎品質: **0.6549** × 權重 **0.75**
- 結構品質: **0.3933** × 權重 **0.25**
- base components: feat_4h_bias50=0.6463 (w=0.4, contrib=0.2585), feat_nose=0.2981 (w=0.18, contrib=0.0537), feat_pulse=0.728 (w=0.27, contrib=0.1966), feat_ear=0.9741 (w=0.15, contrib=0.1461)
- structure components: feat_4h_bb_pct_b=0.7181 (w=0.34, contrib=0.2442), feat_4h_dist_bb_lower=0.2189 (w=0.33, contrib=0.0722), feat_4h_dist_swing_low=0.2331 (w=0.33, contrib=0.0769)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2589** | structure_group_max_entry_gain: **0.1517**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.6956** / layers≈**2** / required_bias50_cap≈**-0.8315**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.615 | 0.2275 | 0.1499 | 0.489 | 0 | False |
...
| broad `regime_gate+entry_quality_label` | 175 | 0.5943 | 0.2155 | 0.1499 | 0.4875 | 0 | False |
