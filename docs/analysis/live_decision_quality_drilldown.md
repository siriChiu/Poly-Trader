...
- feature_timestamp: **2026-05-17 01:02:39.277398**
...
- runtime_blocker: circuit_breaker | reason: 連續虧損筆數： 98 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 98 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 98 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['標籤失衡'] win_rate=0.02 avg_pnl=-0.012 avg_品質=-0.2929 window=2026-05-14 14:00:00->2026-05-16 02:01:54.246765 adverse_連續虧損筆數=98x0 (2026-05-14 15:00:00->2026-05-16 02:01:54.246765)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜阻塞 外溢，41 筆 / 勝率 0.0% / 品質 -0.301，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6958** / trade_floor **0.55** / gap **0.1458**
- 基礎品質: **0.8894** × 權重 **0.75**
- 結構品質: **0.1149** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.8858 (w=0.18, contrib=0.1594), feat_pulse=0.6819 (w=0.27, contrib=0.1841), feat_ear=0.9722 (w=0.15, contrib=0.1458)
- structure components: feat_4h_bb_pct_b=0.2595 (w=0.34, contrib=0.0882), feat_4h_dist_bb_lower=0.0807 (w=0.33, contrib=0.0266), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.0829** | structure_group_max_entry_gain: **0.2212**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 100 | 0.02 | -0.2929 | 0.3353 | 0.8538 | 33 | True |
