...
- feature_timestamp: **2026-04-22 06:16:56.930747**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.4696**
- layers: **0 → 0**
...
- final entry_quality: **0.462** / trade_floor **0.55** / gap **-0.088**
- base_quality: **0.3958** × weight **0.75**
- structure_quality: **0.6608** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.3836 (w=0.18, contrib=0.069), feat_pulse=0.6885 (w=0.27, contrib=0.1859), feat_ear=0.9388 (w=0.15, contrib=0.1408)
- structure components: feat_4h_bb_pct_b=1.0 (w=0.34, contrib=0.34), feat_4h_dist_bb_lower=0.4284 (w=0.33, contrib=0.1414), feat_4h_dist_swing_low=0.5437 (w=0.33, contrib=0.1794)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.088**
- base_group_max_entry_gain: **0.4532** | structure_group_max_entry_gain: **0.0848**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.2933, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.2933)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+entry_quality_label` | 82 | 0.4878 | 0.1272 | 0.247 | 0.6071 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 0 | None | None | None | None | 0 | False |
| narrow `regime_label+entry_quality_label` | 82 | 0.4878 | 0.1272 | 0.247 | 0.6071 | 0 | False |
