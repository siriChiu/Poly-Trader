...
- feature_timestamp: **2026-04-22 03:51:40.262725**
- target: `simulated_pyramid_win`
- live path: **bull / BLOCK / D**
- signal: **HOLD** @ confidence **0.5718**
- layers: **0 → 0**
...
- final entry_quality: **0.4294** / trade_floor **0.55** / gap **-0.1206**
- base_quality: **0.3583** × weight **0.75**
- structure_quality: **0.6428** × weight **0.25**
- base components: feat_4h_bias50=0.0 (w=0.4, contrib=0.0), feat_nose=0.1781 (w=0.18, contrib=0.0321), feat_pulse=0.6994 (w=0.27, contrib=0.1888), feat_ear=0.9158 (w=0.15, contrib=0.1374)
- structure components: feat_4h_bb_pct_b=1.0 (w=0.34, contrib=0.34), feat_4h_dist_bb_lower=0.4208 (w=0.33, contrib=0.1389), feat_4h_dist_swing_low=0.4967 (w=0.33, contrib=0.1639)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.1206**
- base_group_max_entry_gain: **0.4814** | structure_group_max_entry_gain: **0.0893**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.402, max_gain≈0.3）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.402)
