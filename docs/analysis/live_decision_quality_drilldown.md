...
- feature_timestamp: **2026-05-24 14:10:15.691539**
...
- deployment_blocker: 精準樣本尚未建立 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2351；目前維持不可部署治理。
...
- runtime closure summary: **當前即時分桶 觀察｜基線觀察（市場狀態 / 偏離）｜q35 的精準樣本仍未就緒（0/50，路徑=精準樣本尚未建立 / 治理=精準即時代理路徑僅供治理參考）；較寬範圍 / 近似樣本 目前都只屬僅供治理參考，不可視為部署閉環。 阻塞點=當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q35` 的精準支持樣本仍停在 0/50（缺 50），支持路徑=精準樣本尚未建立，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 -0.2351；目前維持不可部署治理。 精準路徑與外溢對照：同 gate 寬範圍出現 盤整｜觀察 外溢，79 筆 / 勝率 0.0% / 品質 -0.355，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.321。**
- q35 scaling audit: overall=bias50_formula_may_be_too_harsh / redesign=base_stack_redesign_discriminative_reweight_crosses_floor_but_執行_blocked / runtime_gap=-0.0203 / mode=exact_lane_formula_review / next_patch=feat_4h_bias50_formula
- q35 runtime truth: redesign_entry_quality=0.5628 / redesign_layers_after=0 / runtime_layers=0 / blocker=精準樣本尚未建立 / exact_support=0/50 / support_gap=50
...
- final entry_quality: **0.5703** / trade_floor **0.55** / gap **0.0203**
- 基礎品質: **0.6357** × 權重 **0.75**
- 結構品質: **0.3741** × 權重 **0.25**
- base components: feat_4h_bias50=0.5701 (w=0.4, contrib=0.228), feat_nose=0.6062 (w=0.18, contrib=0.1091), feat_pulse=0.5526 (w=0.27, contrib=0.1492), feat_ear=0.9959 (w=0.15, contrib=0.1494)
- structure components: feat_4h_bb_pct_b=0.603 (w=0.34, contrib=0.205), feat_4h_dist_bb_lower=0.1866 (w=0.33, contrib=0.0616), feat_4h_dist_swing_low=0.3258 (w=0.33, contrib=0.1075)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2733** | structure_group_max_entry_gain: **0.1564**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.6993** / layers≈**2** / required_bias50_cap≈**-0.4505**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `entry_quality_label` | 138 | 0.529 | 0.2227 | 0.2594 | 0.642 | 0 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 37 | 0.0 | -0.321 | 0.3658 | 0.8173 | 0 | True |
| narrow `regime_label+entry_quality_label` | 37 | 0.0 | -0.321 | 0.3658 | 0.8173 | 0 | True |
| broad `regime_gate+entry_quality_label` | 63 | 0.0952 | -0.2479 | 0.3689 | 0.8545 | 0 | True |
