...
- feature_timestamp: **2026-04-20 21:28:25.512019**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.4165**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5761（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，122 rows / WR 0.0% / 品質 -0.230，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5761** / trade_floor **0.55** / gap **0.0261**
- base_quality: **0.6254** × weight **0.75**
- structure_quality: **0.4281** × weight **0.25**
- base components: feat_4h_bias50=0.1469 (w=0.0, contrib=0.0), feat_nose=0.6254 (w=1.0, contrib=0.6254), feat_pulse=0.6686 (w=0.0, contrib=0.0), feat_ear=0.9884 (w=0.0, contrib=0.0)
- structure components: feat_4h_bb_pct_b=0.7096 (w=0.34, contrib=0.2413), feat_4h_dist_bb_lower=0.2734 (w=0.33, contrib=0.0902), feat_4h_dist_swing_low=0.2928 (w=0.33, contrib=0.0966)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.281** | structure_group_max_entry_gain: **0.1429**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.738** / layers≈**2** / required_bias50_cap≈**0.534**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 122 | 0.0984 | -0.1663 | 0.2566 | 0.7161 | 12 | True |
