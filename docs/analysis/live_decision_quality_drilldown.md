...
- feature_timestamp: **2026-05-13 18:08:21.474122**
...
- runtime closure summary: **circuit breaker active：Recent 50-sample win rate: 28.00% < 30%; release condition = streak < 50 且 recent 50 win rate >= 30%；目前 recent 50 只贏 14/50，至少還差 1 勝。 exact-vs-spillover=同 quality 寬 scope 出現 bull|BLOCK spillover，447 rows / WR 20.2% / 品質 -0.058，明顯劣於 exact live lane WR 58.0% / 品質 0.214。**
...
- base_quality: **0.695** × weight **0.75**
- structure_quality: **0.0618** × weight **0.25**
- base components: feat_4h_bias50=0.7882 (w=0.4, contrib=0.3153), feat_nose=0.4871 (w=0.18, contrib=0.0877), feat_pulse=0.5843 (w=0.27, contrib=0.1578), feat_ear=0.8949 (w=0.15, contrib=0.1342)
- structure components: feat_4h_bb_pct_b=0.1422 (w=0.34, contrib=0.0484), feat_4h_dist_bb_lower=0.0407 (w=0.33, contrib=0.0134), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0133**
- base_group_max_entry_gain: **0.2287** | structure_group_max_entry_gain: **0.2345**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.0443, max_gain≈0.0635）
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label+regime_gate+entry_quality_label` | 450 | 0.58 | 0.2137 | 0.1407 | 0.4627 | 37 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 450 | 0.58 | 0.2137 | 0.1407 | 0.4627 | 37 | False |
| narrow `regime_label+entry_quality_label` | 450 | 0.58 | 0.2137 | 0.1407 | 0.4627 | 37 | False |
| broad `regime_gate+entry_quality_label` | 503 | 0.5666 | 0.2049 | 0.1451 | 0.4679 | 37 | False |
