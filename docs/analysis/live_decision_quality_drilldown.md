...
- feature_timestamp: **2026-04-20 20:06:27.172117**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.4226**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5507（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，127 rows / WR 0.0% / 品質 -0.231，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5507** / trade_floor **0.55** / gap **0.0007**
- base_quality: **0.578** × weight **0.75**
- structure_quality: **0.4685** × weight **0.25**
- base components: feat_4h_bias50=0.095 (w=0.0, contrib=0.0), feat_nose=0.5122 (w=0.85, contrib=0.4354), feat_pulse=0.3562 (w=0.0, contrib=0.0), feat_ear=0.9511 (w=0.15, contrib=0.1427)
- structure components: feat_4h_bb_pct_b=0.7789 (w=0.34, contrib=0.2648), feat_4h_dist_bb_lower=0.2992 (w=0.33, contrib=0.0987), feat_4h_dist_swing_low=0.318 (w=0.33, contrib=0.1049)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.3165** | structure_group_max_entry_gain: **0.1329**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.6654** / layers≈**1** / required_bias50_cap≈**-0.6765**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 127 | 0.0945 | -0.1692 | 0.2555 | 0.7255 | 12 | True |
