...
- feature_timestamp: **2026-05-28 01:08:05.923225**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 164 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 164 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 164 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['constant_target'] win_rate=0.0 avg_pnl=-0.0135 avg_品質=-0.3185 window=2026-05-25 19:08:45.296826->2026-05-27 02:00:00 adverse_連續虧損筆數=100x0 (2026-05-25 19:08:45.296826->2026-05-27 02:00:00) vs sibling prev_win_rate=0.35 Δwin_rate=-0.35 prev_品質=0.0452 Δ品質=-0.3637 prev_pnl=-0.003 Δpnl=-0.0105 top_shifts=feat_4h_dist_swing_low(3.3112→0.6845), feat_4h_dist_bb_lower(1.4555→0.5482), feat_4h_bb_pct_b(0.6496→0.2711)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜阻塞 外溢，36 筆 / 勝率 0.0% / 品質 -0.309，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.300。**
...
- final entry_quality: **0.6054** / trade_floor **0.55** / gap **0.0554**
- 基礎品質: **0.7953** × 權重 **0.75**
- 結構品質: **0.0357** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.7349 (w=0.18, contrib=0.1323), feat_pulse=0.4425 (w=0.27, contrib=0.1195), feat_ear=0.957 (w=0.15, contrib=0.1436)
- structure components: feat_4h_bb_pct_b=0.0832 (w=0.34, contrib=0.0283), feat_4h_dist_bb_lower=0.0223 (w=0.33, contrib=0.0074), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1535** | structure_group_max_entry_gain: **0.2411**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.175 | -0.1367 | 0.242 | 0.64 | 30 | True |
