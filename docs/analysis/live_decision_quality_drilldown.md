...
- feature_timestamp: **2026-05-19 17:20:50.898762**
- target: `simulated_pyramid_win`
- live path: **熊市 / 觀察 / C**
- signal: **觀望** @ confidence **0.3538**
- layers: **1 → 0**
...
- final entry_quality: **0.6449** / trade_floor **0.55** / gap **0.0949**
- 基礎品質: **0.7612** × 權重 **0.75**
- 結構品質: **0.2961** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.4125 (w=0.18, contrib=0.0743), feat_pulse=0.5138 (w=0.27, contrib=0.1387), feat_ear=0.9879 (w=0.15, contrib=0.1482)
- structure components: feat_4h_bb_pct_b=0.5739 (w=0.34, contrib=0.1951), feat_4h_dist_bb_lower=0.1812 (w=0.33, contrib=0.0598), feat_4h_dist_swing_low=0.1246 (w=0.33, contrib=0.0411)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.1792** | structure_group_max_entry_gain: **0.176**
