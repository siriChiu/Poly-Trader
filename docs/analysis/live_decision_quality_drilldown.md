...
- feature_timestamp: **2026-05-23 09:40:24.602822**
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 89 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['標籤失衡'] win_rate=0.11 avg_pnl=-0.0108 avg_品質=-0.2198 window=2026-05-21 13:08:02.506654->2026-05-22 10:12:46.467502 adverse_連續虧損筆數=89x0 (2026-05-21 15:13:35.056906->2026-05-22 10:12:46.467502) vs sibling prev_win_rate=0.33 Δwin_rate=-0.22 prev_品質=0.0314 Δ品質=-0.2512 prev_pnl=-0.002 Δpnl=-0.0088 top_shifts=feat_4h_dist_bb_lower(1.4934→1.145), feat_4h_dist_swing_low(2.0707→1.7599), feat_4h_bb_pct_b(0.6082→0.4726)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜觀察 外溢，11 筆 / 勝率 45.5% / 品質 0.026，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.6906** / trade_floor **0.55** / gap **0.1406**
- 基礎品質: **0.9208** × 權重 **0.75**
- 結構品質: **0.0** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.9531 (w=0.18, contrib=0.1716), feat_pulse=0.7668 (w=0.27, contrib=0.207), feat_ear=0.9479 (w=0.15, contrib=0.1422)
...
- base_group_max_entry_gain: **0.0594** | structure_group_max_entry_gain: **0.25**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.22 | -0.0942 | 0.247 | 0.6371 | 0 | True |
