...
- feature_timestamp: **2026-04-20 14:07:08.841646**
- target: `simulated_pyramid_win`
- live path: **chop / CAUTION / D**
- signal: **HOLD** @ confidence **0.2090**
- layers: **0 → 0**
...
- final entry_quality: **0.4839** / trade_floor **0.55** / gap **-0.0661**
- base_quality: **0.5191** × weight **0.75**
- structure_quality: **0.3783** × weight **0.25**
- base components: feat_4h_bias50=0.2741 (w=0.4, contrib=0.1097), feat_nose=0.511 (w=0.18, contrib=0.092), feat_pulse=0.6379 (w=0.27, contrib=0.1722), feat_ear=0.9683 (w=0.15, contrib=0.1452)
- structure components: feat_4h_bb_pct_b=0.6257 (w=0.34, contrib=0.2127), feat_4h_dist_bb_lower=0.2421 (w=0.33, contrib=0.0799), feat_4h_dist_swing_low=0.2596 (w=0.33, contrib=0.0857)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0661**
- base_group_max_entry_gain: **0.3607** | structure_group_max_entry_gain: **0.1554**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.2203, max_gain≈0.2178）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.2203), feat_pulse (Δscore≈0.3264)
- bias50 fully relaxed: entry≈**0.7017** / layers≈**2** / required_bias50_cap≈**-0.072**
...
| broad `regime_gate+entry_quality_label` | 55 | 0.4545 | 0.0625 | 0.3673 | 0.6808 | 0 | False |
