...
- feature_timestamp: **2026-04-29 23:13:29.813464**
- target: `simulated_pyramid_win`
- live path: **bear / CAUTION / C**
- signal: **HOLD** @ confidence **0.4740**
- layers: **1 → 0**
...
- structure_quality: **0.1579** × weight **0.25**
- base components: feat_4h_bias50=0.8616 (w=0.4, contrib=0.3446), feat_nose=0.4943 (w=0.18, contrib=0.089), feat_pulse=0.47 (w=0.27, contrib=0.1269), feat_ear=0.8968 (w=0.15, contrib=0.1345)
- structure components: feat_4h_bb_pct_b=0.3161 (w=0.34, contrib=0.1075), feat_4h_dist_bb_lower=0.111 (w=0.33, contrib=0.0366), feat_4h_dist_swing_low=0.0419 (w=0.33, contrib=0.0138)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2287** | structure_group_max_entry_gain: **0.2104**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 400 | 0.3825 | 0.061 | 0.1744 | 0.574 | 34 | False |
