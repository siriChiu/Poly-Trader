...
- feature_timestamp: **2026-04-20 23:49:40.799393**
- target: `simulated_pyramid_win`
- live path: **bull / CAUTION / C**
- signal: **HOLD** @ confidence **0.3382**
- layers: **1 → 0**
...
- runtime closure summary: **q35 discriminative redesign 已啟用並把 entry_quality 拉到 0.5871（raw layers=1），但最終 execution 仍被 under_minimum_exact_live_structure_bucket 擋住；目前不可把 patch active 誤讀成可部署。 exact-vs-spillover=同 regime 寬 scope 出現 bull|BLOCK spillover，112 rows / WR 0.0% / 品質 -0.233，明顯劣於 exact live lane WR — / 品質 —。**
...
- final entry_quality: **0.5871** / trade_floor **0.55** / gap **0.0371**
- base_quality: **0.6457** × weight **0.75**
- structure_quality: **0.4114** × weight **0.25**
- base components: feat_4h_bias50=0.1684 (w=0.0, contrib=0.0), feat_nose=0.6457 (w=1.0, contrib=0.6457), feat_pulse=0.7485 (w=0.0, contrib=0.0), feat_ear=0.9752 (w=0.0, contrib=0.0)
- structure components: feat_4h_bb_pct_b=0.6807 (w=0.34, contrib=0.2315), feat_4h_dist_bb_lower=0.2628 (w=0.33, contrib=0.0867), feat_4h_dist_swing_low=0.2823 (w=0.33, contrib=0.0932)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0**
- base_group_max_entry_gain: **0.2657** | structure_group_max_entry_gain: **0.1471**
- best_single_component: **None**（group=None, Δscore≈None, max_gain≈None）
- single-component floor crossers: None
- bias50 fully relaxed: entry≈**0.7513** / layers≈**2** / required_bias50_cap≈**0.7545**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 112 | 0.1071 | -0.1628 | 0.2615 | 0.7089 | 12 | True |
