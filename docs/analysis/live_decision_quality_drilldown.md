...
- feature_timestamp: **2026-05-22 04:11:56.675626**
- target: `simulated_pyramid_win`
- live path: **盤整 / 觀察 / D**
- signal: **觀望** @ confidence **0.5940**
- layers: **0 → 0**
- allowed_layers_raw_reason: 進場品質低於交易門檻
- allowed_layers_reason: 精準樣本未達最小門檻
- execution_guardrail_reason: 精準樣本未達最小門檻
- runtime_blocker: None | reason: None
- deployment_blocker: 精準樣本未達最小門檻 | reason: 當前即時結構分桶 `觀察｜基線觀察（市場狀態 / 偏離）｜q15` 的精準支持樣本仍停在 1/50（缺 49），支持路徑=精準樣本未達最小門檻，不可把舊範圍的支持閉環誤讀成部署閉環；決策品質仍為 D / 品質分數 0.1447；目前維持不可部署治理。
...
- final entry_quality: **0.4887** / trade_floor **0.55** / gap **-0.0613**
- 基礎品質: **0.5363** × 權重 **0.75**
- 結構品質: **0.3457** × 權重 **0.25**
- base components: feat_4h_bias50=0.558 (w=0.4, contrib=0.2232), feat_nose=0.2921 (w=0.18, contrib=0.0526), feat_pulse=0.4154 (w=0.27, contrib=0.1122), feat_ear=0.9891 (w=0.15, contrib=0.1484)
- structure components: feat_4h_bb_pct_b=0.611 (w=0.34, contrib=0.2077), feat_4h_dist_bb_lower=0.1855 (w=0.33, contrib=0.0612), feat_4h_dist_swing_low=0.2327 (w=0.33, contrib=0.0768)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0613**
- base_group_max_entry_gain: **0.3478** | structure_group_max_entry_gain: **0.1636**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.2043, max_gain≈0.1326）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.2043), feat_pulse (Δscore≈0.3027), feat_nose (Δscore≈0.4541), feat_4h_dist_bb_lower (Δscore≈0.743)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `regime_label` | 97 | 0.4124 | 0.1122 | 0.1383 | 0.4123 | 26 | False |
| exact `regime_label+regime_gate+entry_quality_label` | 15 | 0.2 | -0.0572 | 0.2293 | 0.7063 | 1 | False |
| narrow `regime_label+entry_quality_label` | 15 | 0.2 | -0.0572 | 0.2293 | 0.7063 | 1 | False |
| broad `regime_gate+entry_quality_label` | 15 | 0.2 | -0.0572 | 0.2293 | 0.7063 | 1 | False |
