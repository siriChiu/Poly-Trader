...
- feature_timestamp: **2026-05-27 23:06:57.634994**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 162 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 162 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 162 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['constant_target'] win_rate=0.0 avg_pnl=-0.0135 avg_品質=-0.3192 window=2026-05-25 19:00:00->2026-05-27 00:00:00 adverse_連續虧損筆數=100x0 (2026-05-25 19:00:00->2026-05-27 00:00:00) vs sibling prev_win_rate=0.37 Δwin_rate=-0.37 prev_品質=0.0655 Δ品質=-0.3847 prev_pnl=-0.0023 Δpnl=-0.0112 top_shifts=feat_4h_dist_swing_low(3.3367→0.7294), feat_4h_dist_bb_lower(1.4555→0.5653), feat_4h_bb_pct_b(0.6475→0.2794)。 精準路徑與外溢對照：同 regime 寬範圍出現 熊市｜阻塞 外溢，35 筆 / 勝率 0.0% / 品質 -0.303，明顯劣於 精準即時路徑 勝率 0.0% / 品質 -0.300。**
...
- final entry_quality: **0.6359** / trade_floor **0.55** / gap **0.0859**
- 基礎品質: **0.8479** × 權重 **0.75**
- 結構品質: **0.0** × 權重 **0.25**
- base components: feat_4h_bias50=1.0 (w=0.4, contrib=0.4), feat_nose=0.6396 (w=0.18, contrib=0.1151), feat_pulse=0.7008 (w=0.27, contrib=0.1892), feat_ear=0.9567 (w=0.15, contrib=0.1435)
...
- base_group_max_entry_gain: **0.1142** | structure_group_max_entry_gain: **0.25**
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.185 | -0.1268 | 0.2386 | 0.633 | 28 | True |
| exact `regime_label+regime_gate+entry_quality_label` | 7 | 0.0 | -0.2998 | 0.3032 | 0.6474 | 7 | False |
| narrow `regime_label+entry_quality_label` | 12 | 0.25 | -0.066 | 0.2302 | 0.5159 | 7 | False |
