...
- feature_timestamp: **2026-05-27 12:17:18.456226**
...
- runtime_blocker: 風控熔斷 | reason: 連續虧損筆數： 119 >= 50; 最近 50 筆勝率: 0.00% < 30%
- deployment_blocker: 風控熔斷啟用中 | reason: 連續虧損筆數： 119 >= 50; 最近 50 筆勝率: 0.00% < 30%
...
- runtime closure summary: **風控熔斷啟用中：連續虧損筆數： 119 >= 50; 最近 50 筆勝率: 0.00% < 30%；解除條件：連續虧損筆數 < 50 且最近 50 筆勝率 >= 30%；目前最近 50 筆只贏 0/50，至少還差 15 勝。 同時近期病態=近期範圍切片 100 筆 顯示 分佈病態 警示=['constant_target'] win_rate=0.0 avg_pnl=-0.0125 avg_品質=-0.2969 window=2026-05-25 06:34:20.218454->2026-05-26 12:59:11.166710 adverse_連續虧損筆數=100x0 (2026-05-25 06:34:20.218454->2026-05-26 12:59:11.166710) vs sibling prev_win_rate=0.8 Δwin_rate=-0.8 prev_品質=0.3721 Δ品質=-0.669 prev_pnl=0.0048 Δpnl=-0.0173 top_shifts=feat_4h_dist_swing_low(3.4645→2.0465), feat_4h_dist_bb_lower(1.6417→1.0866), feat_4h_bb_pct_b(0.679→0.5254)。 精準路徑與外溢對照：同品質寬範圍出現 盤整｜觀察 外溢，144 筆 / 勝率 21.5% / 品質 -0.109，明顯劣於 精準即時路徑 勝率 — / 品質 —。**
...
- final entry_quality: **0.5466** / trade_floor **0.55** / gap **-0.0034**
- 基礎品質: **0.6887** × 權重 **0.75**
- 結構品質: **0.1203** × 權重 **0.25**
- base components: feat_4h_bias50=0.7729 (w=0.4, contrib=0.3092), feat_nose=0.6913 (w=0.18, contrib=0.1244), feat_pulse=0.3979 (w=0.27, contrib=0.1074), feat_ear=0.9845 (w=0.15, contrib=0.1477)
- structure components: feat_4h_bb_pct_b=0.2837 (w=0.34, contrib=0.0965), feat_4h_dist_bb_lower=0.0723 (w=0.33, contrib=0.0239), feat_4h_dist_swing_low=0.0 (w=0.33, contrib=0.0)

## Gap attribution（哪個 component 真正在卡 floor）

- remaining_gap_to_floor: **0.0034**
- base_group_max_entry_gain: **0.2334** | structure_group_max_entry_gain: **0.2199**
- best_single_component: **feat_4h_bias50**（group=base, Δscore≈0.0113, max_gain≈0.0681）
- single-component floor crossers: feat_4h_bias50 (Δscore≈0.0113), feat_pulse (Δscore≈0.0168), feat_nose (Δscore≈0.0252), feat_4h_bb_pct_b (Δscore≈0.04)
...
|---|---:|---:|---:|---:|---:|---:|---|
| chosen `global` | 200 | 0.4 | 0.0376 | 0.1978 | 0.5438 | 0 | True |
...
- None
- worst_pathology_scope: **entry_quality_label** rows=144 win_rate=0.2153 quality=-0.1093
