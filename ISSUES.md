...
_最後更新：2026-05-18 11:02:50 CST_
...
## 當前主線事實
- **最新 fast heartbeat #1324-productization 已完成 collect + diagnostics refresh**
  - `Raw=33534 / Features=24637 / Labels=66862`
...
- **recent canonical diagnostics 已刷新**
  - `latest_window=100` / `win_rate=23.0%` / `dominant_regime=bear(100.0%)` / `avg_quality=-0.0775` / `avg_pnl=-0.0060` / `alerts=regime_concentration,regime_shift`
...
- **source / venue blockers 仍開啟**
  ...
  - fin_netflow：`quality_flag=source_auth_blocked` / `latest_status=auth_missing` / `forward_archive_rows=4195` / `archive_window_coverage_pct=0.0`
...
- 目前真相：`quality_flag=source_auth_blocked` / `latest_status=auth_missing` / `forward_archive_rows=4195` / `archive_window_coverage_pct=0.0`
