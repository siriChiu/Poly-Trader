...
> **最後更新：2026-04-02 13:25 GMT+8**
> **🔄 心跳 #98：Pulse 第3輪 P0 → 替換 vol_roc48→vol_spike12 (IC=-0.0669)；BTC=$66,400；CV=56.32%**
...
| #H109 | ⚠️ Aura IC 驟降（0.0316，-0.0089 本輪）→ 第2輪 | 監控3輪，若持續低於 0.05 考慮替換 | 🟡 P1 監控中（第2輪/3）|
| #H110 | ⚠️ Tongue IC 弱（-0.0043 本輪）→ 第2輪 | 監控3輪，若持續低於 0.05 改用 FNG 14d change rate | 🟡 P1 監控中（第2輪/3）|
| #H111 | ⚠️ Pulse IC 全量稀釋（ic_map=+0.009）| 近期 IC 顯著但全量被稀釋；需累積更多 vol_spike12 數據 | 🟡 P1 |
...
## 📊 當前系統健康 (2026-04-02 13:25 GMT+8)

### 數據管線
| 項目 | 數值 | 狀態 |
|------|------|------|
| Raw data | 11,110 筆 | ✅ 每 5 分鐘增長 |
| Features | 11,095 筆 | ✅ |
| Labels | 22,086 筆 (h=4 + h=24) | ✅ 三類均衡 |
| BTC 當前 | $66,400 | ✅ |
| FNG | 12.0（極度恐慌）| ⚠️ 市場悲觀 |
| Funding Rate | -3.04e-05（負/偏空）| ⚠️ |

### 感官 IC（近期 N=1000，h=4）
| 感官 | 特徵 | IC(近期) | 狀態 |
|------|------|----------|------|
| Eye | fr_cumsum_48 | -0.2534 | ✅ **強** |
| Ear | mom_24 | -0.0842 | ✅ |
| Nose | RSI14 norm | -0.0845 | ✅ |
| Tongue | FNG pct | -0.0043 | ⚠️ 監控（第2輪）|
| Body | price_ret_20P | +0.1384 | ✅ |
| Pulse | vol_spike12 | -0.0669 | ✅ **已修復** |
| Aura | vol_ratio_short_long | -0.0089 | ⚠️ 監控（第2輪）|
| Mind | ret_144 | -0.2358 | ✅ **最強** |
...
| 優先 | 行動 | Issue |
|------|------|-------|
| P1 | **監控 Aura IC**：若連續3輪 < 0.05（第2輪）→ 替換 | #H109 |
| P1 | **監控 Tongue IC**：若連續3輪 < 0.05（第2輪）→ 替換為 FNG 14d change | #H110 |
