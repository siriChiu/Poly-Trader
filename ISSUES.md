...
- 目前真相：`window=500` / `win_rate=11.0%` / `dominant_regime=bull(85.6%)` / `avg_quality=-0.1712` / `avg_pnl=-0.0061`
- 病態切片：`alerts=label_imbalance,regime_shift` / `tail_streak=49` / `low_variance=9` / `low_distinct=10` / `null_heavy=10`
- 下一步：直接對 recent canonical rows 做 feature variance / distinct-count / target-path drill-down；維持 decision-quality guardrails，並檢查 calibration scope 是否仍被病態 slice 稀釋。 recent_window=500, alerts=['label_imbalance', 'regime_shift'], win_rate=0.1100, delta_vs_full=-0.5150, dominant_regime=bull(85.60%), interpretation=distribution_pathology, avg_pnl=-0.0061, avg_quality=-0.1712, avg_dd_penalty=0.3199, spot_long_win_rate=0.0080, feature_diag=variance:9/56, frozen:0, compressed:9, expected_static:3, overlay_only:1, unexpected_frozen:0, distinct:10, null_heavy:10, tail_streak=49x1 since 2026-04-19 10:13:18.192660 -> 2026-04-19 20:20:52.206214, adverse_streak=214x0 since 2026-04-17 15:28:55.115358 -> 2026-04-18 13:43:25.809469, prev_win_rate=0.736, delta_vs_prev=-0.626, prev_quality=0.3281, quality_delta_vs_prev=-0.4993, prev_pnl=0.0053, pnl_delta_vs_prev=-0.0114, top_shift_examples=feat_eye(1.0038→-1.8968,Δσ=0.7563)/feat_local_top_score(0.4188→0.2716,Δσ=0.655)/feat_local_bottom_score(0.3022→0.4372,Δσ=0.5913), new_compressed=feat_vwap_dev, compressed_examples=feat_body(0.0001/500)/feat_ear(0.0065/498)/feat_tongue(0.0099/500), expected_static_examples=feat_dxy[weekend_macro_market_closed]/feat_nq_return_24h[weekend_macro_market_closed]/feat_vix[weekend_macro_market_closed], overlay_only_examples=feat_scales_ssr[research_sparse_source], distinct_examples=feat_4h_dist_swing_high(0/0)/feat_chorus(0/0)/feat_fin_netflow(0/0), null_examples=feat_4h_dist_swing_high(0.0)/feat_chorus(0.0)/feat_fin_netflow(0.0), recent_examples=2026-04-19 20:17:48.909646:1:chop:0.5981/2026-04-19 20:19:01.725188:1:chop:0.6273/2026-04-19 20:20:52.206214:1:chop:0.6142, adverse_examples=2026-04-18 13:00:00.000000:0:bull:-0.2342/2026-04-18 13:36:43.970223:0:bull:-0.2119/2026-04-18 13:43:25.809469:0:bull:-0.2137
- 驗證：
...
- 目前真相：`quality_flag=source_auth_blocked` / `latest_status=auth_missing` / `forward_archive_rows=2763` / `archive_window_coverage_pct=0.0`
