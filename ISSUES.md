...
| #H111 | ⚠️ Pulse IC 接近閾值（-0.0717） | 近期 IC 剛過 0.05，需持續監控 | 🟡 P1 監控中 |
...
## 📊 當前系統健康 (2026-04-02 13:39 GMT+8)

### 數據管線
| 項目 | 數值 | 狀態 |
|------|------|------|
| Raw data | 11,112 筆 | ✅ 每 5 分鐘增長 |
| Features | 11,097 筆 | ✅ |
| Labels | 22,089 筆 (h=4 + h=24) | ✅ 三類均衡 |
| BTC 當前 | $66,476 | ✅ |
...
| 感官 | 特徵 | IC(近期) | 狀態 |
|------|------|----------|------|
| Eye | fr_cumsum_48 | -0.2525 | ✅ **強** |
| Ear | mom_24 | -0.0815 | ✅ |
| Nose | RSI14 norm | -0.0801 | ✅ |
| Tongue | fr_acceleration（新）| +0.1162 | ✅ **替換** |
| Body | vol_zscore_48 | +0.1346 | ✅ **強** |
| Pulse | vol_spike12 | -0.0717 | ✅ 監控 |
| Aura | volume_trend_12（新）| -0.2522 | ✅ **替換** |
| Mind | ret_144 | -0.2306 | ✅ **最強** |
...
| 優先 | 行動 | Issue |
|------|------|-------|
| P1 | **監控 Pulse IC**：在 -0.0717 邊緣，需每輪心跳確認 | #H111 |
| P1 | **驗證新感官**：Tongue(fr_acc)/Aura(vol_trend)需2-3輪心跳驗證穩定性 | #H112/#H113 |
