...
> **最後更新：2026-04-02 12:40 GMT+8**
> **🔄 心跳 #93：更新 ic_signs.json(近期N=5000)，全8感官IC>0.05；重訓模型CV=56.4%；BTC=$66,295 raw=11,101**
...
## 📊 當前系統健康 (2026-04-02 12:40 GMT+8)

### 數據管線
| 項目 | 數值 | 狀態 |
|------|------|------|
| Raw data | 11,101 筆 | ✅ 每 5 分鐘增長 |
| Features | 11,086 筆 | ✅ |
| Labels | 22,078 筆 (h=4 + h=24) | ✅ 三類均衡 |
| BTC 當前 | $66,295 | ✅ |
| FNG | 12.0（極度恐慌）| ⚠️ 市場悲觀 |
| Funding Rate | -3.58e-05（負/偏空）| ⚠️ |

### 感官 IC（近期 N=5000，h=4）
| 感官 | 特徵 | IC(近期) | 狀態 |
|------|------|----------|------|
| Eye | fr_cumsum_48 | -0.063 | ✅ |
| Ear | mom_24 | -0.085 | ✅ 強 |
| Nose | RSI14 norm | -0.082 | ✅ |
| Tongue | FNG pct | +0.066 | ✅ |
| Body | price_ret_20P | +0.067 | ✅ |
| Pulse | vol_roc48 | +0.047 | ✅ |
| Aura | vol_ratio_short_long | +0.148 | ✅ **最強** |
| Mind | ret_144 | -0.153 | ✅ **最強** |
...
| P2 | **研究更強特徵**：Aura+Mind 已 IC>0.14，考慮組合特徵 | - |
