...
*最後更新：2026-04-07 12:17 UTC — Heartbeat #595*

## 📊 系統健康狀態 v4.23

| 項目 | 數值 | 狀態 |
|------|------|------|
| Raw | **10,092** | ✅ +6 vs #594（持續增長） |
| Features | **10,051** | ✅ +6 vs #594 |
| Labels | **27,684** | ⚠️ 凍結（與 #594 相同） |
| sell_win | **33.21%** | 🔴 持平（vs #594 33.21%） |
| 全域 IC | **5/22** | ➡️ 持平 |
| TW-IC | **13/22** | ➡️ 持平 |
| 模型數 | **8** | ✅ |
| Tests | **6/6** | ✅ 全過 |
...
## 📊 市場快照（#595 即時）
- BTC: **$68,245**（🔻 -$132 vs #594 $68,377，持續下跌逼近$68K）
- FNG: **11**（持續極度恐懼）
- FR: **0.00003036**（⬆️ +4.4% vs #594 0.00002915，反升！）
- LSR: **1.3229**（⬇️ -16bps vs #594 1.3245，長倉比例略降）
- OI: **91,018**（⬆️ +7 vs #594 91,011，持倉量微升）
...
## ✅ 本次摘要
- 🟢 **Raw 10,092（+6 vs #594 10,086）**：持續增長（從 +10 降至 +6，仍有活動）
- 🟢 **Features 10,051（+6 vs #594 10,045）**：跟隨 Raw 增長
- 🔴 **Labels 27,684**：完全凍結（與 #594 相同），自 #593 跳增後零增長
- 🔴 **sell_win=33.21%**：持平（vs #594 33.21%），遠低於 90% 目標
...
- 🟡 **BTC $68,245（-$132）**：持續下跌逼近 $68K 關口
- 🟢 **FR 0.00003036（+4.4%）**：反升！從 #594 的微幅下降趨勢反轉
- 🟡 **LSR 1.3229（-16bps）**：長倉比例微降
- 🟡 **OI 91,018（+7）**：持倉量微升
