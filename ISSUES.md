...
> **最後更新：2026-04-02 03:50 GMT+8**
> **🔄 心跳 #52：fix #H60 feat_pulse v2 (pos_in_range_72, IC=-0.160) + feat_mind v2 (ret_72, IC=-0.146)，模型重訓 Train=71.1% CV=40.2%**
> **✅ 上輪修復：心跳 #51：fix #H59 feat_pulse NEG_IC_FEATS 錯誤，模型重訓**
...
| ID | 問題 | 解決方案 | 日期 |
|----|------|----------|------|
| **#H60** | **feat_pulse IC=+0.019 統計噪音 → v2 pos_in_range_72 (IC=-0.160); feat_mind IC=+0.020 統計噪音 → v2 ret_72 (IC=-0.146)** | **替換計算邏輯+回填+重訓，Train 71.1% CV 40.2%** | **04-02 03:50** |
...
| Features | 2,231 筆 | ✅ |
| Labels | 4,307 筆 | ✅ |
| 最新資料時間 | 2026-04-01 19:46 UTC | ✅ |
| BTC 當前 | $68,231 | ✅ |
| Funding | 0.0000279 (極低/中性) | ℹ️ |
| OI ROC | +0.0087 | ℹ️ |
| **main.py 進程** | **5分鐘排程** | ✅ |
...
| feat_pulse v2 (pos_in_range_72) | -0.160 | ✅ 是 | +0.160 | ✅ 替換完成 #H60 |
| feat_aura | -0.190 | ✅ 是 | +0.190 | ✅ |
| feat_mind v2 (ret_72) | -0.146 | ✅ 是 | +0.146 | ✅ 替換完成 #H60 |

### 模型性能（最新）
| 指標 | 值 | 評估 |
|------|------|------|
| Train Accuracy | 71.1% (+2.9%) | ✅ 改善 |
| TimeSeries CV | 40.2% ± 4.2% | 🟡 需更多數據 |
...
| 優先 | 行動 | Issue |
|------|------|-------|
| P1 | **持續累積乾淨數據**：現有 2,231 筆（5min 排程，每天新增 ~288 筆） | #H33 |
| P1 | **feat_tongue 替換**：IC=-0.056 (p=0.209) 不顯著，考慮替換為更有效信號 | #H58 |
