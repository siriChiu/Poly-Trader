...
*最後更新：2026-04-07 09:55 UTC — Heartbeat #574*

## 📊 系統健康狀態 v4.7

| 項目 | 數值 | 狀態 |
|------|------|------|
| Raw | **9,967** | ⚠️ +4 vs #574 |
| Features | **9,926** | ⚠️ +4 vs #574 |
| Labels | **18,052** | ❌ 持平（凍結！）|
| sell_win | **40.37%** | ❌ 低于50% |
| 全域 IC | **5/22** | ⚠️ 持平 |
| TW-IC | **13/22** | ⚠️ 持平 |
...
## 📊 市場快照（#574 即時）
- BTC: **$69,181**（↔️ +$6 vs #573 $69,175，微幅上升）
- FNG: **11**（持續極度恐懼）
- FR: **0.00005332**（⬇️ -1.8% vs #573 0.00005428，微降但仍處正值高位）
- LSR: **1.2492**（↔️ -1.3% vs #573 1.2512，微降！）
- OI: **91,503**（⬆️ +30 vs #573 91,473，微升）
...
- 🟢 **FR 0.00005332（-1.8%）**：微降但仍處正值高位，多頭付費意願仍強
- 🟡 **LSR 1.2492（-1.3%）**：微降，需注意長倉比例下降趨勢
- 🟡 **BTC $69,181（+$6）**：微幅上升
