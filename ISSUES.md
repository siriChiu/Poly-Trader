...
## 當前主線事實
- **最新 fast heartbeat #1224 已完成 collect + diagnostics refresh**
  - `Raw=33219 / Features=24406 / Labels=66403`
...
- **recent canonical diagnostics 已刷新**
  - `latest_window=100` / `win_rate=46.0%` / `dominant_regime=chop(97.0%)` / `avg_quality=+0.1032` / `avg_pnl=-0.0008` / `alerts=regime_concentration,regime_shift`
...
- 目前真相：`quality_flag=source_auth_blocked` / `latest_status=auth_missing` / `forward_archive_rows=4041` / `archive_window_coverage_pct=0.0`
