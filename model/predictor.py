...
class XGBoostPredictor:
    ...
    def predict_proba(self, features: Dict) -> float:
        ...
        NEG_IC_FEATS = {"feat_eye_dist", "feat_ear_zscore", "feat_nose_sigmoid", "feat_tongue_pct", "feat_body_roc", "feat_aura"}  # feat_pulse IC=+0.019 (positive) removed 04-02 03:34; feat_mind removed 04-02 03:19
