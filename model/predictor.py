...
class XGBoostPredictor:
    ...
    def predict_proba(self, features: Dict) -> float:
        ...
        NEG_IC_FEATS = {"feat_eye_dist", "feat_ear_zscore", "feat_nose_sigmoid", "feat_body_roc", "feat_aura", "feat_pulse", "feat_mind"}  # h=4: tongue_pct positive IC removed 04-02 04:28
