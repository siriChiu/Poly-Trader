...
4. fast heartbeat summary / ISSUES / ROADMAP 必須 machine-read `positive_discriminative_gap` 與 `unsafe_floor_cross_candidate`，避免下一輪又把「破壞 discrimination 的假跨 floor」誤當成可部署 patch。
