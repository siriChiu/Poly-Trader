...
## 已完成
- **fast heartbeat #20260424_2054 已完成 collect + diagnostics refresh**
...
- current live q15 truth 維持：**29/50 + exact_bucket_present_but_below_minimum + reference_only_non_current_live_scope**
