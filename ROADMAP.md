...
## 已完成
- **fast heartbeat #20260424w 已完成 collect + diagnostics refresh**
...
- current live q15 truth 維持：**7/50 + exact_bucket_present_but_below_minimum + reference_only_until_exact_support_ready**
