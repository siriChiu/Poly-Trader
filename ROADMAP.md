...
## 已完成
- **fast heartbeat #20260424_1908 已完成 collect + diagnostics refresh**
...
- current live bucket support truth 維持：**5/50 + exact_bucket_present_but_below_minimum + reference_only_non_current_live_scope**
