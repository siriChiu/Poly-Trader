...
## 已完成
- **full heartbeat #1331-productization 已完成 collect + diagnostics refresh**
...
- **場館 readiness 摘要已補上 metadata-vs-runtime fail-closed 文案**
  - `VenueReadinessSummary` 現在會在 Dashboard / Execution Status / Strategy Lab 共用區塊上方顯示 `元資料通過數 / 實單生命週期可交易數`；本輪 runtime truth 是 `metadata 1/2`、`runtime 0/2`，並明講 metadata 正常只代表觀測層，未完成憑證 / 委託確認 / 成交證據前不可 canary/live
