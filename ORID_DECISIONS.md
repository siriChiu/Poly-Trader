...
## 心跳 #1129-productization-floor-context ORID

### O｜客觀事實
- collect + diagnostics refresh 完成：`Raw=32479 / Features=23897 / Labels=65569`；歷史覆蓋確認：`2y_backfill_ok=True` / `raw_start=2024-04-13T22:00:00+00:00` / `features_start=2024-04-14T07:00:00+00:00` / `labels_start=2024-04-14T07:00:00+00:00`；`simulated_pyramid_win=56.74%`。
...
- latest recent-window diagnostics：`latest_window=100` / `win_rate=19.0%` / `dominant_regime=chop(94.0%)` / `avg_quality=-0.1219` / `avg_pnl=-0.0066` / `alerts=label_imbalance,regime_concentration,regime_shift`。
