...
### O｜客觀事實
- collect + diagnostics refresh 完成：`Raw=32509 / Features=23927 / Labels=65619`；歷史覆蓋確認：`2y_backfill_ok=True` / `raw_start=2024-04-13T22:00:00+00:00` / `features_start=2024-04-14T07:00:00+00:00` / `labels_start=2024-04-14T07:00:00+00:00`；`simulated_pyramid_win=56.72%`。
...
- latest recent-window diagnostics：`latest_window=100` / `win_rate=25.0%` / `dominant_regime=chop(80.0%)` / `avg_quality=-0.0442` / `avg_pnl=-0.0036` / `alerts=regime_shift`。
