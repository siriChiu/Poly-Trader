...
- **Action**：維持 breaker-first truth，並把 current live bucket support 與 recommended patch 持續顯示為 `reference_only`；下一步沿 recent pathological slice 與 release math 繼續追根因。
