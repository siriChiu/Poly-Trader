...
### I｜意義洞察
1. **support truth ≠ deployment closure**：`support=8/50` 且 `support_route_verdict=exact_bucket_present_but_below_minimum` 只代表治理前進，還不能把 reference-only patch 升級成 runtime patch。
