...
### O｜客觀事實
- collect + diagnostics refresh 完成：`Raw=32486 / Features=23904 / Labels=65579`；歷史覆蓋確認：`2y_backfill_ok=True` / `raw_start=2024-04-13T22:00:00+00:00` / `features_start=2024-04-14T07:00:00+00:00` / `labels_start=2024-04-14T07:00:00+00:00`；`simulated_pyramid_win=56.74%`。
