...
## 心跳 #1132-productization-timeout-fix ORID

### O｜客觀事實
- collect + diagnostics refresh 完成：`Raw=32483 / Features=23901 / Labels=65573`；歷史覆蓋確認：`2y_backfill_ok=True` / `raw_start=2024-04-13T22:00:00+00:00` / `features_start=2024-04-14T07:00:00+00:00` / `labels_start=2024-04-14T07:00:00+00:00`；`simulated_pyramid_win=56.74%`。
...
- latest recent-window diagnostics：`latest_window=100` / `win_rate=21.0%` / `dominant_regime=chop(96.0%)` / `avg_quality=-0.1025` / `avg_pnl=-0.0060` / `alerts=regime_concentration,regime_shift`。
