...
### O｜客觀事實
- collect + diagnostics refresh 完成：`Raw=32490 / Features=23908 / Labels=65588`；歷史覆蓋確認：`2y_backfill_ok=True` / `raw_start=2024-04-13T22:00:00+00:00` / `features_start=2024-04-14T07:00:00+00:00` / `labels_start=2024-04-14T07:00:00+00:00`；`simulated_pyramid_win=56.73%`。
...
- latest recent-window diagnostics：`latest_window=100` / `win_rate=23.0%` / `dominant_regime=chop(92.0%)` / `avg_quality=-0.0780` / `avg_pnl=-0.0051` / `alerts=regime_concentration,regime_shift`。
