...
_最後更新：2026-04-28 03:05:03 CST_
...
### O｜客觀事實
- collect + diagnostics refresh 完成：`Raw=32390 / Features=23808 / Labels=65357`；歷史覆蓋確認：`2y_backfill_ok=True` / `raw_start=2024-04-13T22:00:00+00:00` / `features_start=2024-04-14T07:00:00+00:00` / `labels_start=2024-04-14T07:00:00+00:00`；`simulated_pyramid_win=56.90%`。
...
- latest recent-window diagnostics：`latest_window=100` / `win_rate=84.0%` / `dominant_regime=chop(82.0%)` / `avg_quality=+0.4164` / `avg_pnl=+0.0076` / `alerts=label_imbalance,regime_shift`。
