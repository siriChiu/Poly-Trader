...
def _load_anchors() -> Dict[str, tuple]:
    ...
    return {
        ...
        'feat_nw_width': (0.0, 0.08),
        'feat_nw_slope': (-0.03, 0.03),
        'feat_adx': (0.0, 0.8),
        'feat_choppiness': (0.25, 0.75),
        'feat_donchian_pos': (0.0, 1.0),
...
FEATURE_MAP = {
    ...
    'feat_nw_width':  'nw_width',
    'feat_nw_slope':  'nw_slope',
    'feat_adx':       'adx',
    'feat_choppiness': 'choppiness',
    'feat_donchian_pos': 'donchian_pos',
# 4H Distance
...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "bb_pct_b":{"name": "NW Env",   "emoji": "🔵", "description": "Nadaraya-Watson envelope position",      "modules": {"main": {"name": "NW Env",      "source": "Technical", "enabled": True, "weight": 1.0, "value": None}}, "score": 0.5},
    "nw_width":{"name": "NW Width", "emoji": "〰️", "description": "Nadaraya-Watson bandwidth",               "modules": {"main": {"name": "NW Width",    "source": "Technical", "enabled": True, "weight": 1.0, "value": None}}, "score": 0.5},
    "nw_slope":{"name": "NW Slope", "emoji": "📏", "description": "Slope of NW center line",                 "modules": {"main": {"name": "NW Slope",    "source": "Technical", "enabled": True, "weight": 1.0, "value": None}}, "score": 0.5},
    "adx":{"name": "ADX",           "emoji": "🧭", "description": "Trend strength (ADX)",                    "modules": {"main": {"name": "ADX",         "source": "Technical", "enabled": True, "weight": 1.0, "value": None}}, "score": 0.5},
    "choppiness":{"name": "Choppy", "emoji": "🪵", "description": "Choppiness index",                         "modules": {"main": {"name": "Chop",        "source": "Technical", "enabled": True, "weight": 1.0, "value": None}}, "score": 0.5},
    "donchian_pos":{"name": "Donchian", "emoji": "📦", "description": "Donchian channel position",            "modules": {"main": {"name": "Donchian",    "source": "Technical", "enabled": True, "weight": 1.0, "value": None}}, "score": 0.5},
    # 7 4H Structure
    ...
    "4h_bb_pct_b":   {"name": "4H NW Env",   "emoji": "🔵", "description": "4H Nadaraya-Watson envelope position", "modules": {"main": {"name": "NW Env",      "source": "4H Structure", "enabled": True, "weight": 1.0, "value": None}}, "score": 0.5},
...
class FeaturesEngine:
    ...
    def generate_advice(self, scores: Optional[Dict[str, float]] = None) -> Dict[str, Any]:
        ...
        names = {
            ...
            "atr_pct": "ATR 波幅", "vwap_dev": "VWAP 偏離", "bb_pct_b": "NW Envelope 位置",
            "4h_bias50": "4H MA50 偏離", "4h_bias20": "4H MA20 偏離", "4h_dist_sl": "4H 支撐距離",
            "4h_rsi14": "4H RSI", "4h_macd_hist": "4H MACD", "4h_bb_pct_b": "4H NW 位置",
            "4h_ma_order": "4H 均線排列",
        }
        summary = (
