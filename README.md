...
- **Support-aware runtime blocker**：q15 lane 已從 `support=0` 推進到 **exact-supported (`77 / 50`)**；目前 live blocker 已轉成 `entry_quality_below_trade_floor`，下一步是 exact-supported component verify，而不是再拿 proxy / neighbor 假裝放行
