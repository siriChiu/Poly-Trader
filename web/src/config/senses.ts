...
export const FEATURE_GROUPS: Record<FeatureGroupKey, { label: string; description: string }> = {
  ...
  technical: {
    label: "技術指標",
    description: "以 Nadaraya-Watson Envelope、RSI、MACD、ATR、VWAP 等較有競爭力的結構/波動指標為主。",
  },
  macro: {
    label: "宏觀風險",
...
export const ALL_SENSES: Record<string, SenseMeta> = {
  ...
  bb_pct_b: {
    name: "NW Envelope 位置",
    shortLabel: "NW Env",
    description: "Nadaraya-Watson Envelope 相對位置。",
    meaning: "比傳統布林通道更平滑地估計動態支撐/壓力，能更早看出價格是否貼近局部極端區。",
    category: "technical",
    color: "#c084fc",
  },
  nw_width: {
    name: "NW 寬度",
    shortLabel: "NW Width",
    description: "Nadaraya-Watson Envelope 寬度。",
    meaning: "用來觀察波動是否擴張，越寬通常代表市場正在加速進入趨勢或洗盤期。",
    category: "technical",
    color: "#8b5cf6",
  },
  nw_slope: {
    name: "NW 斜率",
    shortLabel: "NW Slope",
    description: "Nadaraya-Watson 中線斜率。",
    meaning: "比單純均線更平滑地觀察局部趨勢推進方向，適合做短中期節奏濾網。",
    category: "technical",
    color: "#38bdf8",
  },
  adx: {
    ...
    meaning: "高值代表趨勢很明確，低值代表震盪。很適合拿來分辨該做趨勢追隨還是均值回歸。",
    category: "technical",
    color: "#f97316",
  },
  choppiness: {
    ...
    meaning: "高值代表市場正在箱體震盪，低值代表可能進入有方向的趨勢段。",
    category: "technical",
    color: "#22c55e",
  },
  donchian_pos: {
    name: "Donchian 位置",
    shortLabel: "Donchian",
    description: "價格在 Donchian Channel 中的位置。",
    meaning: "用來看價格是否接近最近 N 根高低區間的上緣或下緣，對突破/回歸判斷都很實用。",
    category: "technical",
    color: "#eab308",
  },
  claw: {
  ...
  "4h_bb_pct_b": {
    name: "4H NW Envelope 位置",
    shortLabel: "4H NW",
    description: "4H Nadaraya-Watson Envelope 相對位置。",
    meaning: "在 4H 框架看價格是否靠近平滑估計出的動態上/下緣，比固定布林更適合做結構濾網。",
    category: "structure4h",
    color: "#c084fc",
  },
  "4h_dist_bb_lower": {
    name: "4H NW 下緣距離",
    shortLabel: "4H下緣",
    description: "距離 4H Nadaraya-Watson 下緣的百分比。",
    meaning: "越接近下緣，通常越靠近高時間框架的動態支撐區，可搭配 4H Bias 與 swing low 一起判讀。",
    category: "structure4h",
    color: "#34d399",
  },
  "4h_dist_sl": {
