...
const RUNTIME_DETAIL_TOKEN_REPLACEMENTS: Array<[string, string]> = [
  ...
  ["deployable_candidates_available", "已有可部署候選"],
  ...
  ["q15 audit", "q15 支持審核"],
  ["q35 support", "q35 支持樣本"],
  ["generic breaker", "通用熔斷"],
  ["exact support closure", "精準樣本閉環"],
  ["exact support", "精準樣本"],
  ["same exact lane", "同一精準路徑"],
  ["dominant neighbor bucket", "主導鄰近分桶"],
  ["structure component", "結構元件"],
  ["exact 支持樣本閉環", "精準樣本閉環"],
  ["exact 支持樣本", "精準樣本"],
  ["same 精準路徑", "同一精準路徑"],
  ["dominant 鄰近分桶", "主導鄰近分桶"],
  ["結構 component", "結構元件"],
  ["production_profile_unspecified", "正式配置來源未指定"],
  ["global shrinkage", "全域收縮"],
  ["exact-supported", "精準樣本已支持"],
  ["support-aware", "支援樣本感知"],
  ["live 基準", "即時基準"],
  ["live bull lane", "即時牛市路徑"],
  ...
  ["base stack redesign discriminative reweight crosses floor but execution blocked", "基礎堆疊重設可跨門檻，但執行仍被精準樣本阻塞"],
  ["base-stack", "基礎堆疊"],
